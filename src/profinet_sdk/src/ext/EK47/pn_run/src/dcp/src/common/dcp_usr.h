...
/*  2016-06-01  P06.00,06.01,07.00 1727166: [CR] increase the number of      */
/*                                          ressources for DCP Indentify     */
/*                                                                           */
/*****************************************************************************/
#endif /* DCP_MESSAGE */
...
#define DCP_OPC_CANCEL_REQ			(LSA_OPCODE_TYPE)	13
 ...
 */
#define DCP_NUM_SERVER_IDENTIFY_RESOURCES	25	//1727166: was 16
...
*/
#define DCP_IDENTIFY_DO_NOT_NOTIFY_USER_ON_NEW_ENTRY    0
#define DCP_IDENTIFY_NOTIFY_USER_ON_NEW_ENTRY           1
typedef struct DCP_RQB_ARGS_IDENTIFY_REQ_
{
	...
	LSA_UINT8			Notify;		/* Callback with Notify-RB (if one is in	*/
									/* queue) on every entry of a new node		*/
									/* On return: unchanged				  		*/
	LSA_UINT32			NotifyId;	/* Will be returned with NotifyIndication	*/
									/* if Notify is DCP_IDENTIFY_NOTIFY_USER_ON_NEW_ENTRY. */
									/* On return: unchanged				  		*/
	LSA_UINT16			Tolerance;	/* Time in Milliseconds to be added to the	*/
									...
									/* On return: unchanged				  		*/
	LSA_UINT32			RequestId;	/* User defined ID to cancel this request	*/
									/* On return: unchanged				  		*/
...
/* Upper RQB parameter structure for client CANCEL request **********************
*/
typedef struct DCP_RQB_ARGS_CANCEL_REQ_
{
	LSA_UINT32			RequestId;	/* The IDENTIFY/GET/SET RequestID to cancel */
									/* On return: unchanged				  		*/
} DCP_RQB_ARGS_CANCEL_REQ;
...
typedef union dcp_rqb_args_tag
{
	...
	DCP_RQB_ARGS_CANCEL_REQ		CancelReq;	/* Client: Cancel Request		*/
#ifdef DCP_DO_TIMEOUT_EXTERN
