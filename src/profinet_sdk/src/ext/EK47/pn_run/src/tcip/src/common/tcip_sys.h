...
typedef LSA_FATAL_ERROR_TYPE *TCIP_FATAL_ERROR_PTR_TYPE;	/* pointer to LSA_FATAL_ERROR */

typedef LSA_VOID *TCIP_UPPER_MEM_PTR_TYPE;				/* pointer to upper-memory */

typedef LSA_VOID *TCIP_LOCAL_MEM_PTR_TYPE;				/* pointer to local-memory */

typedef LSA_VOID *TCIP_EDD_LOWER_MEM_PTR_TYPE;		/* pointer to lower-memory */
...
typedef TCIP_DETAIL_TYPE *TCIP_DETAIL_PTR_TYPE;
...
/*lint -function(exit, tcip_fatal1) */
LSA_VOID
tcip_fatal1(
	LSA_UINT16 tcip_module_id,
	LSA_INT line,
