...
typedef struct oha_db_elem_tag * OHA_DB_ELEM_PTR_TYPE;
...
typedef struct oha_db_lldp_elem_tag * OHA_DB_LLDP_ELEM_PTR_TYPE;
...
typedef struct oha_db_oid_elem_tag * OHA_DB_OID_ELEM_PTR_TYPE;

typedef struct oha_db_oid_elem_tag
{
    LSA_UINT32      Value;                  /* variable as integer           */
    LSA_UINT8       TmpOctStr[1+1];         /* temorary during a set oper.   */
...
/* lldpStatistics */
typedef struct oha_oid_stats_tag * OHA_OID_STATS_PTR_TYPE;
...
/* lldpConfiguration */
typedef struct oha_oid_lldp_config_tag * OHA_OID_LLDP_CONFIG_PTR_TYPE;
...
/* lldpPortConfig */
typedef struct oha_oid_port_config_tag * OHA_OID_PORT_CONFIG_PTR_TYPE;
...
typedef struct oha_db_lldpdu_tag * OHA_DB_LLDPDU_PTR_TYPE;
...
typedef struct oha_lldp_sender_tag * OHA_LLDP_SENDER_PTR_TYPE;
...
typedef struct oha_db_device_tag * OHA_UPPER_DB_DEVICE_PTR_TYPE;
...
typedef struct oha_db_lldp_tag * OHA_DB_LLDP_PTR_TYPE;
...
typedef struct oha_dhcp_rtf_tag
{
	...
	LSA_UINT16 ClientIDLen;   /* Length of ClientID, range 0 … 0xff */
} OHA_DHCP_RTF_TYPE;
...
typedef struct oha_db_dcp_tag
{
	...
	OHA_DHCP_RTF_TYPE                           DHCPRtFParams;      /* RtF values of DHCP option 61 and 255 */
	LSA_BOOL                                    DHCPRtFParamsActive;/* true if initial values are active  */
                                                                    /* false if values are set otherwise  */
} OHA_DB_DCP_TYPE;
...
typedef struct oha_db_if_tag * OHA_DB_IF_PTR_TYPE;
...
typedef struct oha_db_if_tag
{
    ...
    LSA_BOOL                    IsPulled[OHA_CFG_MAX_PORTS]; /* written by PrmChangePort */
                                                 /* LSA_TRUE: build no PrmDiagnosis  */
	LSA_UINT8                  ClusterID;        /* 0x00: No ClusterID assigned   */
	LSA_UINT32                 ClusterIP;        /* Cluster IP                    */
	LSA_UINT32                 ClusterSubnet;    /* Cluster subnet mask           */
	LSA_BOOL                   ClusterValidationValid; /* LSA_TRUE: ClusterIPv4SuiteValidationRecord written */
	LSA_UINT16                 ClusterValidation;      /* value of IPAddressValidation */

	OHA_IP_SUITE_TYPE          LocalPendingIP;   /* local IP conflict (multiple Ifs), 0.0.0.0 ... no conflict */
} OHA_DB_IF_TYPE;

typedef struct oha_db_tag * OHA_DB_PTR_TYPE;
...
typedef struct oha_db_tag
{
    ...
    LSA_UINT32          SNMPActivation;          /* from SNMPControlRecord    */
	LSA_UINT32          NextRemIndex;            /* used for RemoteSender[].OidRemEntry.RemIndex (TIA 4246570) */
} OHA_DB_TYPE;
...
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
LSA_EXTERN OHA_DB_IF_PTR_TYPE OHA_DB_GET_INTERFACE(
    LSA_UINT16 NICId);
...
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
LSA_EXTERN LSA_UINT16 OHA_DB_GET_NIC(
    LSA_UINT32 IfId);
 ...
 *===========================================================================*/
LSA_EXTERN LSA_INT OHA_DB_READ_SUPPORTED_DATABASE(
    LSA_UINT16  NicId,
 ...
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_READ_PROFIBUS_COMMON(
    LSA_UINT16  NicId,
 ...
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_READ_PROFIBUS_ADDITION(
    LSA_UINT16  NicId,
    OHA_COMMON_MEM_U8_PTR_TYPE* ParamPtrPtr
);
 ...
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_READ_TCPIP_STATUS(
    LSA_UINT16  NicId
);
 ...
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_TCPIP_STATUS(
    LSA_UINT16  NicId,
    LSA_UINT16  Status
);
 ...
 * return value:   LSA_INT:                             Length
 *===========================================================================*/
LSA_EXTERN LSA_INT OHA_DB_READ_MAC_ADDR(
    LSA_UINT16  NicId,
 ...
 * return value:   LSA_INT:                             Length
 *===========================================================================*/
LSA_EXTERN LSA_INT OHA_DB_READ_IP_SUITE(
    LSA_UINT16  NicId,
 ...
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_READ_DHCP_OPTION(
    LSA_UINT16                  NicId,
 ...
 * return value:   LSA_INT:                             Length
 *===========================================================================*/
LSA_EXTERN LSA_INT OHA_DB_READ_STATION_TYPE(
    LSA_UINT16                  NicId,
 ...
 * return value:   LSA_INT:                             Length
 *===========================================================================*/
LSA_EXTERN LSA_INT OHA_DB_READ_STATION_NAME(
    LSA_UINT16  NicId,
 ...
 *===========================================================================*/
LSA_EXTERN LSA_UINT8 OHA_DB_READ_STATION_ID(
    LSA_UINT16  NicId,
 ...
 *                                              if not present
 *===========================================================================*/
LSA_EXTERN LSA_UINT8 OHA_DB_READ_OEM_DEVICE_ID(
    LSA_UINT16  NicId,
    OHA_COMMON_MEM_U8_PTR_TYPE        * IdPtrPtr
);
 ...
 *                                              0 if no role
 *===========================================================================*/
LSA_EXTERN LSA_UINT8 OHA_DB_READ_PROFINET_ROLE(
    LSA_UINT16  NicId
);
 ...
 * +---------------------+---------------------------------------------------+
 *===========================================================================*/
LSA_EXTERN LSA_UINT8 OHA_DB_READ_DEVICE_INSTANCE(
    LSA_UINT16                    NicId,
 ...
 *                                              cannot be changed
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_PROFINET_ROLE(
    LSA_UINT16      NicId,
    LSA_UINT8       role
);
 ...
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_MAC_ADDR(
    LSA_UINT16                          NicId,
 ...
 * return value:   LSA_UINT16:                          Error
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_IP_SUITE(
    LSA_UINT16                    NicId,
 ...
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_DHCP_OPTION(
    LSA_UINT16   NicId,
    LSA_UINT8  * OptionPtr
);
 ...
 *                                              cannot be changed
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_DEVICE_INSTANCE(
    LSA_UINT16                    NicId,
    LSA_UINT16                    Instance,
    LSA_UINT8                     AccessControl,
    LSA_BOOL                      Remanent
 ...
 *
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_STATION_ID(
    LSA_UINT16                    NicId,
    LSA_UINT8                   * IdPtr,
    LSA_INT                       IdLen,
    LSA_UINT8                     AccessControl,
 ...
 * +---------------+------------------------------------------------------+
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_OEM_DEVICE_ID(
    LSA_UINT16                    NicId,
    LSA_UINT8                   * IdPtr,
    LSA_INT                       IdLen,
    LSA_UINT8                     AccessControl,
 ...
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_PROFIBUS_ADDITION(
    LSA_UINT16                      NicId,
 ...
 *                                          parameters cannot be changed
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_PROFIBUS_COMMON(
    LSA_UINT16                       NicId,
    OHA_COMMON_MEM_U8_PTR_TYPE       ParamPtr,
	LSA_BOOL                         IsRema
);
 ...
 *                                              cannot be changed
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_STATION_NAME(
    LSA_UINT16                    NicId,
 ...
 *                                              cannot be changed
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_STATION_TYPE(
    LSA_UINT16                    NicId,
 ...
 *                                          cannot be changed
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_DEVICE_INITIATIVE(
    LSA_UINT16      NicId,
 ...
 *                                          cannot be changed
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_READ_DEVICE_INITIATIVE(
    LSA_UINT16      NicId,
 ...
 * return value:   LSA_UINT16:      LSA_RET_OK or LSA_RET_ERR_PARAM
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_LLDP_ELEMENT(
    LSA_UINT16                  NicId,
    LSA_UINT16                  PortId,
    LSA_UINT8                   Type,       /* type of variable */
    LSA_UINT8                   SubType,    /* subtype of variable */
 ...
 * return value:   LSA_UINT16:      LSA_RET_OK or LSA_RET_ERR_PARAM
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_READ_LLDP_ELEMENT(
    LSA_UINT16                  NicId,
    LSA_UINT16                  PortId,
    LSA_UINT8                   Type,        /* type of variable, option */
 ...
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_READ_LLDP_PORT_ID(
    LSA_UINT16  NicId,
    LSA_UINT16  PortId,
    OHA_COMMON_MEM_U8_PTR_TYPE * NamePtrPtr
);
 ...
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_READ_LLDP_CHASSIS_ID(
    LSA_UINT16                  NicId,
 ...
 *                                              cannot be changed
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_PORT_NAME(
    LSA_UINT16                    NicId,
    LSA_UINT16                    PortId,
    OHA_COMMON_MEM_U8_PTR_TYPE    NamePtr,
    LSA_INT                       NameLen,
 ...
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_SYS_NAME(
 ...
 * return value:   LSA_UINT16:      LSA_RET_OK or LSA_RET_ERR_PARAM
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_READ_SYS_NAME(
 ...
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_SYS_CONTACT (
 ...
 * return value:   LSA_UINT16:      LSA_RET_OK or LSA_RET_ERR_PARAM
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_READ_SYS_CONTACT(
 ...
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_SYS_LOCATION (
 ...
 * return value:   LSA_UINT16:      LSA_RET_OK or LSA_RET_ERR_PARAM
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_READ_SYS_LOCATION(
 ...
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_SYS_CAP (
 ...
 * return value:    LSA_UINT16      Error:      != LSA_RET_OK if name cannot be written
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_IF_DESCR (
    LSA_UINT16                  NicId,
    LSA_UINT16                  PortId,
 ...
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_READ_IF_DESCR (
    LSA_UINT16                  NicId,
    LSA_UINT16                  PortId,
 ...
 * return value:   LSA_UINT16:      LSA_RET_OK or LSA_RET_ERR_PARAM
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_READ_LLDP_MIB_VALUE(
 ...
 * return value:   LSA_UINT16:      LSA_RET_OK or LSA_RET_ERR_PARAM
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_READ_LLDP_MIB_ACCESS(
    LSA_UINT32                  Options,    /* type of variable   */
    OHA_COMMON_MEM_U8_PTR_TYPE  pAccCtrl    /* access control for variable */
);
 ...
 * return value:   LSA_UINT16:      LSA_RET_OK or LSA_RET_ERR_PARAM
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_READ_LLDP_MIB_PORT_VALUE(
    LSA_UINT16                  NicId,
    LSA_UINT16                  PortId,
 ...
 * return value:   LSA_UINT16:      LSA_RET_OK or LSA_RET_ERR_PARAM
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_READ_LLDP_MIB_PORT_ACCESS(
    LSA_UINT16                  NicId,
    LSA_UINT16                  PortId,
    LSA_UINT32                  PortOptions,    /* type of variable   */
    OHA_COMMON_MEM_U8_PTR_TYPE  pAccCtrl    /* access control for variable */
 ...
 * return value:   LSA_UINT16:  LSA_RET_OK or LSA_RET_ERR_PARAM
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_LLDP_MIB_VALUE(
    LSA_UINT32                  Options,    /* type of variable   */
 ...
 * return value:   LSA_UINT16:  LSA_RET_OK or LSA_RET_ERR_PARAM
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_LLDP_MIB_ACCESS(
    LSA_UINT32                  Options,    /* type of variable   */
    LSA_UINT8                   AccCtrl    /* access control for variable */
);
 ...
 * return value:   LSA_UINT16:  LSA_RET_OK or LSA_RET_ERR_PARAM
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_LLDP_MIB_PORT_VALUE(
    LSA_UINT16                  NicId,
    LSA_UINT16                  PortId,
    LSA_UINT32                  PortOptions,/* type of variable   */
    LSA_UINT32					Value,      /* variable in octets */
 ...
 * return value:   LSA_UINT16:  LSA_RET_OK or LSA_RET_ERR_PARAM
 *===========================================================================*/
LSA_EXTERN LSA_UINT16 OHA_DB_WRITE_LLDP_MIB_PORT_ACCESS(
    LSA_UINT16                  NicId,
    LSA_UINT16                  PortId,
    LSA_UINT32                  PortOptions,/* type of variable   */
    LSA_UINT8                   AccCtrl    /* access control for variable */
 ...
 */
LSA_UINT32 oha_control_snmp_oid(
    ...
    LSA_UINT32                   * var_len,      /* OUT - length of matched variable */
...
/*---------------------------------------------------------------------------*/
LSA_BOOL OHA_UPPER_CASES_ALLOWED(LSA_UINT16  NicId);
