...
#define SOCK_LOCAL_MEM_PTR_TYPE  *

#ifndef SOCK_DETAIL_PTR_TYPE
	#define SOCK_DETAIL_PTR_TYPE struct sock_details_tag *
#endif
...
typedef struct sock_socket_opt_tag
{
	...
	LSA_BOOL                SO_BROADCAST_;      /* broadcast allowed */
} SOCKET_OPTION;
...
/*lint -function(exit, socks_fatal_error) */
LSA_VOID
socks_fatal_error(
	LSA_UINT16 module,
	LSA_UINT16 line,
...
#define SOCK_SET_ROUTE_OK 1
#define SOCK_SET_ROUTE_ERR_PARAM 2
#define SOCK_SET_ROUTE_ERR_LOWER_LAYER 3

#ifndef SOCK_SET_ROUTE
LSA_UINT8 SOCK_SET_ROUTE(
	SockIF_IPAddr target,    /* route target address  */
...
#if 0 /* only for cluster IP support of IP stacks other than OpenBSD -- is not supported at the moment */

#define SOCK_CLUSTER_IP_OK 1
#define SOCK_CLUSTER_IP_OK_ACTIVE 2
#define SOCK_CLUSTER_IP_NOK_PARAMETER 10
#define SOCK_CLUSTER_IP_NOK_LOC_NET 11

#ifndef SOCK_CLUSTER_IP_CONFIG_SET
LSA_UINT8 SOCK_CLUSTER_IP_CONFIG_SET
(
	LSA_UINT32 InterfaceID,
	LSA_UINT8 ClusterID,
	SockIF_IPAddr ClusterIPAddress,
	SockIF_IPAddr ClusterSubnetMask
);
#endif

#ifndef SOCK_CLUSTER_IP_STATE_SET
LSA_UINT8 SOCK_CLUSTER_IP_STATE_SET
(
	LSA_UINT32 InterfaceID,
...
#ifndef SOCK_CLUSTER_IP_STATE_GET
LSA_UINT8 SOCK_CLUSTER_IP_STATE_GET
(
	LSA_UINT32 InterfaceID
);
#endif
...
/*=============================================================================
* SOCK_HTONL, SOCK_NTOHL, SOCK_HTONS, SOCK_NTOHS
*===========================================================================*/

#ifdef LSA_HOST_ENDIANESS_LITTLE
/* flips a byte pattern of 0102 to 0201 */
#define SOCK_FLIP16(C) ((LSA_UINT16) ( (((LSA_UINT16) (C))>>8) | ( ((LSA_UINT16)(C)) << 8)) )
/* flips a byte pattern of 01020304 to 04030201 */
#define SOCK_FLIP32(C) ((LSA_UINT32) (((C) >> 24) | (((C) & 0x00ff0000) >> 8) | (((C) & 0x0000ff00) <<  8) | (((C) << 24))) )
#else
#define SOCK_FLIP16(C)     (C)
#define SOCK_FLIP32(C)     (C)
#endif

#ifndef SOCK_NTOHS
#define SOCK_NTOHS(Value) ( SOCK_FLIP16(Value) )/* Network TO Host Short */
#endif

#ifndef SOCK_NTOHL
#define SOCK_NTOHL(Value) ( SOCK_FLIP32(Value) )/* Network TO Host Long */
#endif

#ifndef SOCK_HTONS
#define SOCK_HTONS(Value) ( SOCK_FLIP16(Value) )/* Host To Network Short */
#endif

#ifndef SOCK_HTONL
#define SOCK_HTONL(Value) ( SOCK_FLIP32(Value) )/* Host TO Network Long */
#endif
