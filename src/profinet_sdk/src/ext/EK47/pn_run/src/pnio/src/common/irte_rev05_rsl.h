...
// DESCR__HOL_LIMIT_API: Die Anzahl der für einen lokalen Kanal (CHA bzw. CHB) maximal zulässigen Datenpuffer
...
// DESCR__HOL_LIMIT_PORT: Die Anzahl der für einen Port maximal zulässigen Datenpuffer
...
// DESCR__UCMC_TABLE_BASE: KRAM-Byte-Adresse; zeigt auf den Start der Uni-/Multicast-Adresstabelle;muß 8-Byte-aligned sein, d.h. es muß immer gelten: UCMC-Base-Address 2..0  = 000.
...
// DESCR__UCMC_TABLE_LENGTH: Länge der Uni-/Multicast-Adresstabelle in Anzahl der Einträge - 1
...
// DESCR__UCMC_TABLE_RANGE: Größe des Nachbarschaftsbereichs beginnend ab Einsprung-Offset (der Offset wird durch das LFSR bestimmt).
...
// DESCR__VLAN_TABLE_BASE: KRAM-Byte-Adresse; zeigt auf den Start der VLAN-Adresstabelle;muß 8-Byte-aligned sein, d.h. es muß immer gelten: VLAN-Base-Address 2..0  = 000.
...
// DESCR__TIMER_SCOREBOARD_ENTRIES: Gibt die Gesamtanzahl der möglichen Entries im Timer-Scoreboard an (muss immer ein Vielfaches von 4 sein).
...
// DESCR__HOL_MASK_P3: Bitmaske für das Annehmen von Sendeaufträgen bei erreichtem HOL-Limit an Port 3. Bit n entspricht dabei der Priorität n.‚0‘: Sendeaufträge mit dieser Priorität werden nicht angenommen.‚1‘: Sendeaufträge mit dieser Priorität werden angenommen.
...
// DESCR__STATISTIC_CTRL_BASE_PTR: Zeiger ins K-RAM, auf einen Bereich, ab dem die Port-spezifischen Statistikzähler abgelegt sind.
...
// DESCR__ENABLE_EXTERNAL_INTERRUPT: 00 : kein zusätzlicher Interrupt-Puls am Pin “int_new_entry”01 : Interrupt-Puls der Trace-Unit wird aufgeschaltet10 : Interrupt-Puls der Trigger-Unit wird aufgeschaltet11 : kein zusätzlicher Interrupt-Puls am Pin “int_new_entry”
