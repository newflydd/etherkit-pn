 ...
 *
 *
 *	Example of ACP usage of references:
 *
...
#define ACP_LOWER_TRACE_00(idx_, level_, msg_)
#define ACP_LOWER_TRACE_01(idx_, level_, msg_, para1_)
#define ACP_LOWER_TRACE_02(idx_, level_, msg_, para1_, para2_)
#define ACP_LOWER_TRACE_03(idx_, level_, msg_, para1_, para2_, para3_)
#define ACP_LOWER_TRACE_04(idx_, level_, msg_, para1_, para2_, para3_, para4_)
#define ACP_LOWER_TRACE_05(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_)
#define ACP_LOWER_TRACE_06(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_)
#define ACP_LOWER_TRACE_07(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_)
#define ACP_LOWER_TRACE_08(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_)
#define ACP_LOWER_TRACE_09(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_)
#define ACP_LOWER_TRACE_10(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_)
#define ACP_LOWER_TRACE_11(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_)
#define ACP_LOWER_TRACE_12(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_, para12_)
...
#ifndef ACP_UPPER_TRACE_00
#define ACP_UPPER_TRACE_00(idx_, level_, msg_) \
    LSA_IDX_TRACE_00(TRACE_SUBSYS_ACP_UPPER, idx_, level_, msg_)
#endif

#ifndef ACP_UPPER_TRACE_01
#define ACP_UPPER_TRACE_01(idx_, level_, msg_, para1_) \
    LSA_IDX_TRACE_01(TRACE_SUBSYS_ACP_UPPER, idx_, level_, msg_, para1_)
#endif

#ifndef ACP_UPPER_TRACE_02
#define ACP_UPPER_TRACE_02(idx_, level_, msg_, para1_, para2_) \
    LSA_IDX_TRACE_02(TRACE_SUBSYS_ACP_UPPER, idx_, level_, msg_, para1_, para2_)
#endif

#ifndef ACP_UPPER_TRACE_03
#define ACP_UPPER_TRACE_03(idx_, level_, msg_, para1_, para2_, para3_) \
    LSA_IDX_TRACE_03(TRACE_SUBSYS_ACP_UPPER, idx_, level_, msg_, para1_, para2_, para3_)
#endif

#ifndef ACP_UPPER_TRACE_04
#define ACP_UPPER_TRACE_04(idx_, level_, msg_, para1_, para2_, para3_, para4_) \
    LSA_IDX_TRACE_04(TRACE_SUBSYS_ACP_UPPER, idx_, level_, msg_, para1_, para2_, para3_, para4_)
#endif

#ifndef ACP_UPPER_TRACE_05
#define ACP_UPPER_TRACE_05(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_) \
    LSA_IDX_TRACE_05(TRACE_SUBSYS_ACP_UPPER, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_)
#endif

#ifndef ACP_UPPER_TRACE_06
#define ACP_UPPER_TRACE_06(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_) \
    LSA_IDX_TRACE_06(TRACE_SUBSYS_ACP_UPPER, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_)
#endif

#ifndef ACP_UPPER_TRACE_07
#define ACP_UPPER_TRACE_07(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_) \
    LSA_IDX_TRACE_07(TRACE_SUBSYS_ACP_UPPER, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_)
#endif

#ifndef ACP_UPPER_TRACE_08
#define ACP_UPPER_TRACE_08(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_) \
    LSA_IDX_TRACE_08(TRACE_SUBSYS_ACP_UPPER, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_)
#endif

#ifndef ACP_UPPER_TRACE_09
#define ACP_UPPER_TRACE_09(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_) \
    LSA_IDX_TRACE_09(TRACE_SUBSYS_ACP_UPPER, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_)
#endif

#ifndef ACP_UPPER_TRACE_10
#define ACP_UPPER_TRACE_10(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_) \
    LSA_IDX_TRACE_10(TRACE_SUBSYS_ACP_UPPER, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_)
#endif

#ifndef ACP_UPPER_TRACE_11
#define ACP_UPPER_TRACE_11(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_) \
    LSA_IDX_TRACE_11(TRACE_SUBSYS_ACP_UPPER, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_)
#endif

#ifndef ACP_UPPER_TRACE_12
#define ACP_UPPER_TRACE_12(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_, para12_) \
    LSA_IDX_TRACE_12(TRACE_SUBSYS_ACP_UPPER, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_, para12_)
#endif
...
#ifndef ACP_LOWER_TRACE_00
#define ACP_LOWER_TRACE_00(idx_, level_, msg_) \
    LSA_IDX_TRACE_00(TRACE_SUBSYS_ACP_LOWER, idx_, level_, msg_)
#endif

#ifndef ACP_LOWER_TRACE_01
#define ACP_LOWER_TRACE_01(idx_, level_, msg_, para1_) \
    LSA_IDX_TRACE_01(TRACE_SUBSYS_ACP_LOWER, idx_, level_, msg_, para1_)
#endif

#ifndef ACP_LOWER_TRACE_02
#define ACP_LOWER_TRACE_02(idx_, level_, msg_, para1_, para2_) \
    LSA_IDX_TRACE_02(TRACE_SUBSYS_ACP_LOWER, idx_, level_, msg_, para1_, para2_)
#endif

#ifndef ACP_LOWER_TRACE_03
#define ACP_LOWER_TRACE_03(idx_, level_, msg_, para1_, para2_, para3_) \
    LSA_IDX_TRACE_03(TRACE_SUBSYS_ACP_LOWER, idx_, level_, msg_, para1_, para2_, para3_)
#endif

#ifndef ACP_LOWER_TRACE_04
#define ACP_LOWER_TRACE_04(idx_, level_, msg_, para1_, para2_, para3_, para4_) \
    LSA_IDX_TRACE_04(TRACE_SUBSYS_ACP_LOWER, idx_, level_, msg_, para1_, para2_, para3_, para4_)
#endif

#ifndef ACP_LOWER_TRACE_05
#define ACP_LOWER_TRACE_05(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_) \
    LSA_IDX_TRACE_05(TRACE_SUBSYS_ACP_LOWER, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_)
#endif

#ifndef ACP_LOWER_TRACE_06
#define ACP_LOWER_TRACE_06(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_) \
    LSA_IDX_TRACE_06(TRACE_SUBSYS_ACP_LOWER, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_)
#endif

#ifndef ACP_LOWER_TRACE_07
#define ACP_LOWER_TRACE_07(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_) \
    LSA_IDX_TRACE_07(TRACE_SUBSYS_ACP_LOWER, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_)
#endif

#ifndef ACP_LOWER_TRACE_08
#define ACP_LOWER_TRACE_08(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_) \
    LSA_IDX_TRACE_08(TRACE_SUBSYS_ACP_LOWER, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_)
#endif

#ifndef ACP_LOWER_TRACE_09
#define ACP_LOWER_TRACE_09(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_) \
    LSA_IDX_TRACE_09(TRACE_SUBSYS_ACP_LOWER, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_)
#endif

#ifndef ACP_LOWER_TRACE_10
#define ACP_LOWER_TRACE_10(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_) \
    LSA_IDX_TRACE_10(TRACE_SUBSYS_ACP_LOWER, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_)
#endif

#ifndef ACP_LOWER_TRACE_11
#define ACP_LOWER_TRACE_11(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_) \
    LSA_IDX_TRACE_11(TRACE_SUBSYS_ACP_LOWER, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_)
#endif

#ifndef ACP_LOWER_TRACE_12
#define ACP_LOWER_TRACE_12(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_, para12_) \
    LSA_IDX_TRACE_12(TRACE_SUBSYS_ACP_LOWER, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_, para12_)
#endif
...
#ifndef ACP_MEM_TRACE_00
#define ACP_MEM_TRACE_00(idx_, level_, msg_) \
    LSA_IDX_TRACE_00(TRACE_SUBSYS_ACP_MEMORY, idx_, level_, msg_)
#endif

#ifndef ACP_MEM_TRACE_01
#define ACP_MEM_TRACE_01(idx_, level_, msg_, para1_) \
    LSA_IDX_TRACE_01(TRACE_SUBSYS_ACP_MEMORY, idx_, level_, msg_, para1_)
#endif

#ifndef ACP_MEM_TRACE_02
#define ACP_MEM_TRACE_02(idx_, level_, msg_, para1_, para2_) \
    LSA_IDX_TRACE_02(TRACE_SUBSYS_ACP_MEMORY, idx_, level_, msg_, para1_, para2_)
#endif

#ifndef ACP_MEM_TRACE_03
#define ACP_MEM_TRACE_03(idx_, level_, msg_, para1_, para2_, para3_) \
    LSA_IDX_TRACE_03(TRACE_SUBSYS_ACP_MEMORY, idx_, level_, msg_, para1_, para2_, para3_)
#endif

#ifndef ACP_MEM_TRACE_04
#define ACP_MEM_TRACE_04(idx_, level_, msg_, para1_, para2_, para3_, para4_) \
    LSA_IDX_TRACE_04(TRACE_SUBSYS_ACP_MEMORY, idx_, level_, msg_, para1_, para2_, para3_, para4_)
#endif
...
#ifndef ACP_RTA_TRACE_00
#define ACP_RTA_TRACE_00(idx_, level_, msg_) \
    LSA_IDX_TRACE_00(TRACE_SUBSYS_ACP_RTA, idx_, level_, msg_)
#endif

#ifndef ACP_RTA_TRACE_01
#define ACP_RTA_TRACE_01(idx_, level_, msg_, para1_) \
    LSA_IDX_TRACE_01(TRACE_SUBSYS_ACP_RTA, idx_, level_, msg_, para1_)
#endif

#ifndef ACP_RTA_TRACE_02
#define ACP_RTA_TRACE_02(idx_, level_, msg_, para1_, para2_) \
    LSA_IDX_TRACE_02(TRACE_SUBSYS_ACP_RTA, idx_, level_, msg_, para1_, para2_)
#endif

#ifndef ACP_RTA_TRACE_03
#define ACP_RTA_TRACE_03(idx_, level_, msg_, para1_, para2_, para3_) \
    LSA_IDX_TRACE_03(TRACE_SUBSYS_ACP_RTA, idx_, level_, msg_, para1_, para2_, para3_)
#endif

#ifndef ACP_RTA_TRACE_04
#define ACP_RTA_TRACE_04(idx_, level_, msg_, para1_, para2_, para3_, para4_) \
    LSA_IDX_TRACE_04(TRACE_SUBSYS_ACP_RTA, idx_, level_, msg_, para1_, para2_, para3_, para4_)
#endif

#ifndef ACP_RTA_TRACE_05
#define ACP_RTA_TRACE_05(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_) \
    LSA_IDX_TRACE_05(TRACE_SUBSYS_ACP_RTA, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_)
#endif

#ifndef ACP_RTA_TRACE_06
#define ACP_RTA_TRACE_06(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_) \
    LSA_IDX_TRACE_06(TRACE_SUBSYS_ACP_RTA, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_)
#endif

#ifndef ACP_RTA_TRACE_07
#define ACP_RTA_TRACE_07(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_) \
    LSA_IDX_TRACE_07(TRACE_SUBSYS_ACP_RTA, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_)
#endif

#ifndef ACP_RTA_TRACE_08
#define ACP_RTA_TRACE_08(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_) \
    LSA_IDX_TRACE_08(TRACE_SUBSYS_ACP_RTA, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_)
#endif

#ifndef ACP_RTA_TRACE_09
#define ACP_RTA_TRACE_09(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_) \
    LSA_IDX_TRACE_09(TRACE_SUBSYS_ACP_RTA, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_)
#endif

#ifndef ACP_RTA_TRACE_10
#define ACP_RTA_TRACE_10(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_) \
    LSA_IDX_TRACE_10(TRACE_SUBSYS_ACP_RTA, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_)
#endif

#ifndef ACP_RTA_TRACE_11
#define ACP_RTA_TRACE_11(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_) \
    LSA_IDX_TRACE_11(TRACE_SUBSYS_ACP_RTA, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_)
#endif

#ifndef ACP_RTA_TRACE_12
#define ACP_RTA_TRACE_12(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_, para12_) \
    LSA_IDX_TRACE_12(TRACE_SUBSYS_ACP_RTA, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_, para12_)
#endif
