...
typedef OHA_EDD_LOWER_RQB_TYPE * OHA_EDD_LOWER_RQB_PTR_TYPE;

typedef EDD_RQB_OPEN_CHANNEL_TYPE * OHA_EDD_LOWER_RQB_OPEN_CHANNEL_PTR_TYPE;
typedef EDD_RQB_GET_PARAMS_TYPE   * OHA_EDD_RQB_GET_PARAMS_PTR_TYPE;
typedef EDD_RQB_GET_PORT_PARAMS_TYPE * OHA_EDD_RQB_GET_PORT_PARAMS_PTR_TYPE;
typedef EDD_RQB_LINK_STATUS_IND_PROVIDE_TYPE * OHA_EDD_RQB_LINK_STATUS_IND_PROVIDE_PTR_TYPE;
typedef EDD_RQB_NRT_SET_ARP_FILTER_TYPE * OHA_EDD_RQB_SET_ARP_FILTER_PTR_TYPE;
typedef EDD_RQB_NRT_SET_DCP_FILTER_TYPE * OHA_EDD_RQB_SET_DCP_FILTER_PTR_TYPE;

/* NARE-RQB */
#ifndef OHA_CFG_NO_NARE
typedef NARE_RQB_TYPE    OHA_NARE_LOWER_RQB_TYPE;

typedef OHA_NARE_LOWER_RQB_TYPE * OHA_NARE_LOWER_RQB_PTR_TYPE;
#endif
...
typedef OHA_MRP_LOWER_RQB_TYPE * OHA_MRP_LOWER_RQB_PTR_TYPE;
#endif

/* SOCK-RQB */
typedef SOCK_RQB_TYPE    OHA_SOCK_LOWER_RQB_TYPE;

typedef OHA_SOCK_LOWER_RQB_TYPE * OHA_SOCK_LOWER_RQB_PTR_TYPE;

/* sock doesn't define the pointers */

typedef SOCK_RQB_ARGS_CHANNEL_TYPE  *OHA_SOCK_OPEN_CHANNEL_PTR_TYPE;
typedef SOCK_RQB_ARGS_UDP_OPEN_TYPE *OHA_SOCK_UDP_OPEN_PTR_TYPE;
typedef SOCK_RQB_ARGS_CLOSE_TYPE    *OHA_SOCK_UDP_CLOSE_PTR_TYPE;
typedef SOCK_RQB_ARGS_DATA_TYPE     *OHA_SOCK_UDP_DATA_PTR_TYPE;

/* typedef SOCK_RQB_ARGS_GETHOSTBYNAME_TYPE *OHA_SOCK_GETHOSTBYNAME_PTR_TYPE; */
typedef SOCK_RQB_ARGS_SNMP_ACTIVATE_TYPE   *OHA_SOCK_SNMP_ACTIVATE_PTR_TYPE;
typedef SOCK_RQB_ARGS_SNMP_DEACTIVATE_TYPE *OHA_SOCK_SNMP_DEACTIVATE_PTR_TYPE;
typedef SOCK_RQB_ARGS_SNMP_RECEIVE_TYPE    *OHA_SOCK_SNMP_RECEIVE_PTR_TYPE;


/* DNS-RQB */
#ifdef OHA_CFG_USE_DNS
typedef DNS_RQB_TYPE    OHA_DNS_LOWER_RQB_TYPE;

typedef OHA_DNS_LOWER_RQB_TYPE * OHA_DNS_LOWER_RQB_PTR_TYPE;
#endif

/* DCP-RQB */
typedef DCP_RQB_TYPE    OHA_DCP_LOWER_RQB_TYPE;

typedef OHA_DCP_LOWER_RQB_TYPE * OHA_DCP_LOWER_RQB_PTR_TYPE;

/* LLDP-RQB */
typedef LLDP_RQB_TYPE    OHA_LLDP_LOWER_RQB_TYPE;

typedef OHA_LLDP_LOWER_RQB_TYPE * OHA_LLDP_LOWER_RQB_PTR_TYPE;
...
#ifdef OHA_CFG_USE_DNS
#ifndef OHA_DNS_ALLOC_LOWER_RQB
LSA_VOID OHA_DNS_ALLOC_LOWER_RQB(
    OHA_DNS_LOWER_RQB_PTR_TYPE * lower_rqb_ptr_ptr,
    LSA_USER_ID_TYPE             user_id,
    LSA_UINT16                   length,
    LSA_SYS_PTR_TYPE             sys_ptr
);
...
#ifdef OHA_CFG_USE_DNS
#ifndef OHA_DNS_FREE_LOWER_RQB
LSA_VOID OHA_DNS_FREE_LOWER_RQB(
    LSA_UINT16                  * ret_val_ptr,
    OHA_DNS_LOWER_RQB_PTR_TYPE    lower_rqb_ptr,
    LSA_SYS_PTR_TYPE              sys_ptr
);
...
#ifdef OHA_CFG_USE_DNS
#ifndef OHA_DNS_ALLOC_LOWER_MEM
LSA_VOID OHA_DNS_ALLOC_LOWER_MEM(
    OHA_DNS_LOWER_MEM_PTR_TYPE * lower_mem_ptr_ptr,
    LSA_USER_ID_TYPE             user_id,
    LSA_UINT16                   length,
    LSA_SYS_PTR_TYPE             sys_ptr
);
...
#ifdef OHA_CFG_USE_DNS
#ifndef OHA_DNS_FREE_LOWER_MEM
LSA_VOID OHA_DNS_FREE_LOWER_MEM(
    LSA_UINT16                 * ret_val_ptr,
    OHA_DNS_LOWER_MEM_PTR_TYPE   lower_mem_ptr,
    LSA_SYS_PTR_TYPE             sys_ptr
);
#endif
#endif
