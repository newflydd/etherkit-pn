...
typedef NARE_DCP_LOWER_RQB_TYPE * NARE_DCP_LOWER_RQB_PTR_TYPE;
...
typedef NARE_EDD_LOWER_RQB_TYPE * NARE_EDD_LOWER_RQB_PTR_TYPE;

typedef EDD_RQB_OPEN_CHANNEL_TYPE * NARE_EDD_LOWER_RQB_OPEN_CHANNEL_PTR_TYPE;
typedef EDD_RQB_NRT_SEND_TYPE     * NARE_EDD_LOWER_RQB_NRT_SEND_PTR_TYPE;
typedef EDD_RQB_GET_PARAMS_TYPE   * NARE_EDD_RQB_GET_PARAMS_PTR_TYPE;
