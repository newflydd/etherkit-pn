...
typedef union oha_cbd_path_params_tag
{
    ...
    struct
    {
        LSA_UINT16      NICId;				/* NICId of the if-specific system channels */

        LSA_UINT32      DcpIndicationFilter;/* LSA_FALSE: every dcp indication is sent to the user */
                                            /* 0: all dcp indications are sent to the user */
        ...
        LSA_UINT16      RemaStationFormat; 	/* 0 ... no REMA user channel */
											/* <>0 ..for OHA_OPC_REMA_INDICATION(data_tag=OHA_STATION_DATA) confirmation: */
											/* 1 ... index=OHA_RECORD_INDEX_MULTIPLE_STATION will be indicated */
        ...
        LSA_BOOL        AllowOverlappingSubnet; /*LSA_FALSE: generate diagnosis 0x800D/0x8002 if subnets are overlapping – old behavior */
                                            /*LSA_TRUE: generate diagnosis 0x800D/0x8002 using the rule set of IP forwarding on a longest-match basis */
	} User;

    /* Params for OHA_PATH_TYPE_GLOBAL User Channel */
    struct
    {
        LSA_UINT16      Reserved;            /* no detail                          */
    } Global;
    ...
    /* Params for OHA_PATH_TYPE_DNS Channel */
    struct
    {
        LSA_UINT16      Reserved;            /* no detail                          */
    } Dns;
    ...
    {
        LSA_UINT16      NICId;             /* NIC-specific ID                      */
                                           /* for OHA_OPC_SET_ADDRESS/EMERGENCY, OHA_OPC_DCP_RESPONSE, */
        LSA_BOOL        CheckIpEnabled;    /* and OHA_OPC_PRM_WRITE of a station-record:    */
...
#define OHA_PATH_TYPE_DNS    7   /* System-Channel for DNS  */
#define OHA_PATH_TYPE_MRP    8   /* System-Channel for MRP  */
#define OHA_PATH_TYPE_GLOBAL 9   /* Global User-Channel     */
...
/*@noreturn@*/ LSA_VOID OHA_FATAL_ERROR(
    LSA_UINT16                 length,
...
LSA_EXTERN /*@noreturn@*/ LSA_VOID OHA_FatalError(
