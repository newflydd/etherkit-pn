...
/*  2013-09-02  packing is now controlled by PNIO pcking files               */
...
*  ==========
*/
#define DCP_CDB_SERVER_CHANNEL                      0
#define DCP_CDB_CLIENT_CHANNEL                      1
#define DCP_CDB_ALLOC_LOWER_RQBS_AT_OPEN_CHANNEL    0
#define DCP_CDB_ALLOC_LOWER_RQBS_AT_REQUEST         1
#define DCP_CDB_HELLO_DISABLE                       0
#define DCP_CDB_HELLO_ENABLE                        1
...
typedef struct dcp_detail_tag
{
	...
	LSA_UINT8	ClientCh;				/* DCP_CDB_CLIENT_CHANNEL: Detail extension for client channel exists	            */
										/* DCP_CDB_SERVER_CHANNEL: This is a server channel or DCP_DEV_FSU	                */
	LSA_UINT8	AllocOnRequest;			/* DCP_CDB_ALLOC_LOWER_RQBS_AT_OPEN_CHANNEL: Allocate all lower RBs at open_channel	*/
										/* ------------------------------------------------                                 */
	...
	LSA_UINT8	HelloEnable;			/* DCP_CDB_HELLO_ENABLE: Client channel: Use 10ms HELLO timer				        */
} DCP_DETAIL_TYPE;
...
#define DCP_MAX_SET_OPT_COUNT (DCP_MAX_RSP_DATA_SIZE / DCP_DS_RESULT_MIN_SIZE)
...
LSA_VOID  DCP_SYSTEM_OUT_FCT_ATTR  DCP_SYS_PTR_IS_INITIALIZED(
    LSA_UINT8            DCP_LOCAL_MEM_ATTR *  ret_val_ptr,
    LSA_SYS_PTR_TYPE                           sys_ptr
);
#endif
