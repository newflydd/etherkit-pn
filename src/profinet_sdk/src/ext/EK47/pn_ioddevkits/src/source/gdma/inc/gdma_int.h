...
// ------------------------------------------
#define GDMA_AMODE_INCR_ADDR                             0   // increment address
#define GDMA_AMODE_INCR_HOLD                             2   // hold address
...
#define GDMA_JOB_STATUS     ((volatile LSA_UINT32*) (GDMA_CFG_BASE_ADDRESS + 0x90))
 ...
 */
#define GDMA_LSA_COMPONENT_ID                   0x0000
