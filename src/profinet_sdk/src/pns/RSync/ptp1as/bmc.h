...
/* collect best master properties */
bool updateAnnounceInfo  (struct gPTPd* gPTPd);
void updatePrioVectors   (struct gPTPd* gPTPd);

/* Send announce frame, if we are master */
