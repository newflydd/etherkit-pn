...
#define OEM_DEVKIT_VERSION_HH                   4
#define OEM_DEVKIT_VERSION_H                    7
...
CM_PD_OEM_DATA_TYPE oem_data =
{
        ...
        OEM_DEVKIT_DEV_ANNOTATION_ORDER_ID "                                            ", /* 6ES7 195-3BE00-0YA0*/
...
void tskma_pdb_setup_pndv()
{
    ...
    tskma_pdb_pndv_open_parameter.cm.sys_path_cm[PNDV_INDEX_PATH_EDD_CLRPC_CM] = LSAS_PATH_EDD_CLRPC_CM;    /* index 0 will be opened first */
    tskma_pdb_pndv_open_parameter.cm.sys_path_cm[PNDV_INDEX_PATH_CMPDSV]       = LSAS_PATH_CMPDSV;
    tskma_pdb_pndv_open_parameter.cm.sys_path_cm[PNDV_INDEX_PATH_ACP_CM]       = LSAS_PATH_ACP_CM;
    tskma_pdb_pndv_open_parameter.cm.annotation_ptr                            = TSKMA_IM_GET_ANNOTATION_STR_PTR();
    tskma_pdb_pndv_open_parameter.cm.device_id               				   = TSKMA_IM_DEVICE_ID(); //tskma_dib_device_id();
    ...
    tskma_pdb_pndv_open_parameter.virt_mod.virtmod_used      = 0;
