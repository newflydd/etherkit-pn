...
// *
// *----------------------------------------------------------------*/
static PNIO_UINT32 DecodePackId (PNIO_UINT32 LsaPackId)
{
	...
	{	
		...
		case LSA_COMP_ID_DCP:		ApiPackId = PNIO_PACKID_DCP;	break;
		case LSA_COMP_ID_EDD:		ApiPackId = PNIO_PACKID_EDD;	break;
		case LSA_COMP_ID_GSY:		ApiPackId = PNIO_PACKID_GSY;	break;
		case LSA_COMP_ID_IODAPI:	ApiPackId = PNIO_PACKID_IOD;	break;
		case LSA_COMP_ID_LLDP:		ApiPackId = PNIO_PACKID_LLDP;	break;
		case LSA_COMP_ID_MRP:		ApiPackId = PNIO_PACKID_MRP;	break;
		case LSA_COMP_ID_NARE:		ApiPackId = PNIO_PACKID_NARE;	break;
		case LSA_COMP_ID_OHA:		ApiPackId = PNIO_PACKID_OHA;	break;
		case LSA_COMP_ID_SOCK:		ApiPackId = PNIO_PACKID_SOCK;	break;
		case LSA_COMP_ID_POF:		ApiPackId = PNIO_PACKID_POF;	break;
		case LSA_COMP_ID_LSAS:		ApiPackId = PNIO_PACKID_LSAS;	break;
		case LSA_COMP_ID_TSKMA:		ApiPackId = PNIO_PACKID_TSKMA;	break;
		case LSA_COMP_ID_PNPB:		ApiPackId = PNIO_PACKID_PNPB;	break;
...
// *
// *----------------------------------------------------------------*/
void pcpnio_log (LSA_UINT32 ErrLevel,
				 LSA_UINT32 PackId, 
				 LSA_UINT32 ModId, 
				 LSA_UINT32 LineNum) 
{
...
// *
// *----------------------------------------------------------------*/
void pcpnio_lsa_log (LSA_UINT32 MsgType,
				     LSA_UINT32 PackId, 
					 LSA_UINT32 ModId, 
					 LSA_UINT32 LineNum,
					 LSA_UINT32 Length,
