...
typedef LLDP_EDD_LOWER_RQB_TYPE * LLDP_EDD_LOWER_RQB_PTR_TYPE;

typedef EDD_RQB_OPEN_CHANNEL_TYPE     * LLDP_EDD_LOWER_RQB_OPEN_CHANNEL_PTR_TYPE;
typedef EDD_RQB_NRT_SEND_TYPE         * LLDP_EDD_LOWER_RQB_NRT_SEND_PTR_TYPE;
typedef EDD_RQB_NRT_RECV_TYPE         * LLDP_EDD_LOWER_RQB_NRT_RECV_PTR_TYPE;
typedef EDD_RQB_NRT_CANCEL_TYPE       * LLDP_EDD_LOWER_RQB_NRT_CANCEL_PTR_TYPE;
typedef EDD_RQB_GET_PARAMS_TYPE       * LLDP_EDD_RQB_GET_PARAMS_PTR_TYPE;
typedef EDD_RQB_GET_PORT_PARAMS_TYPE  * LLDP_EDD_RQB_GET_PORT_PARAMS_PTR_TYPE;
typedef EDD_RQB_MULTICAST_TYPE        * LLDP_EDD_RQB_MULTICAST_PTR_TYPE;

typedef EDD_RQB_LINK_STATUS_IND_PROVIDE_TYPE * LLDP_EDD_RQB_LINK_STATUS_IND_PROVIDE_PTR_TYPE;
