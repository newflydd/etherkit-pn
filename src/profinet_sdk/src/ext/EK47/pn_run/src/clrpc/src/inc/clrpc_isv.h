...
typedef struct clrpc_if_object_tag * CLRPC_IF_OBJECT_PTR_TYPE;

typedef struct clrpc_if_object_tag const * CLRPC_IF_OBJECT_CONST_PTR_TYPE;
...
typedef struct clrpc_server_tag * CLRPC_SERVER_PTR_TYPE;
typedef struct clrpc_server_tag const * CLRPC_SERVER_CONST_PTR_TYPE;
...
typedef struct clrpc_scall_tag * CLRPC_SCALL_PTR_TYPE;

typedef struct clrpc_scall_tag const * CLRPC_SCALL_CONST_PTR_TYPE;
