...
extern PULL_PENDING	PullPending;
// *-------------------------------------------------
// *	typedef for PNPB instance data
// *-------------------------------------------------
...
PNIO_UINT32     pnpb_sub_real_entity_from_peri
                     (PNIO_UINT16 EntityInd);
