...
static LLDP_RSP LLDP_TLVSetChassisPortTTLCommon(
    LLDP_COMMON_MEM_PTR_TYPE         *ppTLV,
    LLDP_COMMON_MEM_U32_PTR_TYPE      pTLength,
...
static LLDP_RSP LLDP_TLVGetChassisPortTTLCommon(
    LLDP_COMMON_MEM_PTR_TYPE     *ppTLV,
    LLDP_COMMON_MEM_U32_PTR_TYPE  pTLength,
...
static LLDP_RSP LLDP_TLVValidateMgmAddrLen(
    LLDP_COMMON_MEM_U8_CONST_PTR_TYPE    pTLV,
    LSA_UINT32                            TLength)
{
...
static LLDP_RSP LLDP_TLVValidateVLANNameLen(
    LLDP_COMMON_MEM_U8_CONST_PTR_TYPE    pTLV,
    LSA_UINT32                            TLength)
{
...
static LLDP_RSP LLDP_TLVValidateProtIdentityLen(
    LLDP_COMMON_MEM_U8_CONST_PTR_TYPE    pTLV,
    LSA_UINT32                            TLength)
{
...
LLDP_RSP LLDP_TLVValidateChain(
    ...
    LLDP_COMMON_MEM_BOOL_PTR_TYPE  pEndTLV)
{
    ...
    *pNLength = TLength;
	...
	if (pTLV == 0)
	{
		LLDP_UPPER_TRACE_00(0,LSA_TRACE_LEVEL_FATAL,"LLDP_TLVValidateChain(): pTLV is 0");
    ...
    LLDP_UPPER_MEM_PTR_TYPE      pValue)
{
    ...
    else
    {
        ...
        else
        {
            ...
            /* append TLV */
            LLDP_TLVSetCommon((LLDP_COMMON_MEM_U8_PTR_TYPE *)ppTLV,
                              (LLDP_COMMON_MEM_U32_PTR_TYPE) pTLength,
                              Type,
                              Length,
                              (LLDP_COMMON_MEM_PTR_TYPE) pValue);
...
/*+  Input/Output      LLDP_UPPER_MEM_PTR_TYPE     *ppTLV                   +*/
/*+                    LLDP_UPPER_MEM_U32_PTR_TYPE  pTLength                +*/
...
LLDP_RSP lldp_TLVSetChassisPortTTL(
    LLDP_UPPER_MEM_PTR_TYPE          *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE       pTLength,
    LLDP_TLV_SET_INFO_CONST_PTR_TYPE  pTLVInfo)
{
...
LLDP_RSP lldp_TLVGetChassisPortTTL(
    LLDP_UPPER_MEM_PTR_TYPE     *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE  pTLength,
    LLDP_TLV_GET_INFO_TYPE      *pTLVInfo)
{
...
LLDP_RSP lldp_TLVSetSystemName(
    LLDP_UPPER_MEM_PTR_TYPE                *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE             pTLength,
    LLDP_UPPER_PARAMS_SYSTEM_NAME_PTR_TYPE  pTLVParams)
{
...
LLDP_RSP lldp_TLVSetSystemDescr(
    LLDP_UPPER_MEM_PTR_TYPE                 *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE              pTLength,
    LLDP_UPPER_PARAMS_SYSTEM_DESCR_PTR_TYPE  pTLVParams)
{
...
LLDP_RSP lldp_TLVSetPortVLANID(
    LLDP_UPPER_MEM_PTR_TYPE                       *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE                    pTLength,
...
LLDP_RSP lldp_TLVSetProtIdentity(
    LLDP_UPPER_MEM_PTR_TYPE                  *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE               pTLength,
    LLDP_UPPER_PARAMS_PROTOCOL_IDENTITY_TYPE  pTLVParams)
{
...
LLDP_RSP lldp_TLVSetMACPHYConfigStatus(
    LLDP_UPPER_MEM_PTR_TYPE                                *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE                             pTLength,
...
LLDP_RSP lldp_TLVSetPowerViaMDI(
    LLDP_UPPER_MEM_PTR_TYPE                       *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE                    pTLength,
...
LLDP_RSP lldp_TLVSetMaxFrameSize(
    LLDP_UPPER_MEM_PTR_TYPE                         *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE                      pTLength,
