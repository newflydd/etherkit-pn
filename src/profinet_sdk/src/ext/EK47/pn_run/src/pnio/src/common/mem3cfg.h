...
#define POOL_NUM        ((18 * 6) + 5 + 1)  /* ((POOL_NR_MAX * (EPS_MAX_BOARD_NR + 1)) + EPS_MEM_MAX_USER_POOLS + "eps or mem3 counts different"
                                               see POOL_NR_MAX in <eps_mem.h> */
...
// Note: if activated more memory for each buffer is allocated!!b
