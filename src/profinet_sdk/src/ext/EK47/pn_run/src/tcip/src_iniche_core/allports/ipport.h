...
/*                                                                           */
/*  Configuration of the InterNiche stack based on tcip_iniche_cfg.h         */
/*                                                                           */
/*****************************************************************************/
...
#ifdef _ERRNO_H_ /* INICHE_TCIP_ITGR HU patch: defines in errno.h used */
#define SOCKERRORS_ALREADY
#else
/*===========================================================================*/
/*=== INTERNICHE-DEFINES INSTEAD OF WINDOWS ERRNO ===========================*/
/*===========================================================================*/
#ifndef MCF5235_PLATFORM  /* not MCF5235_PLATFORM */

/* INICHE_TCIP_ITGR to ensure uniqueness of defined values, use 'private' defines; values properly assigned in nptcp.h */
#undef ENOBUFS
#define     ENOBUFS         INICHE_ENOBUFS
#undef ETIMEDOUT
#define     ETIMEDOUT       INICHE_ETIMEDOUT
#undef EISCONN
#define     EISCONN         INICHE_EISCONN
#undef EOPNOTSUPP
#define     EOPNOTSUPP      INICHE_EOPNOTSUPP
#undef ECONNABORTED
#define     ECONNABORTED    INICHE_ECONNABORTED
#undef EWOULDBLOCK
#define     EWOULDBLOCK     INICHE_EWOULDBLOCK
#undef ECONNREFUSED
#define     ECONNREFUSED    INICHE_ECONNREFUSED
#undef ECONNRESET
#define     ECONNRESET      INICHE_ECONNRESET
#undef ENOTCONN
#define     ENOTCONN        INICHE_ENOTCONN
#undef EALREADY
#define     EALREADY        INICHE_EALREADY
#undef EINVAL
#define     EINVAL          INICHE_EINVAL
#undef EMSGSIZE
#define     EMSGSIZE        INICHE_EMSGSIZE
#undef EPIPE
#define     EPIPE           INICHE_EPIPE
#undef EDESTADDRREQ
#define     EDESTADDRREQ    INICHE_EDESTADDRREQ
#undef ESHUTDOWN
#define     ESHUTDOWN       INICHE_ESHUTDOWN
#undef ENOPROTOOPT
#define     ENOPROTOOPT     INICHE_ENOPROTOOPT
#undef EHAVEOOB
#define     EHAVEOOB        INICHE_EHAVEOOB
#undef ENOMEM
#define     ENOMEM          INICHE_ENOMEM
#undef EADDRNOTAVAIL
#define     EADDRNOTAVAIL   INICHE_EADDRNOTAVAIL
#undef EADDRINUSE
#define     EADDRINUSE      INICHE_EADDRINUSE
#undef EAFNOSUPPORT
#define     EAFNOSUPPORT    INICHE_EAFNOSUPPORT
#undef EINPROGRESS
#define     EINPROGRESS     INICHE_EINPROGRESS
#undef ELOWER
#define     ELOWER          INICHE_ELOWER
#undef ENOTSOCK
#define     ENOTSOCK        INICHE_ENOTSOCK
#undef EIEIO
#define     EIEIO           INICHE_EIEIO

#undef ETOOMANYREFS
#define     ETOOMANYREFS    INICHE_ETOOMANYREFS

#undef EFAULT
#define     EFAULT          INICHE_EFAULT
#undef ENETUNREACH
#define     ENETUNREACH     INICHE_ENETUNREACH
...
#define IP_FRAGMENTS    1  /* IP fragment reassembly */ /* disable IP fragmentation, see 1935252 */
