...
static struct NARE_STATIC_TYPE_
{
    /* main-managment of NARE */
    NARE_MGM_TYPE        Mgm;
} g_NARE_Static;

NARE_MGM_PTR_TYPE   g_pNAREInfo;
...
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
NARE_USER_RCTRL_PTR_TYPE NARE_UserGetFreeRCTRL(
...
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
LSA_VOID NARE_UserReleaseRCTRL(
    NARE_HDB_USER_PTR_TYPE      pHDB,
    NARE_USER_RCTRL_PTR_TYPE    pRCtrl)
{
    NARE_ASSERT_NULL_PTR(pHDB);
    ...
    NARE_HDB_USER_PTR_TYPE   *pHDBUser)
{
    ...
    if ( Found )
    {
        ...
        NARE_ALLOC_LOCAL_MEM((NARE_LOCAL_MEM_PTR_TYPE *)&pHDB->UserRCtrl.pTable, RSize);
...
/*+                                                                         +*/
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
static NARE_RSP NAREFreeMgm(LSA_VOID)
{
    NARE_RSP Response;
...
NARE_RSP nare_init(LSA_VOID)
{
    ...
    if (Status == NARE_RSP_OK )
    {
        ...
        g_pNAREInfo->HUser.HandleCnt = NARE_MAX_USER_CHANNELS;
        g_pNAREInfo->HUser.UsedCnt  = 0;
        for ( i=0; i<NARE_MAX_USER_CHANNELS; i++)
        {
        ...
        g_pNAREInfo->HDcp.HandleCnt = NARE_MAX_DCP_CHANNELS;
        g_pNAREInfo->HDcp.UsedCnt   = 0;
        for ( i=0; i<NARE_MAX_DCP_CHANNELS; i++)
        {
        ...
        g_pNAREInfo->HEdd.HandleCnt = NARE_MAX_EDD_CHANNELS;
        g_pNAREInfo->HEdd.UsedCnt   = 0;
        for ( i=0; i<NARE_MAX_EDD_CHANNELS; i++)
        {
...
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
NARE_RSP nare_undo_init(LSA_VOID)
{
