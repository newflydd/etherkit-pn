/*
 * v3.1 August 30, 2011 misclib/tcpcksum.c
...
/*#ifdef MUTE_WARNS*/    /* stifle compiler warnings */  /* INICHE_TCIP_ITGR disable switch to prevent LINT warning, see AP01235682 */
   tcpdata = (char *)NULL;
/*#endif*/   /* MUTE_WARNS */
