...
//  #define ECOS_INSTRUMENT_BUFFER_SIZE			0x2000		    /* 16 Byte/Event * 0x2000  = 128kB */
    ...
    PNIO_VOID* OsIntrumentationBuffer(void)
    {
    	return (PNIO_VOID*) &instrument_buffer;
    }

    PNIO_UINT32 OsIntrumentationBufferSize(void)
    {
    	return sizeof(instrument_buffer);
    }

    PNIO_VOID* OsThreadInfoBuffer(void)
    {
    ...
    PNIO_UINT32 OsThreadInfoBufferSize(void)
    {
	...
	/***************************************************************************/
	void TcpUploadIntrumentationBuffer (PNIO_UINT8* pBuf, PNIO_UINT32 bufSize)
	{
	...
	/***************************************************************************/
	PNIO_UINT32 TcpIntrumentationUpload  (void)
	{
