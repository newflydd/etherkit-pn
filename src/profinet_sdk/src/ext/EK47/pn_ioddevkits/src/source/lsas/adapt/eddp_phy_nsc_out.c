...
#define LSAS_MODULE_ID      113
#define EDDP_MODULE_ID      LTRC_ACT_MODUL_ID /* EDDP_MODULE_ID_EDDP_PHY_NSC */


#ifndef EDDP_CFG_PHY_NSC_MEDIA_TYPE_INTERNAL
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
    ...
    LSA_UINT32          *pDuplexity)
{
    ...
    if ( g_EDDP_PHY_MEDIATYPE[DevId][HwPortID-1] == EDD_MEDIATYPE_FIBER_OPTIC_CABLE )
    {
        ...
        else if (MAUType == EDDP_PHY_MAUTYPE_100BASEPXFD)    //  54/36h
        {
            *pSpeed     = EDD_LINK_SPEED_100;
            *pDuplexity = EDD_LINK_MODE_FULL;
            return EDD_STS_OK;
        }
        else if (MAUType == EDDP_PHY_MAUTYPE_100BASEFXFD)    //  18/12h
        {
            *pSpeed     = EDD_LINK_SPEED_100;
            *pDuplexity = EDD_LINK_MODE_FULL;
            return EDD_STS_OK;
...
#ifdef EDDP_CFG_PHY_NSC_NO_LED_BLINK
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
