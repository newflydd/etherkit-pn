...
/*                                                                           */
/*  08.07.13     AH   Added SupportedCounters EDD_GET_STATISTICS_MIB_TYPE    */
/*                    structure and added Bitmask defines for                */
/*                    SupportedCounters                                      */
/*                                                                           */  
/*  26.07.13     DP   EDDL-development:                                      */ 
/*                    - EDD_DEBUGINFO_IND_PROVIDE_IDENT_EDDL    0x09         */
/*                        (EDDL: IND_PROVIDE)                                */
/*                    - EDD_DEBUGINFO_CONTROL_IDENT_EDDL        0x08         */
/*                        (EDDL: PROVIDER_/CONSUMER_CONTROL)                 */
/*                    - EDD_HW_TYPE_USED_EDDL_I210        0x00000005         */  
/*                        (Intel Springville)                                */
/*                                                                           */  
/*  20.10.13     RZ   EDDL-development:                                      */ 
/*                    Added constants:                                       */
/*                        EDD_CONSADD_TYPE_DEFAULT                           */
/*                        EDD_CONSADD_TYPE_SYSRED                            */
/*                                                                           */  
/*  15.05.14     LG   EDDL-development:                                      */ 
/*                    Added Mode and PTCPSign to EDD_RQB_SET_SYNC_TIME_TYPE  */
/*                    Added constants:                                       */
/*                        EDD_SET_SYNC_PTCP_MODE_ABSOLUTE                    */
/*                        EDD_SET_SYNC_PTCP_MODE_OFFSET                      */
/*                        EDD_SET_SYNC_PTCP_MODE_OFFSET_NEGATIVE             */
/*                        EDD_SET_SYNC_PTCP_MODE_OFFSET_POSITIVE             */
/*  24.09.14     TP   Added EDD_AUTONEG_CAP_NONE                             */
/*                                                                           */  
/*  11.09.14     UL   Service EDD_SRV_PRM_WRITE:                             */
/*                        Added parameter err_offset                         */
/*                    Service EDD_SRV_PRM_END:                               */
/*                        Added parameter err_port_id                        */
/*                        Added parameter err_index                          */
/*                        Added parameter err_offset                         */
/*                        Added parameter err_fault                          */
/*                                                                           */
/*  08.10.14     BV   Service EDD_SRV_PRM_END:                               */
/*                        Added Default values for structure                 */
/*                        EDD_RQB_PRM_END_TYPE                               */
/*                                                                           */
/*  04.11.14     TH   EDD_RQB_GET_PARAMS_TYPE                                */
/*                        removed values:                                    */
/*                            ProviderCyclePhaseMaxByteCnt                   */
/*                            ProvidercyclePhaseMaxCnt                       */
...
/*                              Status                                       */
/*                    removed constants:                                     */
/*                        EDD_CSRT_CONS_EVENT_LEAVING_RED                    */
/*  06.02.15     TH   EDD_RQB_GET_PORT_PARAMS_TYPE                           */
/*                        added values                                       */
/*                              PhyStatus                                    */
/*  05.03.15     BV   EDD_RQB_GET_PORT_PARAMS_TYPE                           */
/*                    removed constants:                                     */
/*                        EDD_CSRT_PROV_EVENT_DROP                           */
/*                        EDD_SRV_RX_OVERLOAD_IND_PROVIDE                    */
/*                    delete struct                                          */
/*                       _EDD_RQB_RX_OVERLOAD_IND_PROVIDE_TYPE               */
/*  29.04.15     AD   Added new hardware type:                               */
/*                      EDD_HW_TYPE_USED_HERA                                */    
/*  21.05.15     GM   EDD_RQB_CSRT_CONSUMER_ADD_TYPE                         */
/*                        added EDD_SRT_DFP_CONSUMER_DATAHOLD_FACTOR_MIN     */
/*                        added EDD_SRT_DFP_CONSUMER_DATAHOLD_FACTOR_MAX     */
/*  13.07.15     HM   EDD_RQB_LINK_STATUS_IND_PROVIDE_TYPE                   */
/*                        IsPOF added                                        */
/*  13.07.15     HM   EDD_RQB_GET_PORT_PARAMS_TYPE                           */
/*                        IsPOF added                                        */
/*  10.09.15     BV   Service EDD_SRV_PRM_CHANGE_PORT added                  */
/*                                                                           */
/*                    Service EDD_SRV_PRM_END                                */
/*                        PortparamsNotApplicable[] added to                 */
/*                                                      EDD_RQB_PRM_END_TYPE */
/*                    Service EDD_SRV_PRM_COMMIT                             */
/*                        ApplyDefaultPortparams[] added to                  */
/*                                                   EDD_RQB_PRM_COMMIT_TYPE */
/*                    Service EDD_SRV_GET_PORT_PARAMS                        */
/*                        IsPulled added to EDD_RQB_GET_PORT_PARAMS_TYPE     */
/*  19.10.15     BV   Service EDD_SRV_PRM_END                                */
/*                        IsModularPort[] added to EDD_RQB_PRM_END_TYPE      */
/*                                                                           */
/*  05.02.16     BJ   EDD_DPB_FEATURE_FRAGTYPE_SUPPORTED_NO                  */
/*                    EDD_DPB_FEATURE_FRAGTYPE_SUPPORTED_STATIC              */
/*                    EDD_DPB_FEATURE_FRAGTYPE_SUPPORTED_DYNAMIC             */
/*                    EDD_DPB_FEATURE_IRTFWDMODE_SUPPORTED_ABSOLUTE          */
/*                    EDD_DPB_FEATURE_IRTFWDMODE_SUPPORTED_RELATIVE          */
/*                        added                                              */
/*  05.04.16    SJ    Added defines:                                         */
/*                           EDD_PROV_BUFFER_PROP_HERA_MEM_TYPE_MASK         */
/*                           EDD_PROV_BUFFER_PROP_HERA_MEM_TYPE_SLOW         */
/*                           EDD_PROV_BUFFER_PROP_HERA_MEM_TYPE_FAST         */
/*                           EDD_PROV_BUFFER_PROP_HERA_MEM_TYPE_INVALID      */
/*                           EDD_PROV_BUFFER_PROP_HERA_MEM_TYPE_UNDEFINED    */
/*                                                                           */
/*  13.04.16     UL   Service EDD_SRV_GET_PARAMS:                            */
/*                    added EDD_HW_TYPE_FEATURE_TIME_MASTER_SUPPORT          */
/*                    added EDD_HW_TYPE_FEATURE_TIME_SLAVE_SUPPORT           */
/*  24.04.16     GM   Service EDD_SRV_SWITCH_SET_PORT_STATE:                 */
/*                    added new data type:                                   */
/*                        EDD_UPPER_SWI_SET_PORT_STATE_PTR_TO_CONST_TYPE     */
/*                    Service EDD_SRV_MULTICAST_FWD_CTRL:                    */
/*                    added new data type:                                   */
/*                        EDD_UPPER_PORTID_MODE_PTR_TO_CONST_TYPE            */
/*  23.05.16     JB   added EDD_FEATURE_SUPPORT_NO_MCMAC_SRCPORT             */
/*                    added EDD_FEATURE_SUPPORT_MCMAC_SRCPORT                */
/*  15.06.16     BV   struct _EDD_RQB_PORTID_MODE_TYPE:                      */
/*                          member PortID renamed to DstPortID               */
/*                          member SrcPortID added                           */
/*                    struct _EDD_RQB_GET_PARAMS_TYPE:                       */
/*                          member FeatureMask added                         */
/*                    added EDD_MAC_ADDR_GROUP_HSYNC                         */
/*                    added EDD_FEATURE_SUPPORT_MCMAC_SRCPORT_MSK            */
/*                    added EDD_FEATURE_SUPPORT_NO_ADD_FWD_RULES             */
/*                    added EDD_FEATURE_SUPPORT_ADD_FWD_RULES                */
/*                    added EDD_FEATURE_SUPPORT_ADD_FWD_RULES_MSK            */
/*                    added EDD_FEATURE_SUPPORT_NO_APPL_EXIST                */
/*                    added EDD_FEATURE_SUPPORT_APPL_EXIST                   */
/*                    added EDD_FEATURE_SUPPORT_APPL_EXIST_MSK               */
/*                    added EDD_NRT_SEND_PRIO_HSYNC                          */
/*                    added EDD_NRT_TX_GRP_HSYNC1_LOW                        */
/*                    added EDD_NRT_TX_GRP_HSYNC1_HIGH                       */
/*                    added EDD_NRT_TX_GRP_HSYNC2_LOW                        */
/*                    added EDD_NRT_TX_GRP_HSYNC2_HIGH                       */
/*                    added EDD_NRT_FRAME_HSYNC                              */
/*  28.06.16     UL   Service EDD_SRV_PRM_INDICATION:                        */
/*                    removed parameter ChannelNumber                        */
/*                    removed define EDD_SRV_PRM_CHANNEL_NUMBER              */
/*  19.09.16     AG   added definitions to suppoert RFC2863-Counter          */
/*  10.08.16     UL   All LSA_BOOL replaced by LSA_UINT8                     */
/*                    EDD_COMMON_MEM_BOOL_PTR_TYPE  removed                  */
/*                    defines for former boolean parameters introduced       */
/*                    new section for system defines common to all EDDs      */
/*                                                                           */
/*  27.10.16     UL   New featuremask EDD_FEATURE_SUPPORT_CLUSTERIP_MSK      */
/*                    Service EDD_SRV_NRT_SET_ARP_FILTER changed:            */
/*                    Only one IP addr at one time possible                  */
/*                    new parameter UserIndex                                */
/*  08.03.17     TP   Changed data type for TxLocalTransferStartNs within    */
/*                    EDD_RESERVED_INTERVAL_IF_RED_TYPE.                     */
/*  12.04.17     UL   EDD_RECORD_SUPPORT_MASK defined                        */
/*  03.05.17     JB   Added EDD_NRT_TX_GRP_IP_VRRP                           */
/*                    and EDD_NRT_FRAME_IP_VRRP                              */
/*  19.10.17     MC   EDD_SRV_GET_LINK_STATUS: Added new parameters:         */
/*                    AddCheckEnabled                                        */
/*                    ChangeReason                                           */
/*                    EDD_SRV_LINK_STATUS_IND_PROVIDE/_EXT: New parameters:  */
/*                    ChangeReason                                           */
/*                    AddCheckEnabled                                        */
/*                    EDD_SRV_GET_PARAMS: Added new parameters:              */
/*                    MaxMRPInterconn_Instances                              */
/*                    SupportedMRPInterconnRole                              */
/*                    New feature flags:                                     */
/*                          MRPInFwdRulesSupported, MRPInOriginatorSupported */
/*                    EDD_SRV_GET_PORT_PARAMS: Added new parameters:         */
/*                    MRPInPort                                              */
/*                    MaxMRPIn_Instances -> MaxMRPInterconn_Instances        */
/*                    MRPInSupportedRole -> SupportedMRPInterconnRole        */
/*                    EDD_MRP_IN_ROLE_CAP_xxx ->                             */
/*                                  EDD_SUPPORTED_MRP_INTERCONN_ROLE_CAP_xxx */
/*                    MRPInPort -> SupportsMRPInterconnPortConfig            */
/*                    EDD_MRP_NO_IN_PORT/EDD_MRP_IN_PORT ->                  */
/*                    EDD_SUPPORTS_MRP_INTERCONN_PORT_CONFIG_NO/_YES         */
/*                    MRPInFwdRulesSupported -> MRPInterconnFwdRulesSupported*/
/*                MRPInOriginatorSupported -> MRPInterconnOriginatorSupported*/
/*    EDD_FEATURE_SUPPORT_MRP_IN_xxx -> EDD_FEATURE_SUPPORT_MRP_INTERCONN_xxx*/
/*  22.01.18     LU   New type EDD_APPL_SYNC_TIME_VALUES_TYPE added.         */
/*                                                                           */
/*  07.06.18     BV   IsPOF renamed to OpticalTransType                      */
/*                                                                           */
#endif
...
/*      EDD_SRV_RX_OVERLOAD_IND_PROVIDE                 (EDD_SERVICE)   0x230a*/
...
#define EDD_SRV_PRM_CHANGE_PORT                         (EDD_SERVICE)   0x2706
...
/*---------------------------------------------------------------------------*/
/* System defines common to all EDDs                                         */
/*---------------------------------------------------------------------------*/
/* Feature flags for EDDx_SRV_DEV_OPEN. The settings have to match the capa- */
/* bilities of the HW/EDD used, or can downgrade its possibilities.          */
/* Support of fragmentation */
#define EDD_DPB_FEATURE_FRAGTYPE_SUPPORTED_NO           0     /* No fragmentation supported        */
#define EDD_DPB_FEATURE_FRAGTYPE_SUPPORTED_STATIC       1     /* Static fragmentation supported    */
#define EDD_DPB_FEATURE_FRAGTYPE_SUPPORTED_DYNAMIC      2     /* Dynamic fragmentation supported   */

/* Type of IRT forwarding mode */ 
#define EDD_DPB_FEATURE_IRTFWDMODE_SUPPORTED_ABSOLUTE   0x01  /* Absolute forwarding of IRT frames */
#define EDD_DPB_FEATURE_IRTFWDMODE_SUPPORTED_RELATIVE   0x02  /* Relative forwarding of IRT frames */

/* General                                                                   */
#define EDD_FEATURE_DISABLE                 0
#define EDD_FEATURE_ENABLE                  1

/* CDB                                                                       */
//InsertSrcMAC
#define EDD_CDB_INSERT_SRC_MAC_DISABLED     0
#define EDD_CDB_INSERT_SRC_MAC_ENABLED      1

//UsePRM, UseCSRT, UseNRT, UseXRT, UseSWITCH, UseSYNC, UseK32, UseCRt
#define EDD_CDB_CHANNEL_USE_OFF             0
#define EDD_CDB_CHANNEL_USE_ON              1

/* SYS (DPB, DSB, COMP_INI)                                                  */
//PortDataAdjustLesserCheckQuality
#define EDD_SYS_PDPORTDATAADJUST_CHECK_FOR_PNIO_STANDARD    0
#define EDD_SYS_PDPORTDATAADJUST_LESSER_CHECK_QUALITY       1

//FeedInLoadLimitationActive
#define EDD_SYS_FILL_INACTIVE               0
#define EDD_SYS_FILL_ACTIVE                 1

//IO_Configured
#define EDD_SYS_IO_CONFIGURED_OFF           0
#define EDD_SYS_IO_CONFIGURED_ON            1

//RxFilterUDP_Broadcast, RxFilterUDP_Unicast
#define EDD_SYS_UDP_WHITELIST_FILTER_OFF    0
#define EDD_SYS_UDP_WHITELIST_FILTER_ON     1

#define EDD_MRA_ENABLE_LEGACY_MODE          1   // This device supports MRA mode 1.0 (legacy). Not conforming to IEC62439-2 Ed.2. 
#define EDD_MRA_DISABLE_LEGACY_MODE         0   // This device supports MRA mode 2.0.

/* I2C-API                                                                  */
// EDDI_I2C_SELECT / EDDP_I2C_SELECT
#define EDD_I2C_DEVICE_NOT_ACTIVATED     0   //I2C device was not activated
#define EDD_I2C_DEVICE_ACTIVATED         1   //I2C device was activated

/* FX-TRANSCEIVER-TYPES                                                     */
#define EDD_FX_TRANSCEIVER_QFBR5978        0
#define EDD_FX_TRANSCEIVER_AFBR59E4APZ     1
#define EDD_FX_TRANSCEIVER_HFBR5803        2
#define EDD_FX_TRANSCEIVER_QFBR5978_2      3
#define EDD_FX_TRANSCEIVER_UNKNOWN         4
#define EDD_FX_TRANSCEIVER_MAX             EDD_FX_TRANSCEIVER_UNKNOWN
...
} EDD_MAC_ADR_TYPE, *EDD_MAC_ADR_PTR_TYPE;
...
#define EDD_DEBUGINFO_IND_PROVIDE_IDENT_EDDL    0x09    /* EDDL: IND_PROVIDE */
...
#define EDD_DEBUGINFO_CONTROL_IDENT_EDDL        0x08    /* EDDL: PROVIDER_/CONSUMER_CONTROL */
...
#define EDD_HANDLE_LOWER_TYPE           LSA_VOID *
...
{
    EDD_HANDLE_LOWER_TYPE             HandleLower;        /* returned EDD-Handle */
...
/* CheckEnabled       :   Additional link check protocol enabled        (out)*/

#define EDD_LINK_ADD_CHECK_DISABLED 0
#define EDD_LINK_ADD_CHECK_ENABLED  1

/* ChangeReason       :   Reason why change of link state was detected  (out)*/
/*                        (used only in conjunction with CheckEnabled)       */

#define EDD_LINK_CHANGE_REASON_NONE         0  /* No additional link check protocol or did not affect link status */
#define EDD_LINK_CHANGE_REASON_UNDEFINED    1  /* Link status change enforced by additional link check protocol,  */
                                               /* but reason cannot be identified in more detail                  */
#define EDD_LINK_CHANGE_REASON_RDI          2  /* Link status change enforced by additional link check protocol,  */
                                               /* reason was Remote Defect Indication                             */
#define EDD_LINK_CHANGE_REASON_TIMEOUT      3  /* Link status change enforced by additional link check protocol,  */
                                               /* reason was frame reception timeout                              */
#define EDD_LINK_CHANGE_REASON_PHY_PROBLEMS 4  /* Link status change enforced by additional link check protocol,  */
                                               /* reason was PHY/hardware problem                                 */
...
/* OpticalTransType   :   TransType if Media Type==optical        (in *)(out)*/
/* ShortPreamble      :   ShortPreamble active for sending        (in *)(out)*/
/*                        EDD_PORT_SHORT_PREAMBLE : Preamble length: 1 Byte  */
/*                        EDD_PORT_LONG_PREAMBLE  : Preamble length: 7 Bytes */
/* TxFragmentation    :   Tx frame fragmentation activated?       (in *)(out)*/
/*                        EDD_PORT_TX_FRAGMENTATION:    activated            */
/*                        EDD_PORT_NO_TX_FRAGMENTATION: not activated        */
/* AddCheckEnabled    :   Additional link check protocol is enabled/disabled */
/* ChangeReason       :   Reason for the link change performed by an         */
/*                        additional link check protocol                     */
...
/* Others */
#define EDD_PORT_OPTICALTYPE_ISSFP          2
#define EDD_PORT_OPTICALTYPE_ISPOF          1
#define EDD_PORT_OPTICALTYPE_ISOTHER        0
//#define EDD_PORT_OPTICALTYPE_ISNONPOF       0
#define EDD_PORT_LONG_PREAMBLE              0
#define EDD_PORT_SHORT_PREAMBLE             1
#define EDD_PORT_NO_TX_FRAGMENTATION        0
#define EDD_PORT_TX_FRAGMENTATION           1
#define EDD_PORT_SYNCID0_TOPO_NOT_OK        0
#define EDD_PORT_SYNCID0_TOPO_OK            1
...
{
    LSA_UINT16                         DstPortID;
    LSA_UINT16                         Mode;
    LSA_UINT16                         SrcPortID;
} EDD_RQB_PORTID_MODE_TYPE;

typedef struct _EDD_RQB_PORTID_MODE_TYPE    EDD_UPPER_MEM_ATTR *        EDD_UPPER_PORTID_MODE_PTR_TYPE;
typedef struct _EDD_RQB_PORTID_MODE_TYPE    EDD_UPPER_MEM_ATTR const *  EDD_UPPER_PORTID_MODE_PTR_TO_CONST_TYPE;

/* DstPortID             :   Port to set forwarding for.                   (in) */
/*                           range: 1..FFFF                                     */
/* Mode                  :   Mode of function                              (in) */
/* SrcPortID             :   Used to create a 1:1 forwarding relation      (in) */
...
#define EDD_MAC_ADDR_GROUP_HSYNC     5
...
#define EDD_MAC_ADDR_GROUP_MRP_IN_1 11
#define EDD_MAC_ADDR_GROUP_MRP_IN_2 12
#define EDD_MAC_ADDR_GROUP_MRP_IN_3 13
#define EDD_MAC_ADDR_GROUP_DLR_1    14
#define EDD_MAC_ADDR_GROUP_DLR_2    15
#define EDD_MAC_ADDR_GROUP_DLR_3    16
...
typedef struct _EDD_RQB_GET_PARAMS_TYPE
{
    ...
    LSA_UINT8                            ConsumerCntClass12Combined;
...
/*                        Bit  28     EDD-Feature: TIME slave support                            */
/*                        Bit  29     EDD-Feature: TIME master support                           */
...
#define EDD_HW_TYPE_USED_EDDL_I210                              0x00000005   /* Intel Springville i210             */
#define EDD_HW_TYPE_USED_HERA                                   0x00000006   /* HERA hardware support              */
#define EDD_HW_TYPE_USED_RZT2                                   0x00000007   /* RZ/T2 hardware support              */
...
/* Feature: TIME slave support                   */
#define EDD_HW_TYPE_FEATURE_TIME_SLAVE_MSK                      0x10000000   /* Bit 28: TIME slave supported?      */
#define EDD_HW_TYPE_FEATURE_TIME_SLAVE_SUPPORT                  0x10000000   /* Yes                                */
#define EDD_HW_TYPE_FEATURE_TIME_SLAVE_NO_SUPPORT               0x00000000   /* No                                 */

/* Feature:  TIME master support                  */
#define EDD_HW_TYPE_FEATURE_TIME_MASTER_MSK                     0x20000000   /* Bit 29: TIME master supported?     */
#define EDD_HW_TYPE_FEATURE_TIME_MASTER_SUPPORT                 0x20000000   /* Yes                                */
#define EDD_HW_TYPE_FEATURE_TIME_MASTER_NO_SUPPORT              0x00000000   /* No                                 */
...
/* MaxMRPInterconn_Instances  : Number of MRP Interconnection instances         */
/*                              supported for this interface. This parameter is */
/*                              configured within EDD startup.                  */
/*                              0: none. MRP interconnect not supported.        */
...
/*                              interconnection roles if only one MRP instance  */
/*                              is present within parameterization (PRM).       */
/*                              The parameter is configured within EDD on       */
/*                              startup and only forwarded to the user (MRP)    */
/*                              Values can be ORed!                             */

#define EDD_MRP_ROLE_CAP_NONE            0x00
#define EDD_MRP_ROLE_CAP_CLIENT          0x01
#define EDD_MRP_ROLE_CAP_MANAGER         0x02
#define EDD_MRP_ROLE_CAP_AUTOMANAGER     0x04

#define EDD_SUPPORTED_MRP_INTERCONN_ROLE_CAP_NONE         0x00
#define EDD_SUPPORTED_MRP_INTERCONN_ROLE_CAP_CLIENT       0x01
#define EDD_SUPPORTED_MRP_INTERCONN_ROLE_CAP_MANAGER      0x02
#define EDD_SUPPORTED_MRP_INTERCONN_ROLE_CAP_AUTOMANAGER  0x04  

/* HSYNCRole                  : This parameter defines the possible HSYNC roles.*/
/*                              It is configuered within EDD on startup an can  */
/*                              not be changed during runtime                   */
/* MRP RSTP+ and MRPIn roles  : This parameter defines the possible MRP_RSTP+ and */
/*                              MRP interconnection forwarding behavior.          */
/*                              It is configured within EDD on startup and can    */
/*                              not be changed during runtime                     */

#define EDD_FEATURE_SUPPORT_NO_MCMAC_SRCPORT             0x00000000  /*  Source Port ID supported - no           */
#define EDD_FEATURE_SUPPORT_MCMAC_SRCPORT                0x00000001  /*  Source Port ID supported - yes          */
#define EDD_FEATURE_SUPPORT_MCMAC_SRCPORT_MSK            0x00000001
                                                         
#define EDD_FEATURE_SUPPORT_NO_ADD_FWD_RULES             0x00000000  /*  Additional FWD rules for hsync - no     */
#define EDD_FEATURE_SUPPORT_ADD_FWD_RULES                0x00000002  /*  Additional FWD rules for hsync - yes    */
#define EDD_FEATURE_SUPPORT_ADD_FWD_RULES_MSK            0x00000002
                                                         
#define EDD_FEATURE_SUPPORT_NO_APPL_EXIST                0x00000000  /*  Hsync Application supported - no        */
#define EDD_FEATURE_SUPPORT_APPL_EXIST                   0x00000004  /*  Hsync Application supported - yes       */
#define EDD_FEATURE_SUPPORT_APPL_EXIST_MSK               0x00000004
                                                         
#define EDD_FEATURE_SUPPORT_NO_CLUSTERIP                 0x00000000  /*  No ClusterIP support (UC MAC, 2nd ARP filter)*/
#define EDD_FEATURE_SUPPORT_CLUSTERIP                    0x00000008  /*  ClusterIP support (UC MAC, 2nd ARP filter)   */
#define EDD_FEATURE_SUPPORT_CLUSTERIP_MSK                0x00000008

#define EDD_FEATURE_SUPPORT_NO_MRP_INTERCONN_FWD_RULES   0x00000000  /*  MRPInterconnFwdRulesSupported - no    */
#define EDD_FEATURE_SUPPORT_MRP_INTERCONN_FWD_RULES      0x00000010  /*  MRPInterconnFwdRulesSupported - yes   */
#define EDD_FEATURE_SUPPORT_MRP_INTERCONN_FWD_RULES_MSK  0x00000010

#define EDD_FEATURE_SUPPORT_NO_MRP_INTERCONN_ORIGINATOR  0x00000000  /*  MRPInOriginatorSupported - no  */
#define EDD_FEATURE_SUPPORT_MRP_INTERCONN_ORIGINATOR     0x00000020  /*  MRPInOriginatorSupported - yes */
#define EDD_FEATURE_SUPPORT_MRP_INTERCONN_ORIGINATOR_MSK 0x00000020
...
/*                           EDD_CONSUMERCNT_CLASS12_SEPARATE:                  */ 
/*                                          ConsumerCntClass1 and Class2        */
/*                                          defines the ConsumerCnt per class.  */
/*                                          No dependences.                     */
/*                            EDD_CONSUMERCNT_CLASS12_COMBINED:                 */
/*                                          ConsumerCntClass1 and Class2        */
...
#define EDD_CONSUMERCNT_CLASS12_SEPARATE    0
#define EDD_CONSUMERCNT_CLASS12_COMBINED    1
...
/* OpticalTransType           :   TransType if Media Type==optical      (out)*/
...
/* SupportsMRPInterconnPortConfig :   Defines if this port is a         (out)*/
/*                                potential interconnection port             */
/*                                used with MRP interconnection              */
/* HSYNCApplSupport           :   Defines whether this is a HSYNC Ring Port  */
/* IsPulled                   :   Defines whether this port is currently     */
/*                                pulled or plugged                          */
/*                                EDD_PORTMODULE_IS_PULLED: Port is currently pulled.     */
/*                                EDD_PORTMODULE_IS_PLUGGED: Port is currently plugged.    */
...
#define EDD_SUPPORTS_MRP_INTERCONN_PORT_CONFIG_NO      0x00
#define EDD_SUPPORTS_MRP_INTERCONN_PORT_CONFIG_YES     0x01

#define EDD_PORTMODULE_IS_PULLED             1
#define EDD_PORTMODULE_IS_PLUGGED            0
...
#define EDD_LINK_DISABLED      10   /* for edd internal use only ! */
...
#define EDD_AUTONEG_CAP_10BASET            0x00000002 //10MBit over RJ45-Conn�s (2*twistedpair),  half duplex
#define EDD_AUTONEG_CAP_10BASETFD          0x00000004 //10MBit over RJ45-Conn�s (2*twistedpair),  full duplex
#define EDD_AUTONEG_CAP_100BASET4          0x00000008 //100MBit over RJ45-Conn�s (4*twistedpair, CAT3),  half duplex
#define EDD_AUTONEG_CAP_100BASETX          0x00000010 //100MBit over RJ45-Conn�s (2*twistedpair, MLT3-Coding, CAT5),  half duplex
#define EDD_AUTONEG_CAP_100BASETXFD        0x00000020 //100MBit over RJ45-Conn�s (2*twistedpair, MLT3-Coding, CAT5),  full duplex
#define EDD_AUTONEG_CAP_100BASET2          0x00000040 //100MBit over RJ45-Conn�s (2*twistedpair, CAT3),  half duplex
#define EDD_AUTONEG_CAP_100BASET2FD        0x00000080 //100MBit over RJ45-Conn�s (2*twistedpair, CAT3), full duplex
...
#define EDD_AUTONEG_CAP_1000BASET          0x00004000 //1GBit over RJ45-Conn�s (4*twistedpair, CAT5e), half duplex
#define EDD_AUTONEG_CAP_1000BASETFD        0x00008000 //1GBit over RJ45-Conn�s (4*twistedpair, CAT6), full duplex
...
/*                               EDD_PORT_TX_FRAGMENTATION:  activated       */
/*                               EDD_PORT_NO_TX_FRAGMENTATION: not activated */
#define EDD_PORT_IS_NOT_WIRELESS             0
#define EDD_PORT_IS_WIRELESS                 1

#define EDD_PORT_MDIX_DISABLED               0
#define EDD_PORT_MDIX_ENABLED                1
...
/*  Mode                 :  Defines the mode to set the PTCP time.                      */
/*                          Offset mode is only used with EDD_HW_TYPE_USED_EDDL_I210    */

#define EDD_SET_SYNC_PTCP_MODE_ABSOLUTE    0           /* PTCP time is absolute         */
#define EDD_SET_SYNC_PTCP_MODE_OFFSET      1           /* PTCP time is offset           */

/*  PTCPSign             :  Defines the sign of the PTCP offset                         */
/*                          Only used with EDD_SET_SYNC_PTCP_MODE_OFFSET                */

#define EDD_SET_SYNC_PTCP_MODE_OFFSET_NEGATIVE    0    /* PTCP offset is negative       */
#define EDD_SET_SYNC_PTCP_MODE_OFFSET_POSITIVE    1    /* PTCP offset is positive       */

/*  ReferenceTimeStampInTicks: Local reference time (timestamp) in ticks at which the   */
/*                             cycle with the specified PTCP Time should begin.         */
/*                             Only used with EDD_SET_SYNC_PTCP_MODE_ABSOLUTE           */
...
#define EDD_NRT_SEND_PRIO_HSYNC     10  //HSYNC Priority
#define EDD_NRT_SEND_PRIO_MGMT_LOW  11  //LLDP
#define EDD_NRT_SEND_PRIO_MGMT_HIGH 12  //GSY, MRP, MRP interconnection
...
/*                        based on TimeResolutionInNS                        */
#define EDD_SYNC_SEND_TX_TIME_NOT_PRESENT    0
#define EDD_SYNC_SEND_TX_TIME_PRESENT        1
...
/*                      NOTE: EDDI uses this entry now for HSYNC             */
...
#define EDD_NRT_TX_GRP_IP_UDP           4   /* Queue: IP_UDP=2               */
                                            /* IP: protocol 17=UDP           */
#define EDD_NRT_TX_GRP_IP_VRRP          5   /* IP protocol 112=VRRP          */
#define EDD_NRT_TX_GRP_ARP              6   /* Queue: IP_MISC=3              */
                                            /* AddressResolutionProtocol     */
#define EDD_NRT_TX_GRP_DCP              7   /* Queue: DCP=4                  */
                                            /* DeviceControlProtocol or      */
                                            /* xRToverDUP with FrmIDs: DCP   */
#define EDD_NRT_TX_GRP_ASRT             8   /* Queue: ALARM=5                */
                                            /* xRT/xRToverDUP with FrmID:ASRT*/
#define EDD_NRT_TX_GRP_MRP              9   /* Queue: MRP=6                  */
                                            /* MediaRedundancyProtocol       */
#define EDD_NRT_TX_GRP_LEN_TSYNC        10   /* Queue: DEFAULT=0             */
                                            /* LEN types with clocktime sync */
#define EDD_NRT_TX_GRP_LEN_STDBY        11  /* Queue: MRP=6                  */
                                            /* LEN types with STDBY SNAP     */
#define EDD_NRT_TX_GRP_LEN_HSR          12  /* Queue: MRP=6                  */
                                            /* LEN types with HSR SNAP       */
#define EDD_NRT_TX_GRP_LLDP             13  /* Queue: LLDP=7                 */
                                            /* LinkLayerDiscoveryProtocol    */
#define EDD_NRT_TX_GRP_PTCP             14  /* Queue: SYNC=8                 */
                                            /* PrecisionTransparentClockProt.*/
#define EDD_NRT_TX_GRP_HSYNC1_LOW	    15  /* HSYNC Frame send at Ring Port 1 with low  priority */
#define EDD_NRT_TX_GRP_HSYNC1_HIGH	    16  /* HSYNC Frame send at Ring Port 1 with high priority */
#define EDD_NRT_TX_GRP_HSYNC2_LOW	    17  /* HSYNC Frame send at Ring Port 2 with low  priority */
#define EDD_NRT_TX_GRP_HSYNC2_HIGH	    18  /* HSYNC Frame send at Ring Port 2 with high priority */
#define EDD_NRT_TX_GRP_DLR              19  /* Queue: MRP=6                  */
                                            /* DeviceLevelRingProtocol (EtherNet/IP) */
...
typedef struct _EDD_RQB_NRT_RECV_TYPE
{
    ...
    LSA_UINT32                       RxTime;
    LSA_UINT8                        doSwFwd[EDD_CFG_MAX_PORT_CNT];     /* 1) */
...
#define EDD_NRT_FRAME_IP_VRRP       0x00010000L  /*  Virtual Router Redundancy Frame */
#define EDD_NRT_FRAME_IP_OTHER      0x00020000L  /*  all other IP protocols          */
#define EDD_NRT_FRAME_RARP          0x00040000L  /*  reverse-ARP                     */
#define EDD_NRT_FRAME_DCP_HELLO     0x00080000L  /*  DCP-HELLO Frame with xRT-Header */
#define EDD_NRT_FRAME_UDP_DCP_HELLO 0x00100000L  /*  DCP-HELLO Frame with UDP-Header */
#define EDD_NRT_FRAME_LEN_STDBY     0x00200000L  /*  MRP-Standby SNAP Frame          */
#define EDD_NRT_FRAME_LEN_HSR       0x00400000L  /*  HSR SNAP Frame                  */
#define EDD_NRT_FRAME_PTCP_ANNO     0x00800000L  /*  xRT PTCP frames Announce Frames */
#define EDD_NRT_FRAME_PTCP_DELAY    0x01000000L  /*  xRT PTCP frames Delay Frames    */
#define EDD_NRT_FRAME_LEN_SINEC_FWL 0x02000000L  /*  SINEC FW loader                 */
#define EDD_NRT_FRAME_HSYNC         0x04000000L  /*  HSYNC frames                    */
#define EDD_NRT_FRAME_DLR           0x08000000L  /*  DLR frames                      */
...
/* doSwFwd            :   EDD_NRT_RECV_DO_FWD_BY_UPPER_LAYER                 */
/*                                 if user shall forward the frame to   (out)*/
/*                        this port if possible. index 0: PortID 1 etc.      */
/*                        only valid with PTCP frames!                       */
#define EDD_NRT_RECV_DO_NOT_FWD_BY_UPPER_LAYER      0
#define EDD_NRT_RECV_DO_FWD_BY_UPPER_LAYER          1
...
//#define EDD_MAX_ARP_FILTER  1       //1 only. specifies ARP Filters setable with each request. Currently EDDI/EDDS/EDDP support 2/1/1 filters. Will be a common define if all EDDs support 2 filters 
...
/* UserIndex          :   UserIndex of filter (IP-Address)              (in) */
/*                        Range: EDDI: 0, 1; EDDS/EDDP: 0                    */
/* IPAddr             :   IP address used as ARP-Filter.                (in) */
...
#define EDD_CSRT_DSTAT_C_WIN_MASK         ( EDD_CSRT_DSTAT_BIT_STATE            |  \
                                            EDD_CSRT_DSTAT_BIT_REDUNDANCY          \
                                           )
...
/*                                                                           */
/*                        EDD_PROV_BUFFER_PROP_HERA:                         */
/*                                                                           */
/*                         EDDP (HERA):                                      */
/*                          EDD_PROV_BUFFER_PROP_HERA_MEM_TYPE_SLOW:         */
/*                           The ProviderBufferTransferStruct                */ 
/*                           (EDDP_HERA_PROVIDER_BUFFER_TRANSFER_STRUCT_TYPE)*/
/*                           and provider I/O buffer is located within slow  */
/*                           memory region defined by pPPMBaseAddrSlowMem    */
/*                                                                           */
/*                          EDD_PROV_BUFFER_PROP_HERA_MEM_TYPE_FAST:         */
/*                           The ProviderBufferTransferStruct                */ 
/*                           (EDDP_HERA_PROVIDER_BUFFER_TRANSFER_STRUCT_TYPE)*/
/*                           and provider I/O buffer is located within fast  */
/*                           memory region defined by pPPMBaseAddrFastMem    */
/*                                                                           */
/*                          EDD_PROV_BUFFER_PROP_HERA_MEM_TYPE_INVALID       */
/*                          --> no valid properties (causes an EDD PARAM err)*/
/*                                                                           */
...
#define EDD_PROV_BUFFER_PROP_HERA_MEM_TYPE_MASK                 0xF0
#define EDD_PROV_BUFFER_PROP_HERA_MEM_TYPE_SLOW                 0x00
#define EDD_PROV_BUFFER_PROP_HERA_MEM_TYPE_FAST                 0x10
#define EDD_PROV_BUFFER_PROP_HERA_MEM_TYPE_INVALID              0xE0
#define EDD_PROV_BUFFER_PROP_HERA_MEM_TYPE_UNDEFINED            0xF0
...
/* InitValue for local  DataStatus Bits: PRIMARY,NO_REDUNDANCY, DATA_VALID, RUN, OK  */
#define EDD_CSRT_DSTAT_LOCAL_INIT_VALUE    ( EDD_CSRT_DSTAT_BIT_STATE         | \
                                             EDD_CSRT_DSTAT_BIT_DATA_VALID    | \
                                             EDD_CSRT_DSTAT_BIT_STOP_RUN      | \
                                             EDD_CSRT_DSTAT_BIT_STATION_FAILURE \
                                           )
/* InitValue for local System redundancy DataStatus Bits: BACKUP, NO_REDUNDANCY, DATA_VALID, RUN, OK  */
#define EDD_CSRT_SRD_DSTAT_LOCAL_INIT_VALUE    ( EDD_CSRT_DSTAT_BIT_DATA_VALID    | \
                                                 EDD_CSRT_DSTAT_BIT_STOP_RUN      | \
                                                 EDD_CSRT_DSTAT_BIT_STATION_FAILURE \
                                               )
...
/*                        For details see doc.                               */
/*                        Has to be valid with CONS_ADD                      */
/*                        e.g. On ERTEC200P it is only supported if the      */
/*                             PERIF is used for I/O-Buffer handling.        */
/*                             (CRNumber is valid)                           */
/*                                                                           */
/*                        EDDI: not used                                     */
#define EDD_CONS_CLEAR_ON_MISS_DISABLE      0
#define EDD_CONS_CLEAR_ON_MISS_ENABLE       1
...
/*                        Range: 3..255                                      */
/*                        Range: 3..31 (DFP Consumer)                        */

#define EDD_SRT_CONSUMER_DATAHOLD_FACTOR_MIN     3
#define EDD_SRT_CONSUMER_DATAHOLD_FACTOR_MAX   255

#define EDD_SRT_DFP_CONSUMER_DATAHOLD_FACTOR_MIN     3
#define EDD_SRT_DFP_CONSUMER_DATAHOLD_FACTOR_MAX     31

/* UserID             :   UserID used for status-indications                 */
/* ConsumerID         :   ConsumerID returned by EDD                         */
/* IOParams           :   additional IO-Parameters (see above)               */

/* Consumertypes for eddl_io_ConsumerBufferRequest_Add:                      */
/* They CANNOT be ORed!                                                      */
/*                        EDD_CONSADD_TYPE_DEFAULT                           */
/*                            A normal consumer(no DFP, no system redundancy)*/
/*                        EDD_CONSADD_TYPE_SYSRED                            */
/*                            A system redundancy consumer.                  */

#define EDD_CONSADD_TYPE_DEFAULT                    0x03
#define EDD_CONSADD_TYPE_SYSRED                     0x04
...
#define EDD_CONS_DO_NOT_COPY_USER_DATA      0
#define EDD_CONS_DO_COPY_USER_DATA          1
...
typedef struct _EDD_RQB_CSRT_GET_APDU_STATUS
{
    ...
    LSA_UINT8                   Present;    /* APDUStatus present?           */
...
/* Present            :   EDD_CSRT_APDU_STATUS_PRESENT:  APDU-Status         */
/*                        present. APDUStatus  contains valid values (out)   */
/*                    :   EDD_CSRT_APDU_STATUS_NOT_PRESENT: ADPU-Status not  */
/*                        present (maybe no consumer received yet)           */
/* APDUStatus         :   APDU-Status for this Provider or Consumer     (out)*/
#define EDD_CSRT_APDU_STATUS_NOT_PRESENT    0
#define EDD_CSRT_APDU_STATUS_PRESENT        1
...
#define EDD_MIB_SUPPORT_INOCTETS            0x00000001
#define EDD_MIB_SUPPORT_INUCASTPKTS         0x00000002
#define EDD_MIB_SUPPORT_INNUCASTPKTS        0x00000004
#define EDD_MIB_SUPPORT_INDISCARDS          0x00000008
#define EDD_MIB_SUPPORT_INERRORS            0x00000010
#define EDD_MIB_SUPPORT_INUNKNOWNPROTOS     0x00000020
#define EDD_MIB_SUPPORT_OUTOCTETS           0x00000040
#define EDD_MIB_SUPPORT_OUTUCASTPKTS        0x00000080
#define EDD_MIB_SUPPORT_OUTNUCASTPKTS       0x00000100
#define EDD_MIB_SUPPORT_OUTDISCARDS         0x00000200
#define EDD_MIB_SUPPORT_OUTERRORS           0x00000400
#define EDD_MIB_SUPPORT_OUTQLEN             0x00000800
#define EDD_MIB_SUPPORT_INMULTICASTPKTS     0x00001000
#define EDD_MIB_SUPPORT_INBROADCASTPKTS     0x00002000
#define EDD_MIB_SUPPORT_OUTMULTICASTPKTS    0x00004000
#define EDD_MIB_SUPPORT_OUTBROADCASTPKTS    0x00008000
#define EDD_MIB_SUPPORT_INHCOCTETS          0x00010000
#define EDD_MIB_SUPPORT_INHCUCASTPKTS       0x00020000
#define EDD_MIB_SUPPORT_INHCMULTICASTPKTS   0x00040000
#define EDD_MIB_SUPPORT_INHCBROADCASTPKTS   0x00080000
#define EDD_MIB_SUPPORT_OUTHCOCTETS         0x00100000
#define EDD_MIB_SUPPORT_OUTHCUCASTPKTS      0x00200000
#define EDD_MIB_SUPPORT_OUTHCMULTICASTPKTS  0x00400000
#define EDD_MIB_SUPPORT_OUTHCBROADCASTPKTS  0x00800000

#define EDD_STATISTICS_GET_VALUES_RAW_MIB2      1
#define EDD_STATISTICS_GET_VALUES_MIB2          0

#define EDD_STATISTICS_DO_NOT_RESET_VALUES      0
#define EDD_STATISTICS_RESET_VALUES             1

#define EDD_RECORD_SUPPORT_INOCTETS         0x00000001
#define EDD_RECORD_SUPPORT_OUTOCTETS        0x00000002
#define EDD_RECORD_SUPPORT_INDISCARDS       0x00000004
#define EDD_RECORD_SUPPORT_OUTDISCARDS      0x00000008
#define EDD_RECORD_SUPPORT_INERRORS         0x00000010
#define EDD_RECORD_SUPPORT_OUTERRORS        0x00000020
#define EDD_RECORD_SUPPORT_MASK             0x0000003F
...
/*                             RateIntervalNs                                */
#define EDD_SYNC_RATE_INVALID       0
#define EDD_SYNC_RATE_VALID         1
...
typedef struct _EDD_RQB_SWI_SET_PORT_STATE_TYPE EDD_UPPER_MEM_ATTR const *  EDD_UPPER_SWI_SET_PORT_STATE_PTR_TO_CONST_TYPE;
...
typedef struct _EDD_RQB_PRM_WRITE_TYPE   EDD_UPPER_MEM_ATTR const  *   EDD_CONST_UPPER_PRM_WRITE_PTR_TYPE;

/** macro to set values for EDD_RQB_PRM_WRITE_TYPE
 *
 * @param   pPrmWrite       pointer to struct EDD_RQB_PRM_WRITE_TYPE
 * @param   _err_offset     LSA_UINT32 value for err_offset
 */
#define EDD_RQB_PRM_WRITE_SET(pPrmWrite, _err_offset)                           \
{                                                                               \
    ((EDD_UPPER_PRM_WRITE_PTR_TYPE)(pPrmWrite))->err_offset = (_err_offset);    \
}

#define EDD_PRM_PARAMS_ASSIGNED_REMOTE      0
#define EDD_PRM_PARAMS_ASSIGNED_LOCALLY     1
...
/* default values for structure EDD_RQB_PRM_END_TYPE */
#define EDD_PRM_ERR_FAULT_NO_OR_TOO_LESS_PARAMS     0
#define EDD_PRM_ERR_FAULT_WRONG_OR_TOO_MANY_PARAMS  1

#define EDD_PRM_PORT_PARAMS_APPLICABLE          0
#define EDD_PRM_PORT_PARAMS_NOT_APPLICABLE      1

#define EDD_PRM_PORT_IS_COMPACT                 0
#define EDD_PRM_PORT_IS_MODULAR                 1

#define EDD_PRM_ERR_OFFSET_DEFAULT          0
#define EDD_PRM_ERR_INDEX_DEFAULT           0x0000FFFF
#define EDD_PRM_ERR_PORT_ID_DEFAULT         0
#define EDD_PRM_ERR_FAULT_DEFAULT           EDD_PRM_ERR_FAULT_WRONG_OR_TOO_MANY_PARAMS
...
/*---------------------------------------------------------------------------*/
/* Opcode: EDD_OPC_REQUEST  Service: EDD_SRV_PRM_CHANGE_PORT                 */
/*---------------------------------------------------------------------------*/
/* Support:EDDI [x] EDDP [x] EDDS [x]                                        */
/*---------------------------------------------------------------------------*/

#define EDD_PRM_PORTMODULE_PLUG_PREPARE     1
#define EDD_PRM_PORTMODULE_PLUG_COMMIT      2
#define EDD_PRM_PORTMODULE_PULLED           3

#define EDD_PRM_APPLY_RECORD_PORT_PARAMS    0
#define EDD_PRM_APPLY_DEFAULT_PORT_PARAMS   1

typedef struct _EDD_RQB_PRM_CHANGE_PORT_TYPE
{
    LSA_UINT16     PortID;
    LSA_UINT8      ModuleState;
    LSA_UINT8      PortparamsNotApplicable;
    LSA_UINT8      ApplyDefaultPortparams;
} EDD_RQB_PRM_CHANGE_PORT_TYPE;

typedef struct _EDD_RQB_PRM_CHANGE_PORT_TYPE   EDD_UPPER_MEM_ATTR *   EDD_UPPER_PRM_CHANGE_PORT_PTR_TYPE;
...
#define EDD_APPLSYNC_OB_CALL_IN_SEQ       0
#define EDD_APPLSYNC_OB_CALL_LOST         1

typedef struct _EDD_APPL_SYNC_START_PARAM_TYPE
{   
    LSA_UINT8           ApplNr;                 //IN: IRTE:   irrelevant
                                                //    PNIP:   Nr. of ApplTimer. Allowed Values: 1�3
    ...
    LSA_VOID LSA_FCT_PTR(EDD_UPPER_OUT_FCT_ATTR, pCBF) (LSA_USER_ID_TYPE UserID, LSA_UINT8 bOBLoss); //Pointer to the function that is called in case of TM-Int.
...
typedef struct _EDD_APPL_SYNC_TIME_VALUES_TYPE
{
    LSA_UINT32      TimeStamp_ns;        // Unit: Ticks (1ns or 10ns)
    LSA_UINT32      CycleCounterLow;     // Unit: 31,25 us
    LSA_UINT32      ApplTimeOffset_ns;   // Unit: 1ns 
} EDD_APPL_SYNC_TIME_VALUES_TYPE;
...
#define EDD_SWICHAR_RTCLASS_NONE  0x00
#define EDD_SWICHAR_RTCLASS_RTC1  0x01
#define EDD_SWICHAR_RTCLASS_RTC2  0x02
#define EDD_SWICHAR_RTCLASS_RTC3  0x04

#define EDD_SWICHAR_MAXNR_QUEUES              15
#define EDD_SWICHAR_FWD_MODE_CUTTHROUGH        0
#define EDD_SWICHAR_FWD_MODE_STOREANDFORWARD   1

#define EDD_SWICHAR_SCHED_STRATEGY_FIFO                0
#define EDD_SWICHAR_SCHED_STRATEGY_STRICT_PRIORITY     1
#define EDD_SWICHAR_SCHED_STRATEGY_WEIGHTEDROUNDROBIN  2

#define EDD_SWICHAR_QUEUE_STRATEGY_STATIC              0
#define EDD_SWICHAR_QUEUE_STRATEGY_DYNAMIC             1

#define EDD_SWICHAR_FRAME_PRIO_VLAN0      (1<<EDD_NRT_SEND_PRIO_0)
#define EDD_SWICHAR_FRAME_PRIO_VLAN1      (1<<EDD_NRT_SEND_PRIO_1)
#define EDD_SWICHAR_FRAME_PRIO_VLAN2      (1<<EDD_NRT_SEND_PRIO_2)
#define EDD_SWICHAR_FRAME_PRIO_VLAN3      (1<<EDD_NRT_SEND_PRIO_3)
#define EDD_SWICHAR_FRAME_PRIO_VLAN4      (1<<EDD_NRT_SEND_PRIO_4)
#define EDD_SWICHAR_FRAME_PRIO_VLAN5      (1<<EDD_NRT_SEND_PRIO_5)
#define EDD_SWICHAR_FRAME_PRIO_VLAN6      (1<<EDD_NRT_SEND_PRIO_6)
#define EDD_SWICHAR_FRAME_PRIO_VLAN7      (1<<EDD_NRT_SEND_PRIO_7)
#define EDD_SWICHAR_FRAME_PRIO_ASRT_LOW   (1<<EDD_NRT_SEND_PRIO_ASRT_LOW)
#define EDD_SWICHAR_FRAME_PRIO_ASRT_HIGH  (1<<EDD_NRT_SEND_PRIO_ASRT_HIGH)
#define EDD_SWICHAR_FRAME_PRIO_HSYNC      (1<<EDD_NRT_SEND_PRIO_HSYNC)
#define EDD_SWICHAR_FRAME_PRIO_MGMT_LOW   (1<<EDD_NRT_SEND_PRIO_MGMT_LOW)
#define EDD_SWICHAR_FRAME_PRIO_MGMT_HIGH  (1<<EDD_NRT_SEND_PRIO_MGMT_HIGH)
#define EDD_SWICHAR_FRAME_PRIO_RTC1       (EDD_SWICHAR_FRAME_PRIO_MGMT_HIGH + 1)
#define EDD_SWICHAR_FRAME_PRIO_RTC2       (EDD_SWICHAR_FRAME_PRIO_MGMT_HIGH + 2)
#define EDD_SWICHAR_FRAME_PRIO_RTC3       (EDD_SWICHAR_FRAME_PRIO_MGMT_HIGH + 3)

typedef struct _EDD_SWICHAR_ASIC_TYPE
{
  LSA_UINT8    SupportedRTClasses;
  LSA_UINT8    ForwardingMode;
  LSA_UINT8    QueueMemoryStrategy;
  LSA_UINT8    QueueGroupCount;
  LSA_UINT16   SwitchingMemoryGranularity;
  LSA_UINT32   Latency_ns;
} EDD_SWICHAR_ASIC_TYPE;

typedef struct _EDD_SWICHAR_QUEUE_TYPE
{
  LSA_UINT32   QueueGroupMemory;
  LSA_UINT32   PrioMappingPerQueueGroup; 
} EDD_SWICHAR_QUEUE_TYPE;

typedef struct _EDD_SWICHAR_PORT_TYPE
{
  LSA_UINT8    SupportedTransmissionRates;
  LSA_UINT8    SchedulerStrategy;
} EDD_SWICHAR_PORT_TYPE;

typedef struct _EDD_SWICHAR_TYPE
{
    EDD_SWICHAR_ASIC_TYPE  Asic;
    EDD_SWICHAR_QUEUE_TYPE Queue[EDD_SWICHAR_MAXNR_QUEUES];
    EDD_SWICHAR_PORT_TYPE  Port[EDD_CFG_MAX_PORT_CNT];
} EDD_SWICHAR_TYPE;

typedef struct _EDD_SWICHAR_TYPE  *  EDD_UPPER_SWICHAR_PTR_TYPE;
...
#define EDD_RQB_SET_HANDLE_LOWER(_pRQB, _Value) \
    ( (_pRQB)->HandleLower = (_Value) )

#define EDD_RQB_GET_HANDLE_LOWER(_pRQB) \
    ( (_pRQB)->HandleLower )
