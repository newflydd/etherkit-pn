...
#if 1 /* callback-function tcip_mib2_written */
   ...
   long     errindex)
{
   ...
   *(varListPtr-1) = (u_char)errindex; /* INICHE_TCIP_ITGR added cast */
   ...
   USE_ARG(headerLength); /* INICHE_TCPIP_ITGR eliminate MIPS compiler warning "variable 'headerLength' set but not used", see 1911686 */
