...
LSA_IDX_TRACE_00(TRACE_SUBSYS_LLDP_UPPER, idx_,level_, msg_)
#endif
#ifndef LLDP_UPPER_TRACE_01
#define LLDP_UPPER_TRACE_01(idx_, level_, msg_, para1_) \
LSA_IDX_TRACE_01(TRACE_SUBSYS_LLDP_UPPER,idx_, level_, msg_, para1_)
#endif

#ifndef LLDP_UPPER_TRACE_02
#define LLDP_UPPER_TRACE_02(idx_, level_, msg_, para1_, para2_) \
LSA_IDX_TRACE_02(TRACE_SUBSYS_LLDP_UPPER, idx_, level_, msg_, para1_, para2_)
#endif

#ifndef LLDP_UPPER_TRACE_03
#define LLDP_UPPER_TRACE_03(idx_, level_, msg_, para1_, para2_, para3_) \
LSA_IDX_TRACE_03(TRACE_SUBSYS_LLDP_UPPER, idx_, level_, msg_, para1_, para2_, para3_)
#endif

#ifndef LLDP_UPPER_TRACE_04
#define LLDP_UPPER_TRACE_04(idx_, level_, msg_, para1_, para2_, para3_, para4_) \
LSA_IDX_TRACE_04(TRACE_SUBSYS_LLDP_UPPER, idx_, level_, msg_, para1_, para2_, para3_, para4_)
#endif

#ifndef LLDP_LOWER_TRACE_00
#define LLDP_LOWER_TRACE_00(idx_, level_, msg_) \
LSA_IDX_TRACE_00(TRACE_SUBSYS_LLDP_LOWER, idx_, level_, msg_)
#endif

#ifndef LLDP_LOWER_TRACE_01
#define LLDP_LOWER_TRACE_01(idx_, level_, msg_, para1_) \
LSA_IDX_TRACE_01(TRACE_SUBSYS_LLDP_LOWER, idx_, level_, msg_, para1_)
#endif

#ifndef LLDP_LOWER_TRACE_02
#define LLDP_LOWER_TRACE_02(idx_, level_, msg_, para1_, para2_) \
LSA_IDX_TRACE_02(TRACE_SUBSYS_LLDP_LOWER, idx_, level_, msg_, para1_, para2_)
#endif

#ifndef LLDP_LOWER_TRACE_03
#define LLDP_LOWER_TRACE_03(idx_,level_, msg_, para1_, para2_, para3_) \
LSA_IDX_TRACE_03(TRACE_SUBSYS_LLDP_LOWER, idx_, level_, msg_, para1_, para2_, para3_)
#endif

#ifndef LLDP_LOWER_TRACE_04
#define LLDP_LOWER_TRACE_04(idx_,level_, msg_, para1_, para2_, para3_, para4_) \
LSA_IDX_TRACE_04(TRACE_SUBSYS_LLDP_LOWER, idx_, level_, msg_, para1_, para2_, para3_, para4_)
#endif

#ifndef LLDP_SYSTEM_TRACE_00
#define LLDP_SYSTEM_TRACE_00(idx_,level_, msg_) \
LSA_IDX_TRACE_00(TRACE_SUBSYS_LLDP_SYSTEM, idx_, level_, msg_)
#endif

#ifndef LLDP_SYSTEM_TRACE_01
#define LLDP_SYSTEM_TRACE_01(idx_,level_, msg_, para1_) \
LSA_IDX_TRACE_01(TRACE_SUBSYS_LLDP_SYSTEM, idx_, level_, msg_, para1_)
#endif

#ifndef LLDP_SYSTEM_TRACE_02
#define LLDP_SYSTEM_TRACE_02(idx_,level_, msg_, para1_, para2_) \
LSA_IDX_TRACE_02(TRACE_SUBSYS_LLDP_SYSTEM, idx_, level_, msg_, para1_, para2_)
#endif

#ifndef LLDP_SYSTEM_TRACE_03
#define LLDP_SYSTEM_TRACE_03(idx_,level_, msg_, para1_, para2_, para3_) \
LSA_IDX_TRACE_03(TRACE_SUBSYS_LLDP_SYSTEM, idx_, level_, msg_, para1_, para2_, para3_)
#endif

#ifndef LLDP_FUNCTION_TRACE_00
#define LLDP_FUNCTION_TRACE_00(idx_,level_, msg_) \
LSA_IDX_TRACE_00(TRACE_SUBSYS_LLDP_FUNCTION, idx_, level_, msg_)
#endif

#ifndef LLDP_FUNCTION_TRACE_01
#define LLDP_FUNCTION_TRACE_01(idx_,level_, msg_, para1_) \
LSA_IDX_TRACE_01(TRACE_SUBSYS_LLDP_FUNCTION, idx_, level_, msg_, para1_)
#endif

#ifndef LLDP_FUNCTION_TRACE_02
#define LLDP_FUNCTION_TRACE_02(idx_,level_, msg_, para1_, para2_) \
LSA_IDX_TRACE_02(TRACE_SUBSYS_LLDP_FUNCTION, idx_, level_, msg_, para1_, para2_)
#endif

#ifndef LLDP_FUNCTION_TRACE_03
#define LLDP_FUNCTION_TRACE_03(idx_,level_, msg_, para1_, para2_, para3_) \
LSA_IDX_TRACE_03(TRACE_SUBSYS_LLDP_FUNCTION, idx_, level_, msg_, para1_, para2_, para3_)
#endif

#ifndef LLDP_PROGRAM_TRACE_00
#define LLDP_PROGRAM_TRACE_00(idx_,level_, msg_) \
LSA_IDX_TRACE_00(TRACE_SUBSYS_LLDP_PROGRAM, idx_, level_, msg_)
#endif

#ifndef LLDP_PROGRAM_TRACE_01
#define LLDP_PROGRAM_TRACE_01(idx_,level_, msg_, para1_) \
LSA_IDX_TRACE_01(TRACE_SUBSYS_LLDP_PROGRAM, idx_, level_, msg_, para1_)
#endif

#ifndef LLDP_PROGRAM_TRACE_02
#define LLDP_PROGRAM_TRACE_02(idx_,level_, msg_, para1_, para2_) \
LSA_IDX_TRACE_02(TRACE_SUBSYS_LLDP_PROGRAM, idx_, level_, msg_, para1_, para2_)
#endif

#ifndef LLDP_PROGRAM_TRACE_03
#define LLDP_PROGRAM_TRACE_03(idx_,level_, msg_, para1_, para2_, para3_) \
LSA_IDX_TRACE_03(TRACE_SUBSYS_LLDP_PROGRAM, idx_, level_, msg_, para1_, para2_, para3_)
#endif

#ifndef LLDP_PROGRAM_TRACE_04
#define LLDP_PROGRAM_TRACE_04(idx_,level_, msg_, para1_, para2_, para3_, para4_) \
LSA_IDX_TRACE_04(TRACE_SUBSYS_LLDP_PROGRAM, idx_, level_, msg_, para1_, para2_, para3_, para4_)
#endif

#ifndef LLDP_PROGRAM_TRACE_05
#define LLDP_PROGRAM_TRACE_05(idx_,level_, msg_, para1_, para2_, para3_, para4_, para5_) \
LSA_IDX_TRACE_05(TRACE_SUBSYS_LLDP_PROGRAM, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_)
#endif

#ifndef LLDP_PROGRAM_TRACE_06
#define LLDP_PROGRAM_TRACE_06(idx_,level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_) \
LSA_IDX_TRACE_06(TRACE_SUBSYS_LLDP_PROGRAM, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_)
#endif

#ifndef LLDP_PROGRAM_TRACE_08
#define LLDP_PROGRAM_TRACE_08(idx_,level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_) \
LSA_IDX_TRACE_08(TRACE_SUBSYS_LLDP_PROGRAM, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_)
#endif
...
#ifndef LLDP_UPPER_TRACE_04
#define LLDP_UPPER_TRACE_04(idx_, level_, msg_, para1_, para2_, para3_, para4_) \
LSA_TRACE_04(TRACE_SUBSYS_LLDP_UPPER, level_, msg_, para1_, para2_, para3_, para4_)
#endif
...
#ifndef LLDP_LOWER_TRACE_04
#define LLDP_LOWER_TRACE_04(idx_,level_, msg_, para1_, para2_, para3_, para4_) \
LSA_TRACE_04(TRACE_SUBSYS_LLDP_LOWER, level_, msg_, para1_, para2_, para3_, para4_)
#endif
...
#ifndef LLDP_PROGRAM_TRACE_04
#define LLDP_PROGRAM_TRACE_04(idx_,level_, msg_, para1_, para2_, para3_, para4_) \
LSA_TRACE_04(TRACE_SUBSYS_LLDP_PROGRAM, level_, msg_, para1_, para2_, para3_, para4_)
#endif

#ifndef LLDP_PROGRAM_TRACE_05
#define LLDP_PROGRAM_TRACE_05(idx_,level_, msg_, para1_, para2_, para3_, para4_, para5_) \
LSA_TRACE_05(TRACE_SUBSYS_LLDP_PROGRAM, level_, msg_, para1_, para2_, para3_, para4_, para5_)
#endif

#ifndef LLDP_PROGRAM_TRACE_06
#define LLDP_PROGRAM_TRACE_06(idx_,level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_) \
LSA_TRACE_06(TRACE_SUBSYS_LLDP_PROGRAM, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_)
#endif

#ifndef LLDP_PROGRAM_TRACE_08
#define LLDP_PROGRAM_TRACE_08(idx_,level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_) \
LSA_TRACE_08(TRACE_SUBSYS_LLDP_PROGRAM, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_)
#endif
...
#define LLDP_UPPER_TRACE_03(idx_, level_, msg_, para1_, para2_, para3_)
#define LLDP_UPPER_TRACE_04(idx_, level_, msg_, para1_, para2_, para3_, para4_)
#define LLDP_UPPER_TRACE_05(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_)
#define LLDP_UPPER_TRACE_06(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_)
#define LLDP_UPPER_TRACE_07(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_)
#define LLDP_UPPER_TRACE_08(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_)
...
#define LLDP_LOWER_TRACE_03(idx_, level_, msg_, para1_, para2_, para3_)
#define LLDP_LOWER_TRACE_04(idx_, level_, msg_, para1_, para2_, para3_, para4_)
#define LLDP_LOWER_TRACE_05(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_)
#define LLDP_LOWER_TRACE_06(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_)
#define LLDP_LOWER_TRACE_07(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_)
#define LLDP_LOWER_TRACE_08(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_)

#define LLDP_FUNCTION_TRACE_00(idx_, level_, msg_)
#define LLDP_FUNCTION_TRACE_01(idx_, level_, msg_, para1_)
#define LLDP_FUNCTION_TRACE_02(idx_, level_, msg_, para1_, para2_)
#define LLDP_FUNCTION_TRACE_03(idx_, level_, msg_, para1_, para2_, para3_)
#define LLDP_FUNCTION_TRACE_04(idx_, level_, msg_, para1_, para2_, para3_, para4_)
#define LLDP_FUNCTION_TRACE_05(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_)
#define LLDP_FUNCTION_TRACE_06(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_)
#define LLDP_FUNCTION_TRACE_07(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_)
#define LLDP_FUNCTION_TRACE_08(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_)
...
#define LLDP_PROGRAM_TRACE_05(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_)
#define LLDP_PROGRAM_TRACE_06(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_)
#define LLDP_PROGRAM_TRACE_07(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_)
#define LLDP_PROGRAM_TRACE_08(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_)
...
#define LLDP_SYSTEM_TRACE_05(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_)
#define LLDP_SYSTEM_TRACE_06(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_)
#define LLDP_SYSTEM_TRACE_07(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_)
#define LLDP_SYSTEM_TRACE_08(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_)
