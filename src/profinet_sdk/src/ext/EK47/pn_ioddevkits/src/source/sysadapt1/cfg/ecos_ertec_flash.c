...
//    #define FLASH_DEF_TYPE         FLASH_SPI_TYPE
    ...
    #define NUM_FLASH_IMAGES        (2)
        ...
        #define FLASH_USERDATA_START    FLASH_NV_ADDR
        #define FLASH_USERDATA_SIZE     FLASH_NV_SIZE
