/*
 * v3.1 August 30, 2011 tcp/tcpsack.c
...
#if 1 /* INICHE_TCIP_ITGR integrated Fix from InterNiche 29.10.2007 */   
   sack_trigger = tcp_getseq (opt);
#endif
...
#if 0 /* INICHE_TCIP_ITGR moved to above, see "Fix from InterNiche 29.10.2007" */
   sack_trigger = tcp_getseq(opt);    /* seq # that caused SACK */ 
#endif
