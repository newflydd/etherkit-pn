...
#ifdef TEMPORARY_MEASURES_WHEN_USING_QSPI_AND_HYPERFLASH_AT_THE_SAME_TIME
...
#ifdef TEMPORARY_MEASURES_WHEN_USING_QSPI_AND_HYPERFLASH_AT_THE_SAME_TIME
                                    (0 << XSPI_QSPI_PRV_BMCFG_MWRCOMB_OFFSET) |
#else
...
#ifndef TEMPORARY_MEASURES_WHEN_USING_QSPI_AND_HYPERFLASH_AT_THE_SAME_TIME
