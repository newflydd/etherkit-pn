    ...
    void trace_response(void* buff, unsigned int buf_length)
    {
        ...
        switch (ping_buffer_header->opcode)
        {
            case TRACE_RESPONSE_OPCODE_SETTRACELVL:                          /* set new tracelevel */
            {
                ...
                TRACE_MEMCPY(&trace_config.maxtracelevel, (void*)((TRACE_UINT32)buff + TRACE_PBHEADER_SIZE), sizeof(trace_config.maxtracelevel));
                ...
                switch (ping_buffer_header->param)
                {
                    default:
                    {
                        ...
                        else
                        {
                            ...
                            tb_seq = (void *)trace_raw_addr;
                            TRACE_MEMCPY((void*)((TRACE_UINT32)buff+TRACE_PBHEADER_SIZE), (void*)((TRACE_UINT32)tb_seq+a), (b-a+1));       /* copy data to ping buffer */
                        }
                        break;
                    }
        ...
        case TRACE_RESPONSE_OPCODE_STATUS:                          /* status */
            ...
            TRACE_MEMCPY((void*)((TRACE_UINT32)buff+TRACE_PBHEADER_SIZE), (void*)&trace_config, sizeof(trace_config));
            ...
            TRACE_MEMCPY( (void*)((TRACE_UINT32)buff+a), &trace_autoread_table_end, sizeof(TRACE_AUTOREAD_ENTRY) );    /* add to buffer */
            a = a + sizeof(TRACE_AUTOREAD_ENTRY);
            /* autoread table */
