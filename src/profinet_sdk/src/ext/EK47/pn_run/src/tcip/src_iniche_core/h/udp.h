/*
 * v3.1 February 9, 2012 h/udp.h (SNMP bugfix)
 * v3.1 August 30, 2011 h/udp.h
 ...
 * IPv4 Hdr is 20 bytes and ethernet header is 14 bytes 
 */
 ...
 */
#ifdef TCIP_CFG_ALIGN_HEADERS /*INICHE_TCIP_ITGR patch  see AP01479236 */
...
/* Figure out a minimum value 
 * IPv6 Hdr is 40 bytes and ethernet header is 14 bytes 
 */
#define UDP_LLHDR6 (54 + ETHHDR_BIAS  + IPSECOPT_SIZE) 

#ifdef USE_PPPOE
#define  UDPHDRSMINLEN6  (10 + UDP_LLHDR6)
#elif  defined(IEEE_802_3)
#define  UDPHDRSMINLEN6  (8 + UDP_LLHDR6)
#else
#define  UDPHDRSMINLEN6  UDP_LLHDR6
#endif

/* Figure out the actual value: minimum value padded out to 
 * a multiple of ALIGN_TYPE
 */
#if ((UDPHDRSMINLEN6 & (ALIGN_TYPE - 1)) == 0)
#define  UDPHDRSLEN6  UDPHDRSMINLEN6
#else
#define  UDPHDRSLEN6  (UDPHDRSMINLEN6 + ALIGN_TYPE - (UDPHDRSMINLEN6 & (ALIGN_TYPE - 1)))
#endif
...
#ifdef INCLUDE_SNMP
/* RFC 1213 (udpTable) */
/* length of index (udpLocalAddress, udpLocalPort) for udpTable (in bytes) */
#define UDP_TBL_IDX_LEN 6
/* start offset of udpLocalAddress in index */
#define UDP_TBL_IDX_LADDR_OFF 0
/* start offset of udpLocalPort in index */
#define UDP_TBL_IDX_LPORT_OFF 4
#endif
