...
#define NARE_FATAL_ERR_reserved_0x08       (NARE_FATAL_ERROR_TYPE)  0x08
...
#define NARE_PATH_TYPE_2      2   /* reserved                */
...
LSA_UINT16 nare_undo_init(LSA_VOID);
...
typedef NARE_ARP_FRAME_HEADER_VLAN_TYPE * NARE_ARP_FRAME_HEADER_VLAN_PTR_TYPE;
typedef NARE_ARP_FRAME_CONTENT_TYPE     * NARE_ARP_FRAME_CONTENT_PTR_TYPE;
typedef NARE_ARP_FRAME_TYPE             * NARE_ARP_FRAME_PTR_TYPE;
...
#error "MAC-Addr size != 6 not supported! "
#endif
...
typedef NARE_DCP_IDENT_REQ_TLV_TYPE * NARE_DCP_IDENT_REQ_TLV_PTR_TYPE;
...
typedef NARE_DCP_IDENT_RSP_TLV_TYPE * NARE_DCP_IDENT_RSP_TLV_PTR_TYPE;
...
typedef NARE_DCP_SET_REQ_TLV_TYPE * NARE_DCP_SET_REQ_TLV_PTR_TYPE;
...
typedef NARE_DCP_SET_RSP_TLV_TYPE * NARE_DCP_SET_RSP_TLV_PTR_TYPE;
