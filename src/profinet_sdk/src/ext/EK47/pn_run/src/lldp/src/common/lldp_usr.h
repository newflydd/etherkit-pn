...
#define LLDP_UPPER_MEM_U32_CONST_PTR_TYPE          /* pointer to upper-memory */ \
LSA_UINT32                   const *
...
#define LLDP_COMMON_MEM_U8_CONST_PTR_TYPE            /* pointer to common-memory */ \
LSA_UINT8                    const *
...
typedef struct _LLDP_RQB_TYPE * LLDP_UPPER_RQB_PTR_TYPE;
...
typedef struct _LLDP_RQB_OPEN_CHANNEL_TYPE * LLDP_UPPER_OPEN_CHANNEL_PTR_TYPE;
...
typedef struct _LLDP_RQB_GET_CONFIG_TYPE * LLDP_UPPER_GET_CONFIG_PTR_TYPE;
...
typedef struct _LLDP_RQB_SET_TYPE * LLDP_UPPER_SET_PTR_TYPE;
...
typedef struct _LLDP_RQB_START_TYPE * LLDP_UPPER_START_PTR_TYPE;
...
typedef struct _LLDP_RQB_STOP_TYPE * LLDP_UPPER_STOP_PTR_TYPE;
...
typedef struct _LLDP_UPPER_TLV_TYPE * LLDP_UPPER_TLV_PTR_TYPE;
...
typedef struct _LLDP_RQB_INDICATION_PROVIDE_TYPE * LLDP_UPPER_INDICATION_PROVIDE_PTR_TYPE;
...
#define LLDP_PRESENT_NO  0
#define LLDP_PRESENT_YES 1

typedef struct _LLDP_RQB_GET_TYPE
{
    LSA_UINT16                 PORTId;                      /* in  */
    LSA_UINT16                 SenderId;                    /* in  */
    LSA_UINT8                  Present;                     /* out: if no Valid tlv chain exists: LLDP_PRESENT_NO / if Valid tlv chain exists: LLDP_PRESENT_YES */
    LLDP_MAC_TYPE              MACAddr;                     /* out */
    LLDP_UPPER_TLV_PTR_TYPE    pTLV;                        /* in/out */
    LSA_UINT32                 TLVLength;                   /* out */
} LLDP_RQB_GET_TYPE;

typedef struct _LLDP_RQB_GET_TYPE * LLDP_UPPER_GET_PTR_TYPE;

/*---------------------------------------------------------------------------*/
/* Opcode: LLDP_OPC_STATS                                                    */
/*---------------------------------------------------------------------------*/

#define LLDP_RESET_STATS_NO  0
#define LLDP_RESET_STATS_YES 1
...
{
    LSA_UINT16              PORTId;                         /* in  */
    LSA_UINT8               Reset;                          /* in: Set to zero after Readout: LLDP_RESET_STATS_YES / Set not to zero after Readout: LLDP_RESET_STATS_NO */
    LLDP_UPPER_STATS_TYPE   Cntr;                           /* out */
} LLDP_RQB_STATS_TYPE;

typedef struct _LLDP_RQB_STATS_TYPE * LLDP_UPPER_STATS_PTR_TYPE;
...
typedef struct _LLDP_RQB_TIMER_TYPE * LLDP_UPPER_TIMER_PTR_TYPE;
...
typedef struct _LLDP_RQB_SET_GLOBALS_TYPE * LLDP_RQB_SET_GLOBALS_PTR_TYPE;
...
typedef struct LLDP_LOCAL_ERROR_CODE_ * LLDP_LOCAL_ERROR_CODE_PTR_TYPE;
#endif
...
/* see above: LLDP_MAX_TLV_DATA_SIZE ... max length of all TLVs */
...
#include "sys_unpck.h"
#define LLDP_TLV_SET_INFO_CONST_PTR_TYPE  LLDP_TLV_SET_INFO_TYPE const *

/* string len max LLDP_MAX_CHASSIS_ID_STRING_SIZE bytes ! */

LSA_EXTERN LLDP_RSP lldp_TLVSetChassisPortTTL(
    LLDP_UPPER_MEM_PTR_TYPE          *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE       pTLength,
    LLDP_TLV_SET_INFO_CONST_PTR_TYPE  pTLVInfo);

LSA_EXTERN LLDP_RSP lldp_TLVGetChassisPortTTL(
    LLDP_UPPER_MEM_PTR_TYPE     *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE  pTLength,
    LLDP_TLV_GET_INFO_TYPE      *pTLVInfo);

LSA_EXTERN LLDP_RSP lldp_TLVGet(
    LLDP_UPPER_MEM_PTR_TYPE     *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE  pTLength,
    LLDP_UPPER_MEM_U32_PTR_TYPE  pType,
    LLDP_UPPER_MEM_U32_PTR_TYPE  pLength,
    LLDP_UPPER_MEM_PTR_TYPE     *ppValue);

LSA_EXTERN LLDP_RSP lldp_TLVSet(
    LLDP_UPPER_MEM_PTR_TYPE     *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE  pTLength,
    LSA_UINT32                   Type,
    LSA_UINT32                   Length,
...
typedef struct _LLDP_PARAMS_CHASSIS_ID_TYPE * LLDP_UPPER_PARAMS_CHASSIS_ID_PTR_TYPE;
...
typedef struct _LLDP_PARAMS_PORT_ID_TYPE * LLDP_UPPER_PARAMS_PORT_ID_PTR_TYPE;
...
typedef struct _LLDP_PARAMS_TTL_TYPE * LLDP_UPPER_PARAMS_TTL_PTR_TYPE;

typedef struct _LLDP_PARAMS_TTL_TYPE const * LLDP_UPPER_PARAMS_TTL_CONST_PTR_TYPE;
...
typedef struct _LLDP_PARAMS_PORT_DESCR_TYPE * LLDP_UPPER_PARAMS_PORT_DESCR_PTR_TYPE;
...
typedef struct _LLDP_PARAMS_SYSTEM_NAME_TYPE * LLDP_UPPER_PARAMS_SYSTEM_NAME_PTR_TYPE;
...
typedef struct _LLDP_PARAMS_SYSTEM_DESCR_TYPE * LLDP_UPPER_PARAMS_SYSTEM_DESCR_PTR_TYPE;
...
typedef struct _LLDP_PARAMS_SYSTEM_CAP_TYPE * LLDP_UPPER_PARAMS_SYSTEM_CAP_PTR_TYPE;

typedef struct _LLDP_PARAMS_SYSTEM_CAP_TYPE   const *    LLDP_UPPER_PARAMS_SYSTEM_CAP_CONST_PTR_TYPE;

// @@@ #define  LLDP_UPPER_PARAMS_SYSTEM_CAP_CONST_PTR_TYPE   LLDP_UPPER_PARAMS_SYSTEM_CAP_PTR_TYPE const *
...
typedef struct _LLDP_PARAMS_MGM_ADDR_TYPE * LLDP_UPPER_PARAMS_MGM_ADDR_PTR_TYPE;
...
typedef struct _LLDP_PARAMS_ORG_SPEC_TYPE * LLDP_UPPER_PARAMS_ORG_SPEC_PTR_TYPE;
...
typedef struct _LLDP_PARAMS_UNKNOWN_OPTIONAL_TYPE * LLDP_UPPER_PARAMS_UNKNOWN_OPTIONAL_PTR_TYPE;
...
typedef struct _LLDP_PARAMS_PORT_VLAN_ID_TYPE * LLDP_UPPER_PARAMS_PORT_VLAN_ID_PTR_TYPE;

typedef struct _LLDP_PARAMS_PORT_VLAN_ID_TYPE   const * LLDP_UPPER_PARAMS_PORT_VLAN_ID_CONST_PTR_TYPE;
...
typedef struct _LLDP_PARAMS_PPVID_TYPE * LLDP_UPPER_PARAMS_PPVID_PTR_TYPE;

typedef struct _LLDP_PARAMS_PPVID_TYPE   const * LLDP_UPPER_PARAMS_PPVID_CONST_PTR_TYPE;
...
typedef struct _LLDP_PARAMS_VLAN_NAME_TYPE * LLDP_UPPER_PARAMS_VLAN_NAME_PTR_TYPE;
...
typedef struct _LLDP_PARAMS_PROTOCOL_IDENTITY_TYPE * LLDP_UPPER_PARAMS_PROTOCOL_IDENTITY_TYPE;
...
typedef struct _LLDP_PARAMS_MAC_PHY_CONFIG_STATUS_TYPE * LLDP_UPPER_PARAMS_MAC_PHY_CONFIG_STATUS_PTR_TYPE;

typedef struct _LLDP_PARAMS_MAC_PHY_CONFIG_STATUS_TYPE const * LLDP_UPPER_PARAMS_MAC_PHY_CONFIG_STATUS_CONST_PTR_TYPE;
...
typedef struct _LLDP_PARAMS_POWER_VIA_MDI_TYPE * LLDP_UPPER_PARAMS_POWER_VIA_MDI_PTR_TYPE;

typedef struct _LLDP_PARAMS_POWER_VIA_MDI_TYPE const * LLDP_UPPER_PARAMS_POWER_VIA_MDI_CONST_PTR_TYPE;
...
typedef struct _LLDP_PARAMS_LINK_AGGREGATION_TYPE * LLDP_UPPER_PARAMS_LINK_AGGREGATION_PTR_TYPE;
typedef struct _LLDP_PARAMS_LINK_AGGREGATION_TYPE const * LLDP_UPPER_PARAMS_LINK_AGGREGATION_CONST_PTR_TYPE;
...
typedef struct _LLDP_PARAMS_MAX_FRAME_SIZE_TYPE * LLDP_UPPER_PARAMS_MAX_FRAME_SIZE_PTR_TYPE;

typedef struct _LLDP_PARAMS_MAX_FRAME_SIZE_TYPE const * LLDP_UPPER_PARAMS_MAX_FRAME_SIZE_CONST_PTR_TYPE;
...
#include "sys_unpck.h"
typedef struct _LLDP_TLV_GET_EX_PARAMS_TYPE * LLDP_UPPER_TLV_GET_EX_PARAMS_PTR_TYPE;
...
LSA_EXTERN LLDP_RSP lldp_TLVSetEnd(
    LLDP_UPPER_MEM_PTR_TYPE     *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE  pTLength);

LSA_EXTERN LLDP_RSP lldp_TLVSetChassisID(
    LLDP_UPPER_MEM_PTR_TYPE               *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE            pTLength,
    LLDP_UPPER_PARAMS_CHASSIS_ID_PTR_TYPE  pTLVParams);

LSA_EXTERN LLDP_RSP lldp_TLVSetPortID(
    LLDP_UPPER_MEM_PTR_TYPE            *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE         pTLength,
    LLDP_UPPER_PARAMS_PORT_ID_PTR_TYPE  pTLVParams);

LSA_EXTERN LLDP_RSP lldp_TLVSetTTL(
    LLDP_UPPER_MEM_PTR_TYPE              *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE           pTLength,
    LLDP_UPPER_PARAMS_TTL_CONST_PTR_TYPE  pTLVParams);

LSA_EXTERN LLDP_RSP lldp_TLVSetPortDescr(
    LLDP_UPPER_MEM_PTR_TYPE               *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE            pTLength,
    LLDP_UPPER_PARAMS_PORT_DESCR_PTR_TYPE  pTLVParams);

LSA_EXTERN LLDP_RSP lldp_TLVSetSystemName(
    LLDP_UPPER_MEM_PTR_TYPE                *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE             pTLength,
    LLDP_UPPER_PARAMS_SYSTEM_NAME_PTR_TYPE  pTLVParams);

LSA_EXTERN LLDP_RSP lldp_TLVSetSystemDescr(
    LLDP_UPPER_MEM_PTR_TYPE                 *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE              pTLength,
    LLDP_UPPER_PARAMS_SYSTEM_DESCR_PTR_TYPE  pTLVParams);

LSA_EXTERN LLDP_RSP lldp_TLVSetSystemCap(
    LLDP_UPPER_MEM_PTR_TYPE                     *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE                  pTLength,
    LLDP_UPPER_PARAMS_SYSTEM_CAP_CONST_PTR_TYPE  pTLVParams);

LSA_EXTERN LLDP_RSP lldp_TLVSetMgmAddr(
    LLDP_UPPER_MEM_PTR_TYPE             *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE          pTLength,
    LLDP_UPPER_PARAMS_MGM_ADDR_PTR_TYPE  pTLVParams);

LSA_EXTERN LLDP_RSP lldp_TLVSetPortVLANID(
    LLDP_UPPER_MEM_PTR_TYPE                       *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE                    pTLength,
    LLDP_UPPER_PARAMS_PORT_VLAN_ID_CONST_PTR_TYPE  pTLVParams);

LSA_EXTERN LLDP_RSP lldp_TLVSetPPVID(
    LLDP_UPPER_MEM_PTR_TYPE                *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE             pTLength,
    LLDP_UPPER_PARAMS_PPVID_CONST_PTR_TYPE  pTLVParams);

LSA_EXTERN LLDP_RSP lldp_TLVSetVLANName(
    LLDP_UPPER_MEM_PTR_TYPE              *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE           pTLength,
    LLDP_UPPER_PARAMS_VLAN_NAME_PTR_TYPE  pTLVParams);

LSA_EXTERN LLDP_RSP lldp_TLVSetProtIdentity(
    LLDP_UPPER_MEM_PTR_TYPE                  *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE               pTLength,
    LLDP_UPPER_PARAMS_PROTOCOL_IDENTITY_TYPE  pTLVParams);

LSA_EXTERN LLDP_RSP lldp_TLVSetMACPHYConfigStatus(
    LLDP_UPPER_MEM_PTR_TYPE                                *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE                             pTLength,
    LLDP_UPPER_PARAMS_MAC_PHY_CONFIG_STATUS_CONST_PTR_TYPE  pTLVParams);

LSA_EXTERN LLDP_RSP lldp_TLVSetPowerViaMDI(
    LLDP_UPPER_MEM_PTR_TYPE                        *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE                     pTLength,
    LLDP_UPPER_PARAMS_POWER_VIA_MDI_CONST_PTR_TYPE  pTLVParams);

LSA_EXTERN LLDP_RSP lldp_TLVSetLinkAgg(
    LLDP_UPPER_MEM_PTR_TYPE                          *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE                       pTLength,
    LLDP_UPPER_PARAMS_LINK_AGGREGATION_CONST_PTR_TYPE pTLVParams);

LSA_EXTERN LLDP_RSP lldp_TLVSetMaxFrameSize(
    LLDP_UPPER_MEM_PTR_TYPE                         *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE                      pTLength,
    LLDP_UPPER_PARAMS_MAX_FRAME_SIZE_CONST_PTR_TYPE  pTLVParams);

LSA_EXTERN LLDP_RSP lldp_TLVGetParams(
    LLDP_UPPER_MEM_PTR_TYPE               *ppTLV,
    LLDP_UPPER_MEM_U32_PTR_TYPE            pTLength,
 ...
 *===========================================================================*/
LSA_VOID lldp_open_channel(LLDP_UPPER_RQB_PTR_TYPE pRQB);
...
LSA_VOID lldp_close_channel(LLDP_UPPER_RQB_PTR_TYPE pRQB);
...
LSA_VOID lldp_request(LLDP_UPPER_RQB_PTR_TYPE  upper_rqb_ptr);
