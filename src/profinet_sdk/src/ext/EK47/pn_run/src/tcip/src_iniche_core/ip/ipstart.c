/*
 * v3.1 August 30, 2011 ip/ipstart.c
...
#define LTRC_ACT_MODUL_ID 16 /* INICHE_TCIP_ITGR added for LSA traces */
...
ip_startup()
{
   ...
   if (ifNumber < 1)    /* no static interfaces? */
   {
      ...
      /* print a debug message and hope user knows what he's doing */
         ...
         TCIP_INICHE_TRACE_00(0,LSA_TRACE_LEVEL_NOTE,"unable to find any static working interfaces");
#else
...
int nclosers = 0; /* INICHE_TCIP_ITGR removed 'static' */
