 ...
 * Macro definitions
 **********************************************************************************************************************/
#define ETHER_PHY_API_VERSION_MAJOR    (0U)
...
typedef enum e_ether_phy_link_speed
{
    ...
    ETHER_PHY_AUTONEG            = 7  ///< Set to Autoneg
...
typedef struct st_ether_phy_cfg
{
    ...
    ether_phy_link_speed_t   link_speed;   // Link Speed and autoneg type at power up
...
typedef struct st_ether_phy_api
{
     ...
     */
    fsp_err_t (* open)(ether_phy_ctrl_t * p_api_ctrl, ether_phy_cfg_t *  p_cfg);
