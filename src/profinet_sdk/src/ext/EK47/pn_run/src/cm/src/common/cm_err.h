...
#define CM_PNIO_FAULTY_BlockType(err_code) \
	CM_PNIO_ERR_MAKE(err_code, CM_PNIO_ERR_DECODE_PNIO, 64/*CMRPC*/, 1/*Unknown Blocks*/)
...
#define CM_PNIO_FAULTY_RSInfoBlock(code2) \
	CM_PNIO_FAULTY_ConnectBlockReq(13, (code2))

/* CMDEV */
#define CM_PNIO_FAULTY_Connect__CMDEV_StateConflict() \
	CM_PNIO_FAULTY_ConnectBlockReq(61, 0) /* State conflict */


/* CMCTL */
#define CM_PNIO_FAULTY_Connect__CMCTL_StateConflict() \
	CM_PNIO_FAULTY_ConnectBlockReq(62, 0) /* State conflict */

#define CM_PNIO_FAULTY_Connect__CMCTL_OutOfResource() \
	CM_PNIO_FAULTY_ConnectBlockReq(62, 3) /* Out of resource */


/* CTLDINA*/
#define CM_PNIO_FAULTY_Connect__CTLDINA_DCPNoRealStationName() \
	CM_PNIO_FAULTY_ConnectBlockReq(63, 2) /* DCP no RealStationName */

#define CM_PNIO_FAULTY_Connect__CTLDINA_NoIPAddress() \
	CM_PNIO_FAULTY_ConnectBlockReq(63, 5) /* No IP address */


/* note: CMRPC was formerly named RMPM */
#define CM_PNIO_FAULTY_Connect__CMRPC_ArgsLengthInvalid() \
	CM_PNIO_FAULTY_ConnectBlockReq(64, 0) /* ArgsLength invalid  */

#define CM_PNIO_FAULTY_Connect__CMRPC_UnknownBlocks() \
	CM_PNIO_FAULTY_ConnectBlockReq(64, 1) /* Unknown blocks */

#define CM_PNIO_FAULTY_Connect__CMRPC_IOCRMissing() \
	CM_PNIO_FAULTY_ConnectBlockReq(64, 2) /* IOCR missing */

#define CM_PNIO_FAULTY_Connect__CMRPC_WrongBlockCount() \
	CM_PNIO_FAULTY_ConnectBlockReq(64, 3) /* Wrong block count (e.g. wrong AlarmCRBlock count) */

#define CM_PNIO_FAULTY_Connect__CMRPC_OutOfARResources() \
	CM_PNIO_FAULTY_ConnectBlockReq(64, 4) /* Out of AR resources */

#define CM_PNIO_FAULTY_Connect__CMRPC_StateConflict() \
	CM_PNIO_FAULTY_ConnectBlockReq(64, 6) /* State conflict */

#define CM_PNIO_FAULTY_Connect__CMRPC_OutOfProviderConsumerOrAlarmResources() \
	CM_PNIO_FAULTY_ConnectBlockReq(64, 7) /* Out of Provider, Consumer, or Alarm Resources */

#define CM_PNIO_FAULTY_Connect__CMRPC_OutOfMemory() \
	CM_PNIO_FAULTY_ConnectBlockReq(64, 8) /* Out of memory */

#define CM_PNIO_FAULTY_Connect__CMRPC_PdevAlreadyOwned() \
	CM_PNIO_FAULTY_ConnectBlockReq(64, 9) /* Pdev already owned */

#define CM_PNIO_FAULTY_Connect__CMRPC_ARSetStateConflictDuringConnectionEstablishment() \
	CM_PNIO_FAULTY_ConnectBlockReq(64, 10) /* ARSet - State conflict during connection establishment */

#define CM_PNIO_FAULTY_Connect__CMRPC_ARSetParameterConflictDuringConnectionEstablishment() \
	CM_PNIO_FAULTY_ConnectBlockReq(64, 11) /* ARSet - Parameter conflict during connection establishment */

#define CM_PNIO_FAULTY_Connect__CMRPC_PdevWithoutIf() \
	CM_PNIO_FAULTY_ConnectBlockReq(64, 12) /* Pdev, port(s) without interface */

#define CM_PNIO_FAUTLY_Connect__CMRPC_PdevDiscrepancyARType() \
	CM_PNIO_FAULTY_ConnectBlockReq(64, 13) /* Discrepancy between Pdev and ARType (TIA 4054738, V7.2i1.2x) */

#define CM_PNIO_FAULTY_Connect__UserSpecific_UserAbort() \
	CM_PNIO_FAULTY_ConnectBlockReq(255, 255) /* User specific: Recommended for "User abort" without further detail */
...
#define CM_PNIO_FAULTY_Release__CMRPC_ArgsLengthInvalid() \
	CM_PNIO_FAULTY_Release(64, 0) /* ArgsLength invalid */

#define CM_PNIO_FAULTY_Release__CMRPC_UnknownBlocks() \
	CM_PNIO_FAULTY_Release(64, 1) /* Unknown blocks */

#define CM_PNIO_FAULTY_Release__CMRPC_OutOfARResources() \
	CM_PNIO_FAULTY_Release(64, 4) /* Out of AR resources */

#define CM_PNIO_FAULTY_Release__CMRPC_ARUUIDUnknown() \
	CM_PNIO_FAULTY_Release(64, 5) /* AR UUID unknown */

#define CM_PNIO_FAULTY_Release__CMRPC_StateConflict() \
	CM_PNIO_FAULTY_Release(64, 6) /* State conflict */
...
#define CM_PNIO_FAULTY_IODControlConnectPlug__CMRPC_ArgsLengthInvalid() \
	CM_PNIO_FAULTY_IODControlConnectPlug(64, 0) /* ArgsLength invalid */

#define CM_PNIO_FAULTY_IODControlConnectPlug__CMRPC_UnknownBlocks() \
	CM_PNIO_FAULTY_IODControlConnectPlug(64, 1) /* Unknown blocks */

#define CM_PNIO_FAULTY_IODControlConnectPlug__CMRPC_WrongBlockCount() \
	CM_PNIO_FAULTY_IODControlConnectPlug(64, 3) /* Wrong block count (e.g. wrong AlarmCRBlock count) */

#define CM_PNIO_FAULTY_IODControlConnectPlug__CMRPC_OutOfARResources() \
	CM_PNIO_FAULTY_IODControlConnectPlug(64, 4) /* Out of AR resources */

#define CM_PNIO_FAULTY_IODControlConnectPlug__CMRPC_ARUUIDUnknown() \
	CM_PNIO_FAULTY_IODControlConnectPlug(64, 5) /* AR UUID unknown */

#define CM_PNIO_FAULTY_IODControlConnectPlug__CMRPC_StateConflict() \
	CM_PNIO_FAULTY_IODControlConnectPlug(64, 6) /* State conflict */
...
#define CM_PNIO_FAULTY_Record__CMRPC_ArgsLengthInvalid() \
	CM_PNIO_FAULTY_Record_PNIO(64, 0) /* ArgsLength invalid */

#define CM_PNIO_FAULTY_Record__CMRPC_OutOfARResources() \
	CM_PNIO_FAULTY_Record_PNIO(64, 4) /* Out of AR Resources */

#define CM_PNIO_FAULTY_Record__CMRPC_ARUUIDUnknown() \
	CM_PNIO_FAULTY_Record_PNIO(64, 5) /* AR UUID unknown */

#define CM_PNIO_FAULTY_Record__CMRPC_StateConflict() \
	CM_PNIO_FAULTY_Record_PNIO(64, 6) /* State conflict */

#define CM_PNIO_FAULTY_Record__CMRPC_OutOfMemory() \
	CM_PNIO_FAULTY_Record_PNIO(64, 8) /* Out of Memory */
