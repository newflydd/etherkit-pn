...
bad_header: /* INICHE_TCIP_ITGR label added */
	  ...
	  USE_ARG(nt); /* INICHE_TCPIP_ITGR eliminate MIPS compiler warning "variable 'nt' set but not used", see 1911686 */
...
#if 1 /* INICHE_TCIP_ITGR drop packets with broadcast or multicast source address, see ID 948168 */
