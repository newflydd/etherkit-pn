...
// *--------------------------------------------
#include "sys_pck1.h" /*lint !e451 !e537 repeated include file */
typedef ATTR_PNIO_PACKED_PRE struct
{
   PNIO_UINT16 ChanNum;				// channel number
   PNIO_UINT16 ChanProp;			// channel properties
   PNIO_UINT16 ChanErrType;			// channel error type
}  ATTR_PNIO_PACKED CHANNEL_DIAG_STRUCT;
...
typedef  ATTR_PNIO_PACKED_PRE struct
{
   ...
   PNIO_UINT16 ChanProp;			// channel properties
   PNIO_UINT16 ChanErrType;			// channel error type
   PNIO_UINT16 ExtChanErrType;      // extended channel error type
   PNIO_UINT32 ExtChanAddValue;     // extended channel error additional value
}  ATTR_PNIO_PACKED EXT_CHANNEL_DIAG_STRUCT;
#include "sys_unpck.h" /*lint !e451 !e537 repeated include file */
