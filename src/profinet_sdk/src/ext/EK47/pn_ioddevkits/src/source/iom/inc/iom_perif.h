...
#define IOM_PERIF_CR_ADDRESS_N(x)       ((volatile iom_perif_cr_address_reg_t *)       (U_PERIF_APB__CR_ADDRESS_1 + (x-1) * sizeof(iom_perif_cr_address_reg_t)))        /* x : 1 ... 27 */
...
typedef struct iom_perif_page_mem_desc_s
{
    ...
    LSA_UINT32  memory_map[256/8/32];
