...
static LLDP_RSP LLDP_UserGetFreeHDB(
...
static LSA_BOOL LLDP_IndicateCheckTooMany(
    LLDP_HDB_PTR_TYPE            pHDB,
    LLDP_EDD_PCTRL_PTR_TYPE      pPCtrl)
{
...
static LSA_BOOL LLDP_IndicateCheckLastInvalid(
    LLDP_HDB_PTR_TYPE               pHDB,
    LLDP_EDD_PCTRL_CONST_PTR_TYPE  pPCtrl,
    LSA_UINT32                      Idx)
{
    LLDP_UPPER_RQB_PTR_TYPE      pRQB;
...
static LSA_BOOL LLDP_IndicateCheckState(
    LLDP_HDB_PTR_TYPE               pHDB,
    LLDP_EDD_PCTRL_CONST_PTR_TYPE  pPCtrl,
    LSA_UINT32                      Idx)
{
...
LSA_VOID LLDP_UserChannelStateMachine(
    LLDP_HDB_PTR_TYPE       pHDB,
    LLDP_RSP                Response)
{
    LLDP_UPPER_RQB_PTR_TYPE      pRQB;
...
static LLDP_RSP LLDP_UserCloseChannel(
    LLDP_HDB_PTR_TYPE             pHDB,
    LLDP_LOCAL_MEM_BOOL_PTR_TYPE  pFinish)
{
...
LSA_VOID LLDP_UserHandleTxDone(
    LLDP_HDB_PTR_TYPE            pHDB,
    LLDP_EDD_PCTRL_PTR_TYPE      pPCtrl)
{
...
LSA_VOID LLDP_UserHandleLinkInd(
    LLDP_HDB_PTR_TYPE            pHDB,
    LLDP_EDD_PCTRL_PTR_TYPE      pPCtrl)
{
...
LSA_VOID LLDP_UserHandleRxFrame(
    LLDP_HDB_PTR_TYPE            pHDB,
    LLDP_EDD_PCTRL_PTR_TYPE      pPCtrl,
    LLDP_COMMON_MEM_U8_PTR_TYPE  pFrame,
...
LSA_VOID LLDP_RequestTimer(LLDP_UPPER_RQB_PTR_TYPE pRQB)
{
    ...
    for (Channel=0; Channel<LLDP_MAX_CHANNELS; Channel++)
    {
...
static LSA_VOID LLDP_RequestIndicationProvide(
    LLDP_UPPER_RQB_PTR_TYPE   pRQB,
    LLDP_HDB_PTR_TYPE         pHDB)
{
...
static LSA_VOID LLDP_RequestGetConfig(
    LLDP_UPPER_RQB_PTR_TYPE   pRQB,
    LLDP_HDB_PTR_TYPE         pHDB)
{
...
static LSA_VOID LLDP_RequestSetGlobals(
    LLDP_UPPER_RQB_PTR_TYPE   pRQB,
    LLDP_HDB_PTR_TYPE         pHDB)
{
...
static LSA_VOID LLDP_RequestStats(
    LLDP_UPPER_RQB_PTR_TYPE   pRQB,
    LLDP_HDB_PTR_TYPE         pHDB)
{
    ...
    if (pRQB->args.Stats.Reset != LLDP_RESET_STATS_NO && pRQB->args.Stats.Reset != LLDP_RESET_STATS_YES)
    {
        Response = LLDP_RSP_ERR_PARAM;
    }
    else if (( pRQB->args.Stats.PORTId > 0 ) &&
        ( pRQB->args.Stats.PORTId <= pHDB->PortCnt ))
    {
        ...
        if (pRQB->args.Stats.Reset == LLDP_RESET_STATS_YES)
        {
...
static LSA_VOID LLDP_RequestGet(
    LLDP_UPPER_RQB_PTR_TYPE   pRQB,
    LLDP_HDB_PTR_TYPE         pHDB)
{
        ...
        ( pRQB->args.Get.SenderId <= pHDB->PortMaxSender ))
    {
        ...
        if ( pRx->State == LLDP_RX_FRAME_STATE_DATA_VALID )
        {
            pRQB->args.Get.Present    = LLDP_PRESENT_YES;
        ...
        {
            pRQB->args.Get.Present    = LLDP_PRESENT_NO;
...
static LSA_VOID LLDP_RequestSet(
    LLDP_UPPER_RQB_PTR_TYPE   pRQB,
    LLDP_HDB_PTR_TYPE         pHDB)
{
...
static LSA_VOID LLDP_RequestStart(
    LLDP_UPPER_RQB_PTR_TYPE   pRQB,
    LLDP_HDB_PTR_TYPE         pHDB)
{
    LLDP_RSP                     Response;
...
static LSA_VOID LLDP_RequestStop(
    LLDP_UPPER_RQB_PTR_TYPE   pRQB,
    LLDP_HDB_PTR_TYPE         pHDB)
{
    LLDP_RSP                     Response;
    ...
    if((pRQB->args.Stop.Mode == 0) ||(pRQB->args.Stop.Mode > LLDP_RXTX_MODE))
    {   /* invalid Mode */
        Response = LLDP_RSP_ERR_PARAM;
        LLDP_UserRequestFinish(pHDB,pRQB,Response);
...
/*+               case we call LLDP_FATAL(LLDP_FATAL_ERR_RQB)               +*/
...
LSA_VOID lldp_open_channel(LLDP_UPPER_RQB_PTR_TYPE pRQB)
{
    ...
    if(pRQB->args.channel.lldp_request_upper_done_ptr == 0)
    {
        LLDP_UPPER_TRACE_00(0,LSA_TRACE_LEVEL_FATAL,"lldp_open_channel(): Cbf is 0");
...
LSA_VOID lldp_request(LLDP_UPPER_RQB_PTR_TYPE pRQB)
{
