...
#ifdef _RENESAS_RZT_
#ifdef USE_HRAM
#define KRISC_DTCM_BASE             0x68280000 // (0x04000000 + 0)
#else
#define KRISC_DTCM_BASE             0x78280000 // (0x04000000 + 0)
#endif
#endif
#ifdef _RENESAS_RZN_
#ifdef USE_HRAM
#define KRISC_DTCM_BASE             0x64280000 // (0x04000000 + 0)
#else
#define KRISC_DTCM_BASE             0x74280000 // (0x04000000 + 0)
#endif
#endif
...
//========================================================================
#if 1
#define PNIP_RAM__OFFSET_STATISTIC  0x00000700
#define PNIP_RAM__OFFSET_SYNC       0x00001000
#define PNIP_RAM__OFFSET_PACK_DATA  0x00005000
#define PNIP_RAM__OFFSET_CMD        0x0000D000
#define PNIP_RAM__OFFSET_API_CTRL   0x00015000
#else
