...
/* contents:
    ...
    - pndv_in_al_check_all_soll_modul_running
    - pndv_in_al_ar_abort_if_ps_lost
    - pndv_al_ps_state
...
{
    UnsignedOpt        tmp_cnt;
    Unsigned16         subslot_cnt;

    pndv_data.diag.cm_diag_req_running    = FALSE;
    pndv_data.diag.cm_dev_req_ignore_done = FALSE;
    ...
    for ( tmp_cnt = 0; tmp_cnt < PNDV_DIAG_CHANNEL_ANZ ; tmp_cnt++)
    {
        ...
        pndv_data.diag.channel_diag[tmp_cnt].as.ch.quit_to_peri  = FALSE;
    ...
    for ( subslot_cnt = 0; subslot_cnt < PNDV_MAX_SV_ENTITY; subslot_cnt++ )
    {
        ...
        pndv_data.diag.dial_repeat_req[subslot_cnt]                 = FALSE;
    }
    ...
    */
    ...
    if ( !pndv_host_ptr_is_nil__(real_cfg_channel_diag_ptr) )
    {
        ...
        else
        {
            ...
            {
                if ( TRUE == real_cfg_channel_diag_ptr->dial.chn_diag[i].alm_kommend )
                {
    ...
    */
    ...
    if ( !pndv_host_ptr_is_nil__(real_cfg_channel_diag_ptr) )
    {
        ...
        else
        {
            for (i = 0; i < anz_chann_diag; i++)
            {
                if ( TRUE == real_cfg_channel_diag_ptr->xdial.ext_diag[i].alm_kommend )
                {
...
/**
 *  @brief remove all ext channel diagnosis of one ar
 *
 *  @param[in]  ar_idx AR index
 *
 *
...
void    pndv_al_peri_xdial_rmv_all    (UnsignedOpt ar_idx)
{
    ...
    {   //check all used modules if they are owned by the requested ar, don't use set_cfg information for that
        if (local_sub_res_ptr->own_ar_idx == ar_idx)
        {
            pndv_in_al_diag_req( PNDV_AL_USI_EXTCHANNELDIAG, local_sub_res_ptr->entity, 0, 0, 0, 0, 0, PNDV_CHANNEL_DIAG_RMV_ALL_REQ_PNDV );
        }
        ...
        if ( PNDV_MAX_SV_ENTITY >= local_sub_res->entity )
        {
            if ( PNDV_AL_FREE  == pndv_data.al.submodul[local_sub_res->entity].pral_state )
            {
                if (    ( PNDV_SUBMODULE_STATE_VALID_MODUL   == local_sub_res->submodule_state )
                     && ( TRUE                               == pndv_al_al_possible_within_state(local_sub_res) )
                   )
                {
                 ...
                 /* pndv_data.al.submodul[local_sub_res->entity].pral_data.device_nr            = set in pndv_in_al_init_submodul */
                    pndv_data.al.submodul[local_sub_res->entity].pral_data.ar_nr                = pndv_data.ar[local_sub_res->own_ar_idx].ar_nr;
                 ...
                 /* pndv_data.al.submodul[local_sub_res->entity].pral_data.alarm_data_length    = set in pndv_in_al_init_submodul */
                    ...
                    PNDV_RQB_SET_HANDLE( &pndv_data.al.submodul[local_sub_res->entity].pral_rqb, pndv_data.cm_handle[PNDV_INDEX_PATH_ACP_CM]);
            ...
            if ( PNDV_AL_FREE  == pndv_data.al.submodul[local_sub_res->entity].upal_state )
            {
                   ...
                   )
                {
                 ...
                 /* pndv_data.al.submodul[local_sub_res->entity].upal_data.device_nr            = set in pndv_in_al_init_submodul */
                    pndv_data.al.submodul[local_sub_res->entity].upal_data.ar_nr                = pndv_data.ar[local_sub_res->own_ar_idx].ar_nr;
                 ...
                 /* pndv_data.al.submodul[local_sub_res->entity].upal_data.alarm_data_length    = set in pndv_in_al_init_submodul */
                    ...
                    PNDV_RQB_SET_HANDLE( &pndv_data.al.submodul[local_sub_res->entity].upal_rqb, pndv_data.cm_handle[PNDV_INDEX_PATH_ACP_CM]);
            ...
            if ( PNDV_AL_FREE  == pndv_data.al.submodul[local_sub_res->entity].ural_state )
            {
                   ...
                   )
                {
                 ...
                 /* pndv_data.al.submodul[local_sub_res->entity].ural_data.device_nr            = set in pndv_in_al_init_submodul */
                    pndv_data.al.submodul[local_sub_res->entity].ural_data.ar_nr                = pndv_data.ar[local_sub_res->own_ar_idx].ar_nr;
                 ...
                 /* pndv_data.al.submodul[local_sub_res->entity].ural_data.alarm_data_length    = set in pndv_in_al_init_submodul */
                    ...
                    PNDV_RQB_SET_HANDLE( &pndv_data.al.submodul[local_sub_res->entity].ural_rqb, pndv_data.cm_handle[PNDV_INDEX_PATH_ACP_CM]);
                   ...
                   )
                {
                    ...
                    if ( (stal_ptr->usi >= PNDV_AL_STAL_RS_LOW_WATERMARK_USI) && (stal_ptr->usi <= PNDV_AL_STAL_RS_EVENT_USI) ) // if Reporting System AlarmItem (RS_AlarmItem)
                    {
                     /* pndv_data.al.submodul[local_sub_res->entity].stal_data.device_nr            = set in pndv_in_al_init_submodul */
                        pndv_data.al.submodul[local_sub_res->entity].stal_data.ar_nr                = pndv_data.ar[stal_ptr->ar_idx].ar_nr;
                    ...
                    {
                     /* pndv_data.al.submodul[local_sub_res->entity].stal_data.device_nr            = set in pndv_in_al_init_submodul */
                        pndv_data.al.submodul[local_sub_res->entity].stal_data.ar_nr                = pndv_data.ar[local_sub_res->own_ar_idx].ar_nr;
                    ...
                    PNDV_RQB_SET_HANDLE( &pndv_data.al.submodul[local_sub_res->entity].stal_rqb, pndv_data.cm_handle[PNDV_INDEX_PATH_ACP_CM]);
 ...
 *
 */
void pndv_al_peri_rosal_req  (Unsigned16 entity_nr)
{
    Unsigned16                          slot_nr,
                                        soll_slot,
                                        subslot_nr;
              ...
              )
            {
                   ...
                   )
                {
                 ...
                 /* pndv_data.al.submodul[local_sub_res->entity].rosal_data.device_nr           = set in pndv_in_al_init_submodul */
                    pndv_data.al.submodul[local_sub_res->entity].rosal_data.ar_nr               = pndv_data.ar[local_sub_res->own_ar_idx].ar_nr;
                 ...
                 /* pndv_data.al.submodul[local_sub_res->entity].pral_data.alarm_data_length    = set in pndv_in_al_init_submodul */
                    ...
                    PNDV_RQB_SET_HANDLE( &pndv_data.al.submodul[local_sub_res->entity].rosal_rqb, pndv_data.cm_handle[PNDV_INDEX_PATH_ACP_CM]);
                    PNDV_RQB_SET_OPCODE( &pndv_data.al.submodul[local_sub_res->entity].rosal_rqb, CM_OPC_SV_AR_ALARM_SEND);

                    PNDV_CM_REQUEST(&pndv_data.al.submodul[local_sub_res->entity].rosal_rqb);
                }
                else
                {
                            ...
                            PNDV_CHANNEL_DIAG_REQ_T req )
{
    if ((usi == PNDV_AL_USI_CHANNELDIAG) || (usi == PNDV_AL_USI_EXTCHANNELDIAG ))
    {
        ...
        channel_diag_ptr->as.ch.quit_to_peri  = ( PNDV_CHANNEL_DIAG_RMV_ALL_REQ_PNDV == req ) ? FALSE : TRUE;
        ...
        switch ( req )
        {
            ...
            {
                pndv_in_write_debug_buffer_all_add__(PNDV_DC_CM_ADD_CHANNEL_DIAG_REQ, entity_nr, ((Unsigned32)( (((Unsigned32)kanal) << 16) | ((Unsigned32)fehlernummer) ) ));
                break;
            }
            case PNDV_CHANNEL_DIAG_RMV_REQ:
            {
                pndv_in_write_debug_buffer_all_add__(PNDV_DC_CM_RMV_CHANNEL_DIAG_REQ, entity_nr, ((Unsigned32)( (((Unsigned32)kanal) << 16) | ((Unsigned32)fehlernummer) ) ));
                break;
            }
            case PNDV_CHANNEL_DIAG_RMV_ALL_REQ:
            {
                pndv_in_write_debug_buffer_all_add__(PNDV_DC_CM_RMV_CHANNEL_DIAG_ALL_REQ, entity_nr, ((Unsigned32)( (((Unsigned32)kanal) << 16) | ((Unsigned32)fehlernummer) ) ));
                break;
            }
            case PNDV_CHANNEL_DIAG_RMV_ALL_REQ_PNDV:
            {
                pndv_in_write_debug_buffer_all_add__(PNDV_DC_CM_RMV_CHANNEL_DIAG_ALL_REQ_PNDV, entity_nr, ((Unsigned32)( (((Unsigned32)kanal) << 16) | ((Unsigned32)fehlernummer) ) ));
                break;
            }
            case PNDV_EXT_CHANNEL_DIAG_ADD_REQ:
            {
                pndv_in_write_debug_buffer_all_add__(PNDV_DC_CM_ADD_EXT_CHANNEL_DIAG_REQ, entity_nr, ((Unsigned32)( (((Unsigned32)kanal) << 16) | ((Unsigned32)fehlernummer) ) ));
                break;
            }
            case PNDV_EXT_CHANNEL_DIAG_RMV_REQ:
            {
                pndv_in_write_debug_buffer_all_add__(PNDV_DC_CM_RMV_EXT_CHANNEL_DIAG_REQ, entity_nr, ((Unsigned32)( (((Unsigned32)kanal) << 16) | ((Unsigned32)fehlernummer) ) ));
                break;
            }
            case PNDV_EXT_CHANNEL_DIAG_RMV_ALL_REQ:
            {
                pndv_in_write_debug_buffer_all_add__(PNDV_DC_CM_RMV_EXT_CHANNEL_DIAG_ALL_REQ, entity_nr, ((Unsigned32)( (((Unsigned32)kanal) << 16) | ((Unsigned32)fehlernummer) ) ));
                break;
            }
            case PNDV_EXT_CHANNEL_DIAG_RMV_ALL_REQ_PNDV:
            {
                pndv_in_write_debug_buffer_all_add__(PNDV_DC_CM_RMV_EXT_CHANNEL_DIAG_ALL_REQ_PNDV, entity_nr, ((Unsigned32)( (((Unsigned32)kanal) << 16) | ((Unsigned32)fehlernummer) ) ));
                break;
            }
            default:
            {
    ...
    else
    {
        ...
        Unsigned16              interface_index = entity_nr;
        ...
        /* set diag and Dial */
        channel_diag_ptr->ch_diag_sm            = PNDV_DIAG_CH_STATE_REQ_AL;
        channel_diag_ptr->as.ch.quit_to_peri    = TRUE;
...
{
    PNDV_CHAN_DIAG_PTR  channel_diag_ptr;
    UnsignedOpt         while_done;

    while_done = FALSE;

    while(FALSE == while_done)
    {
            ...
            if ( PNDV_DIAG_CH_STATE_REQ_AL == channel_diag_ptr->ch_diag_sm )
            {
                ...
                switch ( ret_value = pndv_in_al_diag_branch( channel_diag_ptr)  )
                {
                    ...
                    case PNDV_OK:
                    {
                        ...
                        if ( TRUE == channel_diag_ptr->as.ch.quit_to_peri )
                        {
...
{
    PNDV_CHAN_DIAG_PTR  channel_diag_ptr;
    UnsignedOpt         quit_req,
                        next_diag_req;
    Unsigned16          entity_nr;
    Unsigned16          tmp_ret_val;
        ...
        if ( PNDV_DIAG_CH_STATE_DIAG_DONE == channel_diag_ptr->ch_diag_sm )
        {
            ...
            switch ( tmp_ret_val = pndv_in_al_dial_send( channel_diag_ptr) )
            {
                case PNDV_OK:
                    ...
                    pndv_data.diag.dial_repeat_req[entity_nr] = FALSE;
                ...
                case PNDV_ERR_SEQUENCE:
                    ...
                    pndv_data.diag.dial_repeat_req[entity_nr] = TRUE;
...
UnsignedOpt pndv_al_search_clear_rosal(Unsigned16 slot, Unsigned16 subslot)
{
    ...
    Unsigned16                          local_slot, local_subslot, entity_nr;
 ...
 *  @param[in]  req request type
 *  @return     returns: FALSE = nothing to remove, TRUE = one or more
 *              diagnosis removed
 *
...
Unsigned16 pndv_in_al_diag_branch (PNDV_CHAN_DIAG_PTR diag_channel_ptr )
{
    ...
    Unsigned16 ret_value = PNDV_ERR_SEQUENCE;
...
Unsigned16 pndv_in_al_channel_diag (PNDV_CHAN_DIAG_PTR diag_channel_ptr )
{
    ...
    CM_UPPER_RQB_PTR_TYPE               tmp_rqb_ptr;
    Unsigned16                          ret_value;
    Unsigned16                          device_nr;
    Unsigned16                          slot_nr;
    Unsigned16                          subslot_nr,
                                        entity_nr;
    UnsignedOpt                         subslot_error;
    Unsigned32                          diag_tag = 0;
    Unsigned32                          elem_nr;
    PNDV_STRUCT_CFG_SUBMODULE_RES_PTR_T local_sub_res;
    ...
    diag_tag = ( ( ( (Unsigned32) diag_channel_ptr->as.ch.kanal ) << 16 ) |
                   ( (Unsigned32) diag_channel_ptr->as.ch.fehlernummer )
               )
               + 1; /* never 0 */
    ...
    if (0 == (0x7000 & diag_channel_ptr->as.ch.kanal))
    {
        ...
        diag_tag |= (( (Unsigned32)(diag_channel_ptr->as.ch.properties & CM_CHPR_DIR_MASK) >> 1) << 16 );
    }
    else
    {
    ...
    if (TRUE == pndv_al_diag_possible_within_state(local_sub_res, diag_channel_ptr->req))
    {
        if (FALSE == pndv_data.diag.cm_diag_req_running)
        {
                ...
                switch ( diag_channel_ptr->req )
                {
                    ...
                    case PNDV_EXT_CHANNEL_DIAG_ADD_REQ:
                    {
                        ...
                        if (PNDV_CHANNEL_DIAG_ADD_REQ == diag_channel_ptr->req)
                        {
                            ...
                            pndv_in_write_debug_buffer_all_add__(PNDV_DC_CM_ADD_CHANNEL_DIAG, entity_nr, ((Unsigned32)diag_tag));
                        }
                        else // PNDV_EXT_CHANNEL_DIAG_ADD_REQ
                        {
                            ...
                            pndv_in_write_debug_buffer_all_add__(PNDV_DC_CM_ADD_EXT_CHANNEL_DIAG, entity_nr, ((Unsigned32)diag_tag));

                        }

                        PNDV_RQB_SET_HANDLE( &pndv_data.rqb.diag_add, pndv_data.cm_handle[PNDV_INDEX_PATH_ACP_CM]);
#if (defined PNDV_CFG_USE_DIAG2)||(defined  PNDV_CFG_USE_MULTIDIAG)
                        ...
                        pndv_data.diag.cm_diag_req_running = TRUE;
                    ...
                    case PNDV_EXT_CHANNEL_DIAG_RMV_ALL_REQ_PNDV:
                    {
                        ...
                        #endif
                        {
                            ...
                            if (    ( PNDV_CHANNEL_DIAG_RMV_REQ              == diag_channel_ptr->req )
                                ...
                                ||  ( PNDV_CHANNEL_DIAG_RMV_ALL_REQ_PNDV     == diag_channel_ptr->req ))
                            {
                                pndv_in_write_debug_buffer_all_add__(PNDV_DC_CM_RMV_CHANNEL_DIAG, entity_nr, ((Unsigned32)diag_channel_rmv_key->elem[elem_nr].diag_tag));
                            }
                            else
                            {
                                pndv_in_write_debug_buffer_all_add__(PNDV_DC_CM_RMV_EXT_CHANNEL_DIAG, entity_nr, ((Unsigned32)diag_channel_rmv_key->elem[elem_nr].diag_tag));
                            }
                            ...
                            if (    ( PNDV_CHANNEL_DIAG_RMV_REQ              == diag_channel_ptr->req )
                                ...
                                ||  ( PNDV_CHANNEL_DIAG_RMV_ALL_REQ_PNDV     == diag_channel_ptr->req ))
                            {
                                pndv_in_write_debug_buffer_all_add__(PNDV_DC_CM_RMV_CHANNEL_DIAG, entity_nr, ((Unsigned32)diag_channel_rmv->elem[elem_nr].diag_tag));
                            }
                            else
                            {
                                pndv_in_write_debug_buffer_all_add__(PNDV_DC_CM_RMV_EXT_CHANNEL_DIAG, entity_nr, ((Unsigned32)diag_channel_rmv->elem[elem_nr].diag_tag));
                            }
#endif    /* (defined PNDV_CFG_USE_DIAG2)||(defined  PNDV_CFG_USE_MULTIDIAG) */



                            PNDV_RQB_SET_HANDLE( &pndv_data.rqb.diag_remove, pndv_data.cm_handle[PNDV_INDEX_PATH_ACP_CM]);
#if (defined PNDV_CFG_USE_DIAG2)||(defined  PNDV_CFG_USE_MULTIDIAG)
            ...
            if (pndv_data.iface_ptr->generic_diag_data[interface_idx].length <= PNDV_MAX_GENERIC_DIAG_DATA_LENGTH)
            {
                ...
                switch ( diag_channel_ptr->req )
                {
                    case PNDV_GENERIC_DIAG_ADD_REQ:
                    {
                        ...
                        diag_generic_add->elem[elem_nr].channel_properties =
        ...
        if ( 0 != diag_channel_add->elem[elem_cnt].diag_tag)
        {
            ...
            if(local_sub_res != 0)
            {
                ...
                switch (response)
                {
                    case CM_OK:
                    {
                        pndv_in_al_diag_done( local_sub_res->entity, FALSE);
        ...
        if(local_sub_res != 0)
        {
            ...
            switch ( response )
            {
                case CM_OK:
                {
                    ...
                    {
                        pndv_in_write_debug_buffer_all_add__(PNDV_DC_CM_RMV_GENERIC_DIAG_CBF, diag_tag, interface_idx);
                    }
                    else
                    {
                ...
                case CM_ERR_ELEM:
                {
                    ...
                    pndv_in_al_diag_done( local_sub_res->entity, TRUE); // to go on with the next diag, its needed to purge the waste

                    pndv_in_write_debug_buffer_all__(PNDV_DC_CM_RMV_DIAG_CBF_ERR, ( (Unsigned16)( (((Unsigned16)pndv_data.diag.submodul_rmv_done_err_count)<<8) | ((Unsigned16)local_sub_res->entity) ) ));
        ...
        if(local_sub_res != 0)
        {
            ...
            switch ( response )
            {
                ...
                case CM_ERR_ELEM:
                {
                    ...
                    // in case of R1-redundancy we trust the application to make the alarm-sequence rigth
                    // the ERR_ELEM can occure during a going alarm repetition after a R1 switchover.
                    // the diag is always removed by CM beacause of coupling the going diag at partner-side

                    pndv_in_al_diag_done( local_sub_res->entity, FALSE); // set alarm
...
void pndv_in_al_diag_done( Unsigned16 entity_nr,  UnsignedOpt purge)
{
    ...
    if ( !PNDV_LIST_IS_EMPTY( &pndv_data.diag.channel_diag_new_list  ) )
    {
        ...
        {
            if (TRUE == purge) // purging of this diag is requested - only possible at double diag.remove (ERR_ELEM from CM)
            {
                channel_diag_ptr->ch_diag_sm = PNDV_DIAG_CH_STATE_FREE;
                ...
                else
                {
                    ...
                    //find the rigth interfac index
                    Unsigned16 interface_idx = channel_diag_ptr->as.ch.kanal;
        ...
        /* then a possibly next edit diagnosis trigger 
           is pndv_data.diag.cm_diag_req_running = FALSE */
        pndv_in_al_check_diag();
    }
}
...
Unsigned16 pndv_in_al_dial_send (PNDV_CHAN_DIAG_PTR diag_channel_ptr)
{
    ...
    */
    ...
    if (PNDV_AL_FREE == al_submodul_ptr->dial_state)
    {
        ...
        if (TRUE == pndv_al_al_possible_within_state(local_sub_res))
        {
            ...
            if (PNDV_DIAG_CH_STATE_DIAG_DONE == diag_channel_ptr->ch_diag_sm)
            {
              ...
              /*al_submodul_ptr->dial_data.device_nr           set in pndv_in_al_init_submodul */
                al_submodul_ptr->dial_data.ar_nr               = pndv_data.ar[ar_idx].ar_nr;
              ...
              /*al_submodul_ptr->maintenance_status            dont care */
                ...
                else
                {
                    switch ( diag_channel_ptr->req )
                    {
                        ...
                        case PNDV_CHANNEL_DIAG_RMV_REQ:
                        {
                            ...
                            al_submodul_ptr->dial_info[PNDV_AL_DIAL_INFO_OFFS_CHANNEL_NO_H] = (Unsigned8)(diag_channel_ptr->as.ch.kanal >> 8);
                            al_submodul_ptr->dial_info[PNDV_AL_DIAL_INFO_OFFS_CHANNEL_NO_L] = (Unsigned8) diag_channel_ptr->as.ch.kanal;

                            al_submodul_ptr->dial_info[PNDV_AL_DIAL_INFO_OFFS_CHANNEL_SPEC] = (Unsigned8)(diag_channel_ptr->as.ch.properties >> 8);
                            al_submodul_ptr->dial_info[PNDV_AL_DIAL_INFO_OFFS_CHANNEL_TYPE] = (Unsigned8) diag_channel_ptr->as.ch.properties;

                            al_submodul_ptr->dial_info[PNDV_AL_DIAL_INFO_OFFS_ERR_TYPE_H]   = (Unsigned8)(diag_channel_ptr->as.ch.fehlernummer >> 8);
                            al_submodul_ptr->dial_info[PNDV_AL_DIAL_INFO_OFFS_ERR_TYPE_L]   = (Unsigned8) diag_channel_ptr->as.ch.fehlernummer;
                        ...
                        case PNDV_EXT_CHANNEL_DIAG_RMV_REQ:
                        {
                            ...
                            /* Because of the independence of the processor endianes, no structure is used here */
                            al_submodul_ptr->dial_info[PNDV_AL_DIAL_INFO_OFFS_CHANNEL_NO_H] = (Unsigned8)(diag_channel_ptr->as.xch.kanal >> 8);
                            al_submodul_ptr->dial_info[PNDV_AL_DIAL_INFO_OFFS_CHANNEL_NO_L] = (Unsigned8) diag_channel_ptr->as.xch.kanal;

                            al_submodul_ptr->dial_info[PNDV_AL_DIAL_INFO_OFFS_CHANNEL_SPEC] = (Unsigned8)(diag_channel_ptr->as.xch.properties >> 8);
                            al_submodul_ptr->dial_info[PNDV_AL_DIAL_INFO_OFFS_CHANNEL_TYPE] = (Unsigned8) diag_channel_ptr->as.xch.properties;

                            al_submodul_ptr->dial_info[PNDV_AL_DIAL_INFO_OFFS_ERR_TYPE_H]   = (Unsigned8)(diag_channel_ptr->as.xch.fehlernummer >> 8);
                            al_submodul_ptr->dial_info[PNDV_AL_DIAL_INFO_OFFS_ERR_TYPE_L]   = (Unsigned8) diag_channel_ptr->as.xch.fehlernummer;

                            al_submodul_ptr->dial_info[PNDV_AL_DIAL_INFO_OFFS_XERR_TYPE_H]  = (Unsigned8)(diag_channel_ptr->as.xch.error_type >> 8);
                            al_submodul_ptr->dial_info[PNDV_AL_DIAL_INFO_OFFS_XERR_TYPE_L]  = (Unsigned8) diag_channel_ptr->as.xch.error_type;

                            al_submodul_ptr->dial_info[PNDV_AL_DIAL_INFO_OFFS_ADD_VALUE_B3]  = (Unsigned8)(diag_channel_ptr->as.xch.add_value >> 24);
                            al_submodul_ptr->dial_info[PNDV_AL_DIAL_INFO_OFFS_ADD_VALUE_B2]  = (Unsigned8)(diag_channel_ptr->as.xch.add_value >> 16);
                            al_submodul_ptr->dial_info[PNDV_AL_DIAL_INFO_OFFS_ADD_VALUE_B1]  = (Unsigned8)(diag_channel_ptr->as.xch.add_value >> 8);
                            al_submodul_ptr->dial_info[PNDV_AL_DIAL_INFO_OFFS_ADD_VALUE_B0]  = (Unsigned8) diag_channel_ptr->as.xch.add_value;
                ...
                PNDV_RQB_SET_HANDLE( &al_submodul_ptr->dial_rqb, pndv_data.cm_handle[PNDV_INDEX_PATH_ACP_CM]);
...
void pndv_in_al_al_ack (CM_UPPER_RQB_PTR_TYPE rqb_ptr)
{
    ...
    Unsigned16                          slot_nr,
                                        subslot_nr;
    PNDV_STRUCT_CFG_SUBMODULE_RES_PTR_T local_sub_res;
    Unsigned8                           ret_to_peri = PNDV_ERR_FATAL;
    ...
    if (local_sub_res != 0)
    {
        ...
        switch ( alarm_ptr->alarm_type )
        {
            ...
            case CM_ALARM_TYPE_DIAGNOSIS_DISAPPEARS:
            {
                ...
                {
                    if ( PNDV_LOAD_CHANNEL_DIAG_QUIT_FROM_RQB( rqb_ptr) != FALSE)
                    {
                ...
                else //everything else is supposed to be an generic diag
                {
                    ...
                    Unsigned16 interface_index;
                    Boolean alarm_found = FALSE;
                    ...
                    for(interface_index=0; interface_index!=PNDV_MAX_GENERIC_DIAG_NUMBER; ++interface_index)
                    {
                        if (pndv_data.iface_ptr->generic_diag_data[interface_index].usi == alarm_ptr->alarm_tag)
                        {
                            ...
                            {
                                if ((Boolean) LSA_MEMCMP(pndv_data.iface_ptr->generic_diag_data[interface_index].data,
                                                                    alarm_ptr->alarm_data, alarm_ptr->alarm_data_length ))
                                {
                ...
                if ( TRUE ==  pndv_data.diag.dial_repeat_req[local_sub_res->entity] )
                {
                    pndv_in_al_check_dial_continue();
                }
 ...
 *  @return     TRUE = Alarm possible, FALSE = Alarm not possible
 *
