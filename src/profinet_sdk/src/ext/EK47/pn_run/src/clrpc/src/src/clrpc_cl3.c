...
static CLRPC_HEADER_PTR_TYPE
clrpc_cl_prepare(
	CLRPC_CLIENT_CONST_PTR_TYPE client,
	CLRPC_LOWER_RQB_PTR_TYPE lower,
	LSA_UINT8 ptype
) {
...
clrpc_cl_send(
	...
	CLRPC_LOWER_RQB_PTR_TYPE lower,
	CLRPC_HEADER_CONST_PTR_TYPE hdr,
	LSA_UINT16 port
) {
	CLRPC_LL_UDP_DATA_PTR_TYPE param;
...
clrpc_cl_statemachine(
    ...
    /* refactor: make smaller subfunctions (TIA 212675) */
    ...
    if( clrpc_queue_not_empty(&client->sendCnfQ) && CLRPC_PTR_IS_NULL(client->call.curr) ) {
        ...
        if( CLRPC_PTR_IS_NOT_NULL(upper) ) {
            ...
            case CLRPC_OPC_CL_REBIND:
                ...
                /*lint -e(613) Possible use of null pointer request 1537687 */
            ...
            client->call.curr->args.cl.call->appl_timeout1sec = (LSA_UINT16)((client->call.curr->args.cl.call->appl_timeout1sec * 1000) / CLRPC_PING_TIMEOUT_MSEC);
