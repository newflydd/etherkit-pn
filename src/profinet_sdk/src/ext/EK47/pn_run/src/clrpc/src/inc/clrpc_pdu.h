...
typedef struct clrpc_pnio_in_args_tag *CLRPC_PNIO_IN_ARGS_PTR_TYPE;
...
typedef struct clrpc_pnio_out_args_tag *CLRPC_PNIO_OUT_ARGS_PTR_TYPE;
...
typedef struct clrpc_header_tag *CLRPC_HEADER_PTR_TYPE;
typedef struct clrpc_header_tag const * CLRPC_HEADER_CONST_PTR_TYPE;
...
#define CLRPC_PT_IS(ptype_, mask_) (((1U << (ptype_)) & (mask_)) != 0)
...
typedef struct clrpc_fack_body_tag *CLRPC_FACK_BODY_PTR_TYPE;
...
typedef struct clrpc_error_body_tag *CLRPC_ERROR_BODY_PTR_TYPE;
...
typedef struct clrpc_quit_body_tag * CLRPC_QUIT_BODY_PTR_TYPE;
...
typedef struct clrpc_quack_body_tag *CLRPC_QUACK_BODY_PTR_TYPE;
...
typedef struct clrpc_way_req_tag *CLRPC_WAY_REQ_PTR_TYPE;
...
typedef struct clrpc_way_rsp_tag *CLRPC_WAY_RSP_PTR_TYPE;
...
typedef struct clrpc_way2_rsp_tag *CLRPC_WAY2_RSP_PTR_TYPE;
...
typedef struct clrpc_epm_lookup_tag *CLRPC_EPM_LOOKUP_PTR_TYPE;
...
typedef struct clrpc_epm_lookup_free_tag *CLRPC_EPM_LOOKUP_FREE_PTR_TYPE;
