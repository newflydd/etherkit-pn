...
/* Berkeley style "Socket address" */
	...
	#include "sy_on_pack_2.h" /*INICHE_TCIP_ITGR avoid gap between structs*/
struct sockaddr_in
{
   short    sin_family;
   u_short  sin_port;
   ...
   char     sin_zero[8];
	...
	#include "sy_off_pack_2.h" /*INICHE_TCIP_ITGR avoid gap between structs*/
...
#define     INICHE_ENOBUFS        1	 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_ETIMEDOUT      2	 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_EISCONN        3	 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_EOPNOTSUPP     4	 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_ECONNABORTED   5	 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_EWOULDBLOCK    6	 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_ECONNREFUSED   7	 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_ECONNRESET     8	 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_ENOTCONN       9	 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_EALREADY       10 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_EINVAL         11 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_EMSGSIZE       12 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_EPIPE          13 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_EDESTADDRREQ   14 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_ESHUTDOWN      15 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_ENOPROTOOPT    16 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_EHAVEOOB       17 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_ENOMEM         18 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_EADDRNOTAVAIL  19 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_EADDRINUSE     20 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_EAFNOSUPPORT   21 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_EINPROGRESS    22 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_ELOWER         23 /* INICHE_TCIP_ITGR INICHE_ ADDED */ /* lower layer (IP) error */
#define     INICHE_ENOTSOCK       24 /* INICHE_TCIP_ITGR INICHE_ ADDED */ /* Includes sockets which closed while blocked */
#define     INICHE_EIEIO          27 /* INICHE_TCIP_ITGR INICHE_ ADDED */ /* bad input/output on Old Macdonald's farm :-) */

#ifdef   IP_MULTICAST
#define     INICHE_ETOOMANYREFS   28 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#endif   /* IP_MULTICAST */

#define     INICHE_EFAULT         29 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#define     INICHE_ENETUNREACH    30 /* INICHE_TCIP_ITGR INICHE_ ADDED */
#endif
...
#ifndef MIN
#define  MIN(a,b)    ((a)>(b)?(b):(a))  /* INICHE_TCIP_ITGR parenthesis added */
#define  MAX(a,b)    ((a)>(b)?(a):(b))  /* INICHE_TCIP_ITGR parenthesis added */
#endif
...
#define     IPPORT_RESERVED      49152 /* TCP port numbers */
#define     IPPORT_USERRESERVED  53128 /* = 49152 + (5000 - 1024) */
#else
...
extern int ip_output(struct mbuf *, struct ip_socopts *);

/* mbuf checksumming routine */
extern u_short in_cksum(struct mbuf *, int);
