...
LSA_VOID LLDP_TimerMgmSetup(LSA_VOID)
{
...
LLDP_RSP LLDP_TimerFree(LSA_UINT16 LLDPTimerID)
{
    LLDP_TIMER_INFO_PTR_TYPE        pTimer;
    LSA_UINT16                      RetVal;
    LSA_TIMER_ID_TYPE               TimerID;
...
LSA_BOOL LLDP_TimerRQBCheckFree(
    LSA_UINT16 LLDPTimerID)
{
    LLDP_TIMER_INFO_PTR_TYPE   pTimer;
    LSA_BOOL                   Status;
