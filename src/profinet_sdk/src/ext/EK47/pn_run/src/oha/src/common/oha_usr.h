...
/* TIA 739338: OHA_OPC_TEST_LLDP_CONTROL removed */
#define OHA_OPC_LLDP_INDICATION             (LSA_OPCODE_TYPE)   0x0B
/* TIA 963229:  OHA_OPC_GET_NEIGHBOUR removed */
...
/* TIA 739338: OHA_OPC_TEST_SNMP_CONTROL removed */

#define OHA_OPC_LLDP_READ_ELEMENT           (LSA_OPCODE_TYPE)   0x12

#define OHA_OPC_SNMP_INDICATION             (LSA_OPCODE_TYPE)   0x14
...
#define OHA_OPC_PRM_CHANGE_PORT             (LSA_OPCODE_TYPE)   0x2A
...
/* TIA XXXXXX:  OHA_OPC_PORT_CONTROL removed */
...
#define OHA_UPPER_MEM_PTR_TYPE       LSA_VOID            *
#define OHA_UPPER_MEM_U8_PTR_TYPE    LSA_UINT8           *
#define OHA_UPPER_MEM_U16_PTR_TYPE   LSA_UINT16          *
#define OHA_UPPER_MEM_U32_PTR_TYPE   LSA_UINT32          *
#define OHA_UPPER_MEM_U64_PTR_TYPE   LSA_UINT64          *

#define OHA_EDD_LOWER_MEM_PTR_TYPE   LSA_VOID            *
#define OHA_EDD_LOWER_MEM_U8_PTR_TYPE   LSA_UINT8        *

#define OHA_DCP_LOWER_MEM_PTR_TYPE      LSA_VOID         *
#define OHA_DCP_LOWER_MEM_U8_PTR_TYPE   LSA_UINT8        *

#define OHA_NARE_LOWER_MEM_PTR_TYPE     LSA_VOID         *
#define OHA_NARE_LOWER_MEM_U8_PTR_TYPE  LSA_UINT8        *

#define OHA_MRP_LOWER_MEM_PTR_TYPE      LSA_VOID         *
#define OHA_MRP_LOWER_MEM_U8_PTR_TYPE   LSA_UINT8        *

#define OHA_LLDP_LOWER_MEM_PTR_TYPE     LSA_VOID         *
#define OHA_LLDP_LOWER_MEM_U8_PTR_TYPE  LSA_UINT8        *

#define OHA_SOCK_LOWER_MEM_PTR_TYPE     LSA_VOID         *
#define OHA_SOCK_LOWER_MEM_U8_PTR_TYPE  LSA_UINT8        *

#define OHA_DNS_LOWER_MEM_PTR_TYPE    LSA_VOID           *
#define OHA_DNS_LOWER_MEM_U8_PTR_TYPE LSA_UINT8          *

#define OHA_LOCAL_MEM_PTR_TYPE          LSA_VOID         *
#define OHA_LOCAL_MEM_U8_PTR_TYPE       LSA_UINT8        *
#define OHA_LOCAL_MEM_U16_PTR_TYPE      LSA_UINT16       *
#define OHA_LOCAL_MEM_U32_PTR_TYPE      LSA_UINT32       *

#define OHA_LOCAL_MEM_U8_CONST_PTR_TYPE const LSA_UINT8  *
#define OHA_LOCAL_MEM_BOOL_PTR_TYPE     LSA_BOOL         *

#define OHA_UPPER_RQB_MEM_PTR_TYPE      LSA_VOID         *

#define OHA_COMMON_MEM_PTR_TYPE         LSA_VOID         *
#define OHA_COMMON_MEM_U8_PTR_TYPE      LSA_UINT8        *
#define OHA_COMMON_MEM_U16_PTR_TYPE     LSA_UINT16       *
#define OHA_COMMON_MEM_U32_PTR_TYPE     LSA_UINT32       *
#define OHA_COMMON_MEM_BOOL_PTR_TYPE    LSA_BOOL         *
...
/*===========================================================================*/
#include "sys_pck1.h"
typedef struct oha_rqb_tag * OHA_UPPER_RQB_PTR_TYPE;
...
typedef struct oha_ip_suite_tag * OHA_UPPER_IP_SUITE_PTR_TYPE;

#define OHA_REMANENT_NO  0
#define OHA_REMANENT_YES 1

typedef struct oha_name_tag
{
    OHA_UPPER_MEM_U8_PTR_TYPE pName;        /* NameOfStation                 */
    LSA_UINT16                Length;       /* length of NameOfStation       */
    LSA_UINT8                 Remanent;     /* OHA_REMANENT_NO               */
                                            /*   ... name not remanent stored*/
                                            /* OHA_REMANENT_YES              */
                                            /*   ... name remanent stored    */
} OHA_NAME_TYPE;
#include "sys_unpck.h"
typedef struct oha_name_tag * OHA_UPPER_NAME_PTR_TYPE;
...
#define OHA_OID_PTR_TYPE            OHA_OID      *
...
#define  OHA_MAX_VAR_LEN      507    /* max length in octets of an asn.1 value */
                                     /* see lldpRemUnknownTLVInfo              */
...
/* access-controls for DCP, LLDP elements */
...
typedef LSA_VOID  LSA_FCT_PTR(/*ATTR*/,OHA_UPPER_CALLBACK_FCT_PTR_TYPE)(OHA_UPPER_RQB_PTR_TYPE rb);
#include "sys_pck1.h"
...
typedef struct oha_open_channel_tag * OHA_UPPER_OPEN_CHANNEL_PTR_TYPE;
...
typedef struct oha_config_tag * OHA_UPPER_GET_CONFIG_PTR_TYPE;
...
typedef struct oha_timer_tag * OHA_UPPER_TIMER_PTR_TYPE;
...
typedef struct oha_ident_tag * OHA_UPPER_IDENT_PTR_TYPE;
...
typedef struct oha_station_tag * OHA_UPPER_STATION_PTR_TYPE;
...
typedef struct oha_address_tag * OHA_UPPER_ADDRESS_PTR_TYPE;

typedef struct oha_address_tag
{
    LSA_UINT32                  Options;
    LSA_UINT8                   AccessMode;
    LSA_UINT32                  RemaOptions;            /*former'Remananent'(831915)*/
...
typedef struct oha_addr_info_tag * OHA_UPPER_ADDR_INFO_PTR_TYPE;

#define OHA_CURRENT_IPSUITE_IS_EMERGENCY_NO  0
#define OHA_CURRENT_IPSUITE_IS_EMERGENCY_YES 1

#define OHA_CURRENT_IPSUITE_CONFLICT_DETECTED_NO  0
#define OHA_CURRENT_IPSUITE_CONFLICT_DETECTED_YES 1

#define OHA_FACTORY_RESET_NO  0
#define OHA_FACTORY_RESET_YES 1
...
typedef struct oha_addr_info_tag
{
    ...
    LSA_UINT8           CurrentIPSuiteIsEmergency; /* OHA_CURRENT_IPSUITE_IS_EMERGENCY_YES if CurrentIPSuite = EmergencyIPSuite */
                                                   /* OHA_CURRENT_IPSUITE_IS_EMERGENCY_NO: otherwise */
    LSA_UINT8           IpSuiteRemanent;        /* OHA_REMANENT_YES if CurrentIPSuite is remanent    */
    /***/

    LSA_UINT8           CurrentIPSuiteConflictDetected; /* OHA_CURRENT_IPSUITE_CONFLICT_DETECTED_YES if the CurrentIPSuite is conflicting with another station, CurrentIPSuite is reset to 0.0.0.0 */
    /* which IPSuite is conflicting?
     * if CurrentIPSuite_is_emergency == OHA_CURRENT_IPSUITE_IS_EMERGENCY_NO  --> look into ExpectedIPSuite
     * if CurrentIPSuite_is_emergency == OHA_CURRENT_IPSUITE_IS_EMERGENCY_YES --> look into EmergencyIPSuite
     */
    ...
    LSA_UINT8           FactoryReset;       /* OHA_FACTORY_RESET_YES: a reset to factory is done */
                                            /* OHA_FACTORY_RESET_NO:  no RtF done at the moment */
...
typedef struct oha_dcp_elem_tag * OHA_DCP_ELEM_PTR_TYPE;
...
typedef struct oha_dcp_elem_tag
{
    ...
    LSA_UINT8                   Remanent;   /* storage of variable in memory */
                                            /* if set to OHA_REMANENT_YES    */
...
typedef struct oha_lldp_option_tag * OHA_LLDP_OPTION_PTR_TYPE;
...
typedef struct oha_lldp_elem_tag * OHA_LLDP_ELEM_PTR_TYPE;
...
typedef struct oha_lldp_elem_tag
{
    ...
    LSA_UINT8                   SubType;    /* type of variable (suboption)  */
    LSA_UINT32                  OUI;        /* OUI, if subtype=127           */
    OHA_LLDP_OPTION_PTR_TYPE    pElements;  /* Ptr to Array of LLDP elements(1008255)*/
...
typedef struct oha_hello_indication_tag * OHA_UPPER_HELLO_PTR_TYPE;
...
typedef struct oha_lldp_access_tag * OHA_UPPER_LLDP_ACCESS_PTR_TYPE;
...
typedef struct oha_lldp_config_tag * OHA_UPPER_LLDP_CONFIG_PTR_TYPE;
...
typedef struct oha_lldp_port_config_tag * OHA_UPPER_LLDP_PORT_CONFIG_PTR_TYPE;
...
typedef struct oha_lldp_indication_tag * OHA_UPPER_LLDP_INDICATION_PTR_TYPE;
...
typedef struct oha_dcp_indication_tag * OHA_UPPER_DCP_INDICATION_PTR_TYPE;
...
#define OHA_EVENT_QUERY_WRITE     25  /* ther's a DcpWrite to respond by the control-user */
...
typedef struct oha_dcp_control_tag * OHA_UPPER_DCP_CONTROL_PTR_TYPE;
...
typedef struct oha_query_elem_tag * OHA_QUERY_ELEM_PTR_TYPE;

typedef struct oha_query_elem_tag
{
    LSA_UINT16                  Count;      /* count of pElements           */
    OHA_DCP_ELEM_PTR_TYPE       pElements;  /* Ptr to Array of DCP elements(1008255)*/
...
#define OHA_CTRL_DHCP_CLIENT_ID         (LSA_UINT32) 0x00000020	/* handle DHCP option 61    */
#define OHA_CTRL_DHCP_USAGE             (LSA_UINT32) 0x00000100 /* DHCP option 255 (on/off) */
...
/* TFS 852764: OHA_CTRL_RESPONSE removed, Suboption �Response� only for coding of  DCP-ResPDU, see PNIO draft */
...
typedef struct oha_oid_tag * OHA_UPPER_GET_OID_PTR_TYPE;
...
typedef struct oha_lldp_options_tag * OHA_LLDP_OPTIONS_PTR_TYPE;
...
/*---------------------------------------------------------------------------*/
/* Opcode: OHA_OPC_SNMP_INDICATION                                           */
/*---------------------------------------------------------------------------*/

typedef struct oha_snmp_control_tag * OHA_UPPER_SNMP_CONTROL_PTR_TYPE;

typedef struct oha_snmp_control_tag
{
    LSA_UINT32                  Mode;                            /* in/out  */
} OHA_SNMP_CONTROL_TYPE;
#include "sys_unpck.h"
/* Mode: see �Coding of the field SnmpControl�             */
/*       OHA_CTRL_SNMP_ACTIVATE, OHA_CTRL_SNMP_DEACTIVATE  */
...
#define OHA_DELAY_EXISTING_NO  0
#define OHA_DELAY_EXISTING_YES 1

LSA_EXTERN LSA_UINT16 OHA_Get_PdPortDataExpected(
...
LSA_EXTERN LSA_UINT8 OHA_Get_Peers_PdPortDataExpected( /* returns OHA_OK or OHA_ERR_PARAM */
...
LSA_EXTERN LSA_UINT8 OHA_Get_PdPortDataReal( /* returns OHA_OK or OHA_ERR_PARAM */
    OHA_UPPER_MEM_U8_PTR_TYPE   pRecordData,
    LSA_UINT32                  RecordLen,
    OHA_COMMON_MEM_U16_PTR_TYPE pNumberOfPeers,
    OHA_UPPER_MEM_U8_PTR_TYPE * ppPeerRecord,
...
LSA_EXTERN LSA_UINT8 OHA_Get_Peers_PdPortDataReal( /* returns OHA_OK or OHA_ERR_PARAM */
    OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
    OHA_UPPER_MEM_U8_PTR_TYPE * ppNextPeers,
    OHA_COMMON_MEM_U16_PTR_TYPE Port_Len,
    OHA_COMMON_MEM_U16_PTR_TYPE Chassis_Len,
...
LSA_EXTERN LSA_UINT16 OHA_Get_PdPortMrpDataExpected(
    OHA_UPPER_MEM_U8_PTR_TYPE   pRecordData,
    LSA_UINT32                  RecordLen,
    OHA_UPPER_MEM_U8_PTR_TYPE * ppDomainUUID,
    LSA_UINT32                * err_offset);

LSA_EXTERN LSA_UINT8 OHA_Get_PdInterfaceDataReal( /* returns OHA_OK or OHA_ERR_PARAM */
    OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
    LSA_UINT32                  RecordLen,
    OHA_COMMON_MEM_U16_PTR_TYPE Chassis_Len,
    OHA_UPPER_MEM_U8_PTR_TYPE * ppChassis,
...
LSA_EXTERN LSA_UINT16 OHA_Get_FastStartUpData(
    OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
    LSA_UINT32                  RecordLen,
...
/*---------------------------------------------------------------------------*/
LSA_EXTERN LSA_UINT16 OHA_Get_PrmPDEVData(
...
/*---------------------------------------------------------------------------*/
LSA_EXTERN LSA_UINT16 OHA_Get_PrmStationData(
    OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
    LSA_UINT32                  RecordLen,
...
/*---------------------------------------------------------------------------*/
LSA_EXTERN LSA_UINT16 OHA_Get_PrmSNMPData(
    OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
    LSA_UINT32                  RecordLen,
...
/*---------------------------------------------------------------------------*/
LSA_EXTERN LSA_UINT16 OHA_Get_PrmBUSData(
    OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
    LSA_UINT32                  RecordLen,
...
/*+  OHA_RECORD_INDEX_LLDP_PORT_DATA      OHA_Get_PrmLLDPPortData()         +*/
/*---------------------------------------------------------------------------*/
LSA_EXTERN LSA_UINT16 OHA_Get_PrmSNMPRecord(
    OHA_UPPER_MEM_U8_PTR_TYPE					pRecordData,	/* IN */
    LSA_UINT32									RecordLen,		/* IN */
...
/*---------------------------------------------------------------------------*/
LSA_EXTERN LSA_UINT16 OHA_Get_PrmLLDPInterfaceData(
    OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
    LSA_UINT32                  RecordLen,
    OHA_COMMON_MEM_U16_PTR_TYPE pIfOptions,
	OHA_LLDP_IF_PARAM_TYPE    * pIfConfig,
    LSA_UINT32                * err_offset); /* OUT */

/*---------------------------------------------------------------------------*/
/* helper function for reading LLDP-port subrecords                          */
/*---------------------------------------------------------------------------*/
LSA_EXTERN LSA_UINT16 OHA_Get_PrmLLDPPortData(
    OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
    LSA_UINT32                  RecordLen,
...
/*---------------------------------------------------------------------------*/
LSA_EXTERN LSA_UINT16 OHA_Get_PrmTCIPData(
    OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
    LSA_UINT32                  RecordLen,
...
/*---------------------------------------------------------------------------*/
LSA_EXTERN LSA_UINT16 OHA_Get_PrmSNMPControlData(
    OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
    LSA_UINT32                  RecordLen,
...
/*---------------------------------------------------------------------------*/
/* helper function for reading IPv4ForwardingRecord                          */
/*---------------------------------------------------------------------------*/
LSA_EXTERN LSA_UINT16 OHA_Get_PrmIPForwardingData(
	OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
	LSA_UINT32                  RecordLen,
...
/*---------------------------------------------------------------------------*/
/* helper function for reading ClusterIPv4SuiteRecord                        */
/*---------------------------------------------------------------------------*/
LSA_EXTERN LSA_UINT16 OHA_Get_PrmClusterIPv4SuiteData(
	OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
	LSA_UINT32                  RecordLen,
	OHA_UPPER_MEM_U8_PTR_TYPE * ppIpAddr,
...
/*---------------------------------------------------------------------------*/
/* helper function for reading ClusterIPv4SuiteValidationRecord              */
/*---------------------------------------------------------------------------*/
LSA_EXTERN LSA_UINT16 OHA_Get_PrmClusterIPv4ValidationData(
	OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
	LSA_UINT32                  RecordLen,
...
/*---------------------------------------------------------------------------*/
LSA_EXTERN LSA_UINT16 OHA_Get_PrmNameOfStationData(
    OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
    LSA_UINT32                  RecordLen,
    OHA_UPPER_MEM_U8_PTR_TYPE * ppNameOfStation,
    OHA_COMMON_MEM_U16_PTR_TYPE pLength,
...
/*---------------------------------------------------------------------------*/
LSA_EXTERN LSA_UINT16 OHA_Get_PrmIpSuiteData(
    OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
    LSA_UINT32                  RecordLen,
    OHA_UPPER_MEM_U8_PTR_TYPE * ppIpAddr,
    OHA_COMMON_MEM_U16_PTR_TYPE pLength,
...
/*---------------------------------------------------------------------------*/
/* helper function for reading DNSParametersRecord                           */
/*---------------------------------------------------------------------------*/
LSA_EXTERN LSA_UINT16 OHA_Get_PrmDNSData(
    OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
    LSA_UINT32                  RecordLen,
...
/*---------------------------------------------------------------------------*/
LSA_EXTERN LSA_UINT16 OHA_Get_PrmIfAdjustData(
    OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
    LSA_UINT32                  RecordLen,
...
/*---------------------------------------------------------------------------*/
LSA_EXTERN LSA_UINT16 OHA_Get_PrmPnIdentData(
    OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
    LSA_UINT32                  RecordLen,
...
/*---------------------------------------------------------------------------*/
LSA_EXTERN LSA_UINT16 OHA_Get_PrmDHCPData(
    OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
    LSA_UINT32                  RecordLen,
...
/*---------------------------------------------------------------------------*/
LSA_EXTERN LSA_UINT16 OHA_Get_PrmBusDataCommon(
    OHA_UPPER_MEM_U8_PTR_TYPE   pRecData,
    LSA_UINT32                  RecordLen,
...
typedef OHA_UUID_TYPE * OHA_UPPER_UUID_PTR_TYPE;
...
/* OHA_DO_SYNC_YES := write LLDP-TLV LLDP_PNIO_PTCPSTATUS to database and send if active */
/* OHA_DO_SYNC_NO  := remove the LLDP-TLV from the database and update send if active */

typedef struct oha_ptcp_data_tag * OHA_UPPER_PTCP_DATA_PTR_TYPE;

#define OHA_DO_SYNC_NO  0
#define OHA_DO_SYNC_YES 1

#define OHA_IS_SYNC_NO  0
#define OHA_IS_SYNC_YES 1

typedef struct oha_ptcp_data_tag
{
    LSA_UINT8        DoSync;              /* IN */ /* write/remove TLV, see above */
    LSA_UINT8        IsSync;              /* IN */ /* OHA_IS_SYNC_NO if not sync  */
...
typedef struct oha_tcip_data_tag * OHA_UPPER_TCIP_DATA_PTR_TYPE;
...
/* record index ClusterIPv4SuiteRecord */
#define OHA_RECORD_INDEX_CLUSTER_IP_V4_SUITE        0x0002301A

/* record index ClusterIPv4SuiteValidationRecord */
#define OHA_RECORD_INDEX_CLUSTER_IP_V4_VALIDATION   0x0002301B

/* record index IPv4ForwardingRecord */
#define OHA_RECORD_INDEX_IP_V4_FORWARDING           0x00023020
...
/* record index 0x00023014 DNSParametersRecord */
#define OHA_RECORD_INDEX_DNS_PARAMETERS             0x00023014
...
/* BlockType: ClusterIPv4SuiteRecord */
#define OHA_BLOCK_TYPE_CLUSTER_IP_V4_SUITE        0x301E

/* BlockType: ClusterIPv4SuiteValidationRecord */
#define OHA_BLOCK_TYPE_CLUSTER_IP_V4_VALIDATION   0x301F

/* BlockType: IPv4ForwardingRecord */
#define OHA_BLOCK_TYPE_IP_V4_FORWARDING           0x3021
...
/* BlockType: Sub block DNSParameters */
#define OHA_BLOCK_TYPE_DNS_PARAMETERS             0x3018
...
/* Coding of the field LinkState.Link */
...
/* Coding of the field LinkState.Port */
#define OHA_PORT_STATE_UNKNOWN              0x0000
#define OHA_PORT_STATE_DISABLED             0x0001
#define OHA_PORT_STATE_BLOCKING             0x0002
#define OHA_PORT_STATE_LISTENING            0x0003
#define OHA_PORT_STATE_LEARNING             0x0004
#define OHA_PORT_STATE_FORWARDING           0x0005
#define OHA_PORT_STATE_BROKEN               0x0006
...
/* Coding of ClusterIPRole:  */
#define OHA_CTRL_CLUSTER_IP_BACKUP      0x00000000   /* Set role to Backup  */
#define OHA_CTRL_CLUSTER_IP_PRIMARY     0x00000001	 /* Set role to Primary */

/* Coding of IPAddressValidation:  */
#define OHA_CLUSTER_IP_VALIDATION_IPV4    0x0000     /* use ClusterIPv4Suite */
#define OHA_CLUSTER_IP_VALIDATION_DHCP    0x0001     /* use DHCP  */
#define OHA_CLUSTER_IP_VALIDATION_SITE    0xFFFF     /* configured on site */
...
/*                   Interface (GateWay Inactive)                                */

#define OHA_TOPO_MAX_IND_ENTRIES            13

typedef struct oha_prm_diag_entry_tag * OHA_UPPER_PRM_DIAG_ENTRY_PTR_TYPE;
...
typedef struct oha_prm_diag_entry_tag
{
    ...
    LSA_UINT16 ExtChannelErrorType; /* 0x8000..0x8004 */
...
typedef struct oha_prm_indication_tag * OHA_UPPER_PRM_INDICATION_PTR_TYPE;
...
/* 0x8004   StandardGateway inactive            */
...
#define OHA_STANDARD_GATEWAY_INACTIVE               0x8004
...
#define OHA_CTRL_SNMP_ACTIVATE                   1  /* activate SNMP-   */
#define OHA_CTRL_SNMP_DEACTIVATE                 0  /* deactivate SNMP- */

#define OHA_SNMP_CONTROL_MASK                    0x00000001


/*---------------------------------------------------------------------------*/
/*  Default values for  OHA_OPC_PRM_END  error codes                         */
/*---------------------------------------------------------------------------*/

#define OHA_PRM_ERR_OFFSET_DEFAULT	0
#define OHA_PRM_ERR_INDEX_DEFAULT	0xFFFF
#define OHA_PRM_ERR_PORT_ID_DEFAULT 0
#define OHA_PRM_ERR_FAULT_DEFAULT	1 /* �Wrong or too many parameters are written� */
...
typedef struct oha_prm_control_tag * OHA_UPPER_PRM_CONTROL_PTR_TYPE;

#define OHA_IS_LOCAL_NO  0
#define OHA_IS_LOCAL_YES 1

typedef struct oha_prm_control_tag
{
    LSA_UINT8       is_local;    /* only for OHA_OPC_PRM_COMMIT:                */
                                 /* OHA_IS_LOCAL_NO:  remote request ("cable")  */
                                 /* OHA_IS_LOCAL_YES: local request (by appl.)  */

                                 /* only for OHA_OPC_PRM_COMMIT:   */
    LSA_UINT8       ApplyDefault[OHA_CFG_MAX_PORTS];
                                 /* 0: full param. is applied      */
                                 /* 1: default param. only         */

                                 /* only for OHA_OPC_PRM_END:      */
    LSA_UINT8       NotApplicable[OHA_CFG_MAX_PORTS];
                                 /* 0: full param. is applied      */
                                 /* 1: default param. only         */

    LSA_UINT16      err_port_id; /* for PRM_END only! */
    LSA_UINT32      err_index;   /* for PRM_END only! */
    LSA_UINT32      err_offset;  /* for PRM_END only! */
    LSA_UINT8       err_fault;   /* for PRM_END only! always OHA_PRM_ERR_FAULT_DEFAULT */
...
typedef struct oha_prm_data_tag * OHA_UPPER_PRM_DATA_PTR_TYPE;
...
typedef struct oha_prm_data_tag
{
    ...
    LSA_UINT8                   mk_rema;  /* OHA_REMANENT_YES .. write data to REMA   */
                                          /* OHA_REMANENT_NO ... no write to REMA     */
    LSA_UINT32                  err_offset; /* for PRM_WRITE only! */
} OHA_PRM_DATA_TYPE;

/*---------------------------------------------------------------------------*/
/*  Opcode: OHA_OPC_PRM_CHANGE_PORT                                          */
/*---------------------------------------------------------------------------*/

/* ModuleState: */
#define OHA_PRM_PORTMODULE_PLUG_PREPARE      1
#define OHA_PRM_PORTMODULE_PLUG_COMMIT       2
#define OHA_PRM_PORTMODULE_PULLED            3

typedef struct oha_prm_state_tag
{
    LSA_UINT16          PortId;
    LSA_UINT8           ModuleState;       /* pulled or plugged   */
    LSA_UINT8           ApplyDefault;      /* for PLUG_COMMIT only  */
    LSA_UINT8           NotApplicable;     /* for PLUG_PREPARE only */

} OHA_PRM_STATE_TYPE;

typedef struct oha_prm_state_tag * OHA_PRM_STATE_PTR_TYPE;
...
typedef struct oha_rema_data_tag
{
    ...
    OHA_UPPER_MEM_U8_PTR_TYPE   data;               /* IN  */
    LSA_UINT32                  data_size;          /* IN  */ /* TFS 1374524 */
    LSA_UINT32                  data_length;        /* OUT */
    LSA_UINT16                  data_tag;           /* OUT */
} OHA_REMA_DATA_TYPE;

typedef struct oha_rema_data_tag * OHA_UPPER_REMA_DATA_PTR_TYPE;
...
typedef struct oha_rema_control_tag * OHA_UPPER_REMA_CONTROL_PTR_TYPE;
...
typedef union oha_rqb_args_tag
{
    ...
    OHA_PRM_STATE_TYPE        PrmState;          /* port (pulled, plugged)    */
    ...
    OHA_SNMP_CONTROL_TYPE     SnmpControl;       /* activate/deactivate SNMP  */
 ...
 *===========================================================================*/
LSA_VOID oha_open_channel(OHA_UPPER_RQB_PTR_TYPE pRQB);
 ...
 *     All other RQB-parameters are unchanged.
 *===========================================================================*/
LSA_VOID oha_close_channel(OHA_UPPER_RQB_PTR_TYPE pRQB);
 ...
 *===========================================================================*/
LSA_VOID oha_request(OHA_UPPER_RQB_PTR_TYPE  upper_rqb_ptr);
...
The following syntax is reserved by PNIO:
 i) remote SET (name_interpertation = OHA_NAME_INTERPRETATION_NO):  default (draft convention), no further interpretation
...
#define OHA_ALLOW_UPPER_CASE_NO  0
#define OHA_ALLOW_UPPER_CASE_YES 1

#define OHA_NAME_INTERPRETATION_NO  0
#define OHA_NAME_INTERPRETATION_YES 1
...
#define OHA_IP_INTERPRETATION_NO  0
#define OHA_IP_INTERPRETATION_YES 1
...
/*----------------------------------------------------------------------------*/
LSA_INT oha_oid2a (
    const OHA_OID_PTR_TYPE oid, LSA_UINT16 oidlen,
...
LSA_INT oha_uuid2a
(
    const OHA_COMMON_MEM_U8_PTR_TYPE uuid,
...
LSA_UINT16 oha_mac2a (
    const OHA_COMMON_MEM_U8_PTR_TYPE mac,
...
/*----------------------------------------------------------------------------*/
LSA_UINT16 oha_ip2a (
    const OHA_COMMON_MEM_U8_PTR_TYPE ip,
