...
static const LSA_UINT8 LLDP_BroadcastMac[LLDP_MAC_ADDR_SIZE]= {0x01,0x80,0xC2,0x00,0x00,0x0E};
    ...
    LSA_UINT32            PortMaxSender)
{
    ...
    LLDP_ALLOC_LOCAL_MEM((LLDP_LOCAL_MEM_PTR_TYPE *)&pHDB->pPCtrl,DSize);
    ...
    else
    {
        ...
        while (( Status == LLDP_RSP_OK ) && ( i<pHDB->PortCnt))
        {
            ...
            LLDP_ALLOC_LOCAL_MEM((LLDP_LOCAL_MEM_PTR_TYPE *)&pPCtrl->pRx,DSize);
...
static LSA_UINT32 LLDP_ConstructShutdown(
    LLDP_COMMON_MEM_U8_PTR_TYPE  pFrame,
    LSA_UINT32                   FrameLength)
{
        ...
        else
        {
            ...
            if (!LSA_HOST_PTR_ARE_EQUAL(pRQB, LSA_NULL) )
            {
                ...
                if (!LSA_HOST_PTR_ARE_EQUAL(pRecv, LSA_NULL) )
                {
                    ...
                    LLDP_EDD_RQB_SET_HANDLE(pRQB,0); /* TIA 2709127 */
...
LLDP_RSP LLDP_EDDLinkIndProvide(
    LLDP_HDB_PTR_TYPE        pHDB,
    LSA_UINT32               PortCnt)
{
...
LLDP_RSP LLDP_EDDGetPortParams(
    LLDP_HDB_PTR_TYPE        pHDB,
    LSA_UINT32               PortID)
{
...
static LSA_VOID LLDP_EDDOpenChannelDone(
    LLDP_EDD_LOWER_RQB_PTR_TYPE  pRQB,
    LLDP_HDB_PTR_TYPE            pHDB)
{
    ...
    switch ( LLDP_EDD_RQB_GET_RESPONSE(pRQB))
    {
        case EDD_STS_OK:
            ...
            /* save channel */
            pHDB->EDDHandle = ((LLDP_EDD_LOWER_RQB_OPEN_CHANNEL_PTR_TYPE)pRQB->pParam)->HandleLower; /* TIA 2709127 */
            break;
...
static LSA_VOID LLDP_EDDCloseChannelDone(
    LLDP_EDD_LOWER_RQB_PTR_TYPE  pRQB,
    LLDP_HDB_PTR_TYPE            pHDB)
{
...
static LSA_VOID LLDP_EDDGetParamsDone(
    LLDP_EDD_LOWER_RQB_PTR_TYPE  pRQB,
    LLDP_HDB_PTR_TYPE            pHDB)
{
...
static LSA_VOID LLDP_EDDSetMulticastDone(
    LLDP_EDD_LOWER_RQB_PTR_TYPE  pRQB,
    LLDP_HDB_PTR_TYPE            pHDB)
{
    LLDP_RSP                 Response;
...
static LSA_VOID LLDP_EDDGetPortParamsDone(
    LLDP_EDD_LOWER_RQB_PTR_TYPE  pRQB,
    LLDP_HDB_PTR_TYPE            pHDB)
{
...
static LSA_VOID LLDP_EDDNrtCancelDone(
    LLDP_EDD_LOWER_RQB_PTR_TYPE  pRQB,
    LLDP_HDB_PTR_TYPE            pHDB)
{
    LLDP_RSP                 Response;
...
static LSA_VOID LLDP_EDDNrtSendDone(
    LLDP_EDD_LOWER_RQB_PTR_TYPE  pRQB,
    LLDP_HDB_PTR_TYPE            pHDB)
{
    LSA_UINT16               RetVal;
...
static LSA_VOID LLDP_EDDNrtRecvDone(
    LLDP_EDD_LOWER_RQB_PTR_TYPE  pRQB,
    LLDP_HDB_PTR_TYPE            pHDB)
{
    LSA_UINT16                                  RetVal;
...
static LSA_VOID LLDP_EDDLinkIndDone(
    LLDP_EDD_LOWER_RQB_PTR_TYPE  pRQB,
    LLDP_HDB_PTR_TYPE            pHDB)
{
    LSA_UINT16                                       RetVal;
...
LSA_VOID lldp_edd_request_lower_done(
    LLDP_EDD_LOWER_RQB_PTR_TYPE  pRQB)
{
...
LLDP_RSP LLDP_EDDSendLLDPFrame(
    LLDP_HDB_PTR_TYPE            pHDB,
    LLDP_EDD_PCTRL_PTR_TYPE      pPCtrl,
    LSA_BOOL                     Shutdown)
{
